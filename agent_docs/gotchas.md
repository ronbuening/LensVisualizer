...
- SVG element outlines use 96 subdivisions per surface — sufficient for strong aspherics. Element shapes render each surface to its own SD, with straight connecting edges where front/rear SDs differ (trapezoidal barrel cuts)
