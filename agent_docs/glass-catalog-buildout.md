...
- [six-digit-glass-codes.generated.md](six-digit-glass-codes.generated.md) — lenses/elements whose `glass` annotation still has only a six-digit code rather than an actual glass type; regenerate with `npm test -- sixDigitGlassCodeScan`.
- [six-digit-glass-codes-missing-sellmeier.generated.md](six-digit-glass-codes-missing-sellmeier.generated.md) — code-only elements that do not reach trusted catalog Sellmeier data; regenerated by the same `sixDigitGlassCodeScan`.
