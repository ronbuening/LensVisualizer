...
## stored (nd=1.59319, vd=67.90)  — 1 surface, current label resolves to S-PHM52
...
## stored (nd=1.59349, vd=67.00)  — 2 surfaces, current label resolves to S-PHM52
...
## stored (nd=1.60300, vd=65.40)  — 1 surface, current label resolves to S-PHM52

Candidates:
- **S-PHM53** (nd=1.60300, vd=65.44, Δnd=+0.0000, Δvd=+0.04)

Surfaces:
- [NIKON AF-S NIKKOR 24-70mm f/2.8E ED VR](../src/lens-data/nikon/NikonNikkorAFS2470mmf28E.data.ts) `21`: `S-PHM52 (OHARA)`
...
## stored (nd=1.69895, vd=30.10) [code=699/301]  — 1 surface, current label resolves to S-TIH6

**No catalog candidate within tolerance** — needs per-lens follow-up.

Surfaces:
- [CANON RF 24-50mm F4.5-6.3 IS STM](../src/lens-data/canon/CanonRF2450mmf463.data.ts) `5`: `S-TIH6 (OHARA 699/301)`
...
## stored (nd=1.76182, vd=26.50) [code=762/265]  — 2 surfaces, current label resolves to S-TIH6

**No catalog candidate within tolerance** — needs per-lens follow-up.

Surfaces:
- [CANON FD 35mm f/2 S.S.C. (I)](../src/lens-data/canon/CanonFD35mmf2.data.ts) `11`: `SF (762265, S-TIH6 family)`
...
## stored (nd=1.76802, vd=49.24)  — 1 surface, current label resolves to S-LAH53

Candidates:
- **S-LAH66** (nd=1.77250, vd=49.60, Δnd=+0.0045, Δvd=+0.36)

Surfaces:
- [RICOH GR IV 18.3mm f/2.8](../src/lens-data/ricoh/RicohGR428f28.data.ts) `10A`: `S-LAH53 (OHARA)`
...
## stored (nd=1.77250, vd=49.60) [code=773/496]  — 1 surface, current label resolves to S-LAH53

Candidates:
- **S-LAH66** (nd=1.77250, vd=49.60, Δnd=-0.0000, Δvd=-0.00, codeΔ=0.5)

Surfaces:
- [CANON RF 24-50mm F4.5-6.3 IS STM](../src/lens-data/canon/CanonRF2450mmf463.data.ts) `11`: `S-LAH53 (OHARA 773/496)`

## stored (nd=1.77250, vd=49.60)  — 2 surfaces, current label resolves to S-LAH55V

Candidates:
- **S-LAH66** (nd=1.77250, vd=49.60, Δnd=-0.0000, Δvd=-0.00)

Surfaces:
- [CANON RF 28-70mm F2 L USM](../src/lens-data/canon/CanonRF2870mmf2L.data.ts) `4`: `S-LAH55V (OHARA)`
- [NIKON AF-S NIKKOR 28mm f/1.4E ED](../src/lens-data/nikon/NikonAFS28f14E.data.ts) `11`: `S-LAH55V (OHARA)`

## stored (nd=1.77250, vd=49.62)  — 2 surfaces, current label resolves to S-LAH55V

Candidates:
- **S-LAH66** (nd=1.77250, vd=49.60, Δnd=-0.0000, Δvd=-0.02)

Surfaces:
- [NIKON PC NIKKOR 19mm f/4E ED](../src/lens-data/nikon/NikonNikkorPCE19mmf4E.data.ts) `20`: `S-LAH55V (OHARA)`
- [NIKON NIKKOR Z 24-120mm f/4 S](../src/lens-data/nikon/NikonNikkorZ24120mmf4S.data.ts) `24`: `S-LAM66 (OHARA)`

## stored (nd=1.77271, vd=49.70)  — 1 surface, current label resolves to S-LAM66

Candidates:
- **S-LAH66** (nd=1.77250, vd=49.60, Δnd=-0.0002, Δvd=-0.10)

Surfaces:
- [LEICA SUMMILUX 28 mm f/1.7 ASPH.](../src/lens-data/leica/Leica28mmf17.data.ts) `18A`: `S-LAM66 (OHARA)`

## stored (nd=1.77279, vd=49.40)  — 2 surfaces, current label resolves to S-LAM66

Candidates:
- **S-LAH66** (nd=1.77250, vd=49.60, Δnd=-0.0003, Δvd=+0.20)

Surfaces:
- [NIKON AF NIKKOR 28mm f/1.4D](../src/lens-data/nikon/NikonAF28f14D.data.ts) `3`: `LaM type (near OHARA S-LAM66, nd=1.77250, νd=49.62)`
- [NIKON AF NIKKOR 28mm f/1.4D](../src/lens-data/nikon/NikonAF28f14D.data.ts) `15`: `LaM type (same as L2; near OHARA S-LAM66)`

## stored (nd=1.77279, vd=49.45)  — 1 surface, current label resolves to S-LAH59

Candidates:
- **S-LAH66** (nd=1.77250, vd=49.60, Δnd=-0.0003, Δvd=+0.15)

Surfaces:
- [NIKON AF-S NIKKOR 14-24mm f/2.8G ED](../src/lens-data/nikon/NikonNikkorAFS1424mmf28.data.ts) `22`: `S-LAH59 (OHARA)`
...
## stored (nd=1.79952, vd=42.24)  — 1 surface, current label resolves to TAFD30

Candidates:
- **S-LAH63** (nd=1.80440, vd=39.59, Δnd=+0.0049, Δvd=-2.65)

Surfaces:
- [OLYMPUS ZUIKO AUTO-S 50mm f/1.2](../src/lens-data/olympus/OlympusZuikoAutoS50mmf12.data.ts) `12`: `S-LAH52 (OHARA) / TAFD30 (HOYA)`
...
## stored (nd=1.80400, vd=46.60)  — 5 surfaces, current label resolves to S-LAL18

Candidates:
- **S-LAH65V** (nd=1.80400, vd=46.58, Δnd=-0.0000, Δvd=-0.02)

Surfaces:
- [CANON RF 24-105mm f/4 L IS USM](../src/lens-data/canon/CanonRF24105mmf4L.data.ts) `12`: `S-LAL18 (OHARA)`
- [CANON RF 24-105mm f/4 L IS USM](../src/lens-data/canon/CanonRF24105mmf4L.data.ts) `31`: `S-LAL18 (OHARA)`
- [NIKON NIKKOR Z 28mm f/2.8](../src/lens-data/nikon/NikonZ28f28.data.ts) `3`: `S-LAH55V (OHARA)`
- [NIKON NIKKOR Z 28mm f/2.8](../src/lens-data/nikon/NikonZ28f28.data.ts) `11`: `S-LAH55V (OHARA)`
- [NIKON NIKKOR Z 28mm f/2.8](../src/lens-data/nikon/NikonZ28f28.data.ts) `16`: `S-LAH55V (OHARA)`

## stored (nd=1.80400, vd=46.50)  — 1 surface, current label resolves to TAFD30

Candidates:
- **S-LAH65V** (nd=1.80400, vd=46.58, Δnd=-0.0000, Δvd=+0.08)

Surfaces:
- [CANON RF 85mm f/2 Macro IS STM](../src/lens-data/canon/CanonRF85mmf2Macro.data.ts) `15`: `TAFD30 (HOYA)`

## stored (nd=1.80400, vd=46.58)  — 2 surfaces, current label resolves to S-LAH58

Candidates:
- **S-LAH65V** (nd=1.80400, vd=46.58, Δnd=-0.0000, Δvd=+0.00)

Surfaces:
- [NIKON PC-E NIKKOR 24mm f/3.5D ED](../src/lens-data/nikon/NikonPCENikkor24mmf35DED.data.ts) `1`: `S-LAH58 (OHARA)`
- [NIKON PC-E NIKKOR 24mm f/3.5D ED](../src/lens-data/nikon/NikonPCENikkor24mmf35DED.data.ts) `16`: `S-LAH58 (OHARA)`

## stored (nd=1.80411, vd=46.50)  — 2 surfaces, current label resolves to S-LAH55

Candidates:
- **S-LAH65V** (nd=1.80400, vd=46.58, Δnd=-0.0001, Δvd=+0.08)

Surfaces:
- [NIKON AF NIKKOR 28mm f/1.4D](../src/lens-data/nikon/NikonAF28f14D.data.ts) `10`: `LaH type (near OHARA S-LAH55, nd=1.80440, νd=46.50)`
- [NIKON AF NIKKOR 28mm f/1.4D](../src/lens-data/nikon/NikonAF28f14D.data.ts) `17`: `LaH type (same as L5; near OHARA S-LAH55)`

## stored (nd=1.80440, vd=39.59)  — 1 surface, current label resolves to S-LAH66

Candidates:
- **S-LAH63** (nd=1.80440, vd=39.59, Δnd=-0.0000, Δvd=-0.00)
- **S-LAH53** (nd=1.80610, vd=40.93, Δnd=+0.0017, Δvd=+1.34)

Surfaces:
- [NIKON AF-S NIKKOR 14-24mm f/2.8G ED](../src/lens-data/nikon/NikonNikkorAFS1424mmf28.data.ts) `10`: `S-LAH66 (OHARA)`

## stored (nd=1.80440, vd=39.60)  — 1 surface, current label resolves to S-LAH55V
...
Surfaces:
- [NIKON NIKKOR Z 100-400mm f/4.5-5.6 VR S](../src/lens-data/nikon/NikonNikkorZ100400f4556.data.ts) `6`: `S-LAH55V (OHARA)`

## stored (nd=1.80610, vd=40.94)  — 2 surfaces, current label resolves to S-TIH53
...
- [NIKON AF-S NIKKOR 14-24mm f/2.8G ED](../src/lens-data/nikon/NikonNikkorAFS1424mmf28.data.ts) `25`: `S-LAH58 (OHARA)`

## stored (nd=1.80610, vd=40.90)  — 1 surface, current label resolves to S-LAH55

Candidates:
- **S-LAH53** (nd=1.80610, vd=40.93, Δnd=-0.0000, Δvd=+0.03)
- **S-LAH63** (nd=1.80440, vd=39.59, Δnd=-0.0017, Δvd=-1.31)

Surfaces:
- [NIKON NIKKOR Z 100-400mm f/4.5-5.6 VR S](../src/lens-data/nikon/NikonNikkorZ100400f4556.data.ts) `24`: `S-LAH55 (OHARA) †`
...
## stored (nd=1.81600, vd=46.60)  — 2 surfaces, current label resolves to S-LAH66

Candidates:
- **S-LAH59** (nd=1.81600, vd=46.62, Δnd=-0.0000, Δvd=+0.02)

Surfaces:
- [NIKON AF-S NIKKOR 24-70mm f/2.8E ED VR](../src/lens-data/nikon/NikonNikkorAFS2470mmf28E.data.ts) `17`: `S-LAH66 (OHARA)`
- [NIKON NIKKOR Z 26mm f/2.8](../src/lens-data/nikon/NikonZ26f28.data.ts) `7`: `S-LAL18 (OHARA)`

## stored (nd=1.81600, vd=46.59)  — 1 surface, current label resolves to S-LAH63

Candidates:
- **S-LAH59** (nd=1.81600, vd=46.62, Δnd=-0.0000, Δvd=+0.03)

Surfaces:
- [NIKON NIKKOR Z 14-30mm f/4 S](../src/lens-data/nikon/NikonNikkorZ1430mmf4S.data.ts) `15`: `S-LAH63 (OHARA)`
...
Surfaces:
- [NIKON AF-S NIKKOR 200-500mm f/5.6E ED VR](../src/lens-data/nikon/NikonNikkorAFS200500mmf56.data.ts) `31`: `S-LAH58 (OHARA)`

## stored (nd=1.83481, vd=42.70)  — 1 surface, current label resolves to S-LAH63
...
Surfaces:
- [NIKON AF-S NIKKOR 24-70mm f/2.8E ED VR](../src/lens-data/nikon/NikonNikkorAFS2470mmf28E.data.ts) `31`: `S-LAH63 (OHARA)`

## stored (nd=1.83481, vd=42.82)  — 1 surface, current label resolves to S-LAH58

Candidates:
- **S-LAH55V** (nd=1.83481, vd=42.73, Δnd=-0.0000, Δvd=-0.09)
- **S-LAH55** (nd=1.83481, vd=42.71, Δnd=-0.0000, Δvd=-0.11)

Surfaces:
- [OLYMPUS ZUIKO AUTO-S 50mm f/1.2](../src/lens-data/olympus/OlympusZuikoAutoS50mmf12.data.ts) `1`: `S-LAH58 (OHARA) / TAFD5 (HOYA)`
...
## stored (nd=1.88300, vd=40.80)  — 3 surfaces, current label resolves to S-LAH66
...
Surfaces:
- [FUJIFILM FUJINON XF 56mm F1.2 R](../src/lens-data/fujifilm/FujifilmXF56mmf12.data.ts) `7`: `S-LAH66 (OHARA)`
- [FUJIFILM FUJINON XF 56mm F1.2 R](../src/lens-data/fujifilm/FujifilmXF56mmf12.data.ts) `15`: `S-LAH66 (OHARA)`
- [FUJIFILM FUJINON XF 56mm F1.2 R](../src/lens-data/fujifilm/FujifilmXF56mmf12.data.ts) `17`: `S-LAH66 (OHARA)`

## stored (nd=1.88300, vd=40.76)  — 1 surface, current label resolves to S-LAH79

Candidates:
- **S-LAH58** (nd=1.88300, vd=40.77, Δnd=-0.0000, Δvd=+0.01)
- **TAFD30** (nd=1.88300, vd=40.80, Δnd=+0.0000, Δvd=+0.04)

Surfaces:
- [LEICA APO-SUMMICRON-M 35 f/2 ASPH.](../src/lens-data/leica/LeicaAPO35mmf2.data.ts) `5`: `S-LAH79 (OHARA)`

## stored (nd=1.88300, vd=40.66)  — 1 surface, current label resolves to S-LAH66

Candidates:
- **S-LAH58** (nd=1.88300, vd=40.77, Δnd=-0.0000, Δvd=+0.11)
- **TAFD30** (nd=1.88300, vd=40.80, Δnd=+0.0000, Δvd=+0.14)

Surfaces:
- [NIKON NIKKOR Z 14-30mm f/4 S](../src/lens-data/nikon/NikonNikkorZ1430mmf4S.data.ts) `11`: `S-LAH66 (OHARA)`
...
## stored (nd=1.90366, vd=31.30) [code=903/313]  — 1 surface, current label resolves to S-LAH79

Candidates:
- **S-LAH95** (nd=1.90366, vd=31.34, Δnd=-0.0000, Δvd=+0.04, codeΔ=1.1)

Surfaces:
- [CANON RF 24-240mm F4-6.3 IS USM](../src/lens-data/canon/CanonRF24240mmf463.data.ts) `1`: `S-LAH79 type (903/313)`

## stored (nd=1.90366, vd=31.30) [code=904/313]  — 1 surface, current label resolves to S-LAH55V

Candidates:
- **S-LAH95** (nd=1.90366, vd=31.34, Δnd=-0.0000, Δvd=+0.04, codeΔ=0.8)

Surfaces:
- [CANON RF 24-50mm F4.5-6.3 IS STM](../src/lens-data/canon/CanonRF2450mmf463.data.ts) `7`: `S-LAH55V (OHARA 904/313)`

## stored (nd=1.90366, vd=31.31)  — 2 surfaces, current label resolves to S-LAH58

Candidates:
- **S-LAH95** (nd=1.90366, vd=31.34, Δnd=-0.0000, Δvd=+0.03)

Surfaces:
- [FUJIFILM FUJINON XF 16-55mm f/2.8 R LM WR](../src/lens-data/fujifilm/FujifilmXF1655mmf28R.data.ts) `9`: `OHARA S-LAH58`
- [NIKON AF-S NIKKOR 200-500mm f/5.6E ED VR](../src/lens-data/nikon/NikonNikkorAFS200500mmf56.data.ts) `17`: `S-LAH79 (OHARA)`

## stored (nd=1.90366, vd=31.30)  — 4 surfaces, current label resolves to TAFD30

Candidates:
- **S-LAH95** (nd=1.90366, vd=31.34, Δnd=-0.0000, Δvd=+0.04)

Surfaces:
- [LEICA APO-SUMMICRON 43mm f/2 ASPH.](../src/lens-data/leica/LeicaAPO43mmf2.data.ts) `13`: `S-NPH53 / TAFD30 (OHARA)`
- [NIKON AF-S NIKKOR 85mm f/1.4G](../src/lens-data/nikon/NikonNikkor85f14G.data.ts) `16`: `S-LAH79 (OHARA)`
- [NIKON AF-S NIKKOR 24-70mm f/2.8E ED VR](../src/lens-data/nikon/NikonNikkorAFS2470mmf28E.data.ts) `13`: `S-LAH79 (OHARA)`
- [NIKON AF-S NIKKOR 80-400mm f/4.5-5.6G ED VR](../src/lens-data/nikon/NikonNikkorAFS80400mmf4556G.data.ts) `16`: `S-LAH65V (OHARA)`

## stored (nd=1.90366, vd=31.32)  — 1 surface, current label resolves to S-LAH79

Candidates:
- **S-LAH95** (nd=1.90366, vd=31.34, Δnd=-0.0000, Δvd=+0.02)

Surfaces:
- [NIKON PC NIKKOR 19mm f/4E ED](../src/lens-data/nikon/NikonNikkorPCE19mmf4E.data.ts) `10`: `S-LAH79 (OHARA)`

## stored (nd=1.90366, vd=31.27)  — 1 surface, current label resolves to S-LAH79

Candidates:
- **S-LAH95** (nd=1.90366, vd=31.34, Δnd=-0.0000, Δvd=+0.07)

Surfaces:
- [NIKON NIKKOR Z 24-120mm f/4 S](../src/lens-data/nikon/NikonNikkorZ24120mmf4S.data.ts) `1`: `S-LAH79 (OHARA)`
...
## stored (nd=2.00069, vd=25.50)  — 2 surfaces, current label resolves to S-NPH2
...
## stored (nd=2.00100, vd=29.12)  — 2 surfaces, current label resolves to S-NPH2
