...
- Future mirror/telescope hardening remains tracked in the Mirror/Folded Backlog section of `FEATURE_ADDITION_PLAN.md` (formerly `MIRROR_LENS_FUTURE_ENHANCEMENTS.md`).
