...
- Catalog: **287 verified entries** in `src/optics/glassCatalogData.ts`.
- Current mismatch and coverage counts live in the generated reports. After the 2026-06-19 catalog/source pass,
  ...
  **354** lenses, **4001** non-air surfaces, **3213** strict catalog Sellmeier surfaces (**80.3%**), and **3240**
  trusted chromatic surfaces (**81.0%**).
- `unresolvedGlassScan`: **632** non-explicit-unmatched annotations still do not resolve, covering **221** distinct
  glass-like tokens.
