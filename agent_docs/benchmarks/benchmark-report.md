...
|---|---:|---:|---:|
| summary | 0.00 | +27.5% | +29.4% |
| distortionCurve | 4.70 | +1.1% | +24.1% |
| distortionGrid | 1.68 | +3.6% | +17.2% |
| vignetting | 18.05 | +3.0% | +37.5% |
| pupils | 0.30 | -0.5% | +28.6% |
| bokehPair | 43.97 | +3.9% | +1.7% |
| bestFocus | 0.91 | +6.7% | +28.2% |
| perspectiveFocus | 207.84 | -7.9% | 0.0% |
| perspectiveFieldAberrations | 188.37 | -5.5% | 0.0% |
| perspectiveChromatic | 190.56 | -5.1% | 0.0% |
| perspectiveDistortion | 20.48 | -5.7% | 0.0% |
| perspectiveVignetting | 287.06 | -5.5% | -0.9% |
| perspectivePupils | 169.00 | -7.3% | -0.2% |

## Aberration Panel Trends

| Panel category | Current median ms | vs previous | vs 10-run median |
|---|---:|---:|---:|
| data.chromaticFieldCurvature | 40.64 | -0.7% | +5.1% |
| data.coma | 9.00 | +3.6% | +5.3% |
| data.fieldCurvature | 34.74 | +1.2% | +8.1% |
| data.fieldCurvatureBundle | 40.82 | +2.0% | +7.1% |
| data.saBlurCharacter | 5.54 | +2.0% | -1.4% |
| data.saProfile | 0.86 | +0.2% | +23.4% |
| data.sphericalAberration | 1.00 | +4.8% | +24.7% |
| render.aberrationsTab | 0.28 | +1.6% | -0.5% |
| render.astigmatismSection | 0.06 | -0.4% | -0.4% |
| render.comaPreviewSection | 0.37 | +7.1% | +2.8% |
| render.comaTab | 0.53 | +7.6% | +2.3% |
| render.fieldCurvatureSection | 0.17 | +0.8% | +0.4% |
| render.meridionalComaSection | 0.05 | +0.6% | -0.2% |
| render.sagittalComaSection | 0.06 | +1.1% | +0.1% |
| render.sphericalSection | 0.03 | -2.0% | -2.3% |
