...
- **680** lenses scanned
- **7741** glass surfaces examined
- **7734** surfaces with non-empty `glass` strings
- **37 / 75** native e-line surfaces resolve by explicit name or alias
- **7201** of those resolved to a catalog entry
