...
- **610** lenses scanned
- **6940** glass surfaces examined
- **6933** surfaces with non-empty `glass` strings
- **30 / 75** native e-line surfaces resolve by explicit name or alias
- **6356** of those resolved to a catalog entry
