...
- **783** lenses scanned
- **8774** glass surfaces examined
- **8770** surfaces with non-empty `glass` strings
- **66 / 108** native e-line surfaces resolve by explicit name or alias
- **8149** of those resolved to a catalog entry
