...
- **2556** of those resolved to a catalog entry
- **70** mismatches found (2.7% of resolved surfaces)
- **38** distinct lens files affected
...
| 27A | `S-LAM73 (OHARA)` | S-LAM73 | 1.85659 | 1.79360 | -0.0630 |
| 34 | `S-LAM73 (OHARA)` | S-LAM73 | 1.85659 | 1.79360 | -0.0630 |
...
| Surface | Glass annotation | Catalog match | Stored nd | Catalog nd | Δnd |
|---|---|---|---|---|---|
| 1 | `S-BSM10 (OHARA)` | S-BSM10 | 1.69680 | 1.62280 | -0.0740 |
| 11 | `NBFD12 (HOYA)` | NBFD12 | 1.70154 | 1.79950 | +0.0980 |
...
| Surface | Glass annotation | Catalog match | Stored nd | Catalog nd | Δnd |
|---|---|---|---|---|---|
| 4 | `S-NBH53 (OHARA)` | S-NBH53 | 1.91082 | 1.73800 | -0.1728 |
...
| Surface | Glass annotation | Catalog match | Stored nd | Catalog nd | Δnd |
|---|---|---|---|---|---|
| 5 | `BaF (702411, S-BAH10 family)` | S-BAH10 | 1.70154 | 1.67003 | -0.0315 |
...
| Surface | Glass annotation | Catalog match | Stored nd | Catalog nd | Δnd |
|---|---|---|---|---|---|
| 6 | `S-NBH53 (OHARA)` | S-NBH53 | 1.74950 | 1.73800 | -0.0115 |
...
| Surface | Glass annotation | Catalog match | Stored nd | Catalog nd | Δnd |
|---|---|---|---|---|---|
| 19 | `N-BAF4 equiv. (157957/5374)` | N-BAF4 | 1.57957 | 1.60568 | +0.0261 |
...
| Surface | Glass annotation | Catalog match | Stored nd | Catalog nd | Δnd |
|---|---|---|---|---|---|
| 25 | `S-LAL12 (OHARA)` | S-LAL12 | 1.65844 | 1.67790 | +0.0195 |
...
| Surface | Glass annotation | Catalog match | Stored nd | Catalog nd | Δnd |
|---|---|---|---|---|---|
| 12A | `M-TAF101 (HOYA)` | M-TAF101 | 1.80139 | 1.76802 | -0.0334 |
...
| Surface | Glass annotation | Catalog match | Stored nd | Catalog nd | Δnd |
|---|---|---|---|---|---|
| 7 | `M-TAC80 (HOYA)` | M-TAC80 | 1.59282 | 1.72903 | +0.1362 |
