...
- **753** lenses scanned
- **8553** glass surfaces examined
- **8549** surfaces with non-empty `glass` strings
- **44 / 85** native e-line surfaces resolve by explicit name or alias
- **7957** of those resolved to a catalog entry
