...
- **766** lenses scanned
- **8638** glass surfaces examined
- **8634** surfaces with non-empty `glass` strings
- **58 / 99** native e-line surfaces resolve by explicit name or alias
- **8027** of those resolved to a catalog entry
