...
- **556** lenses scanned
- **6129** glass surfaces examined
- **6122** surfaces with non-empty `glass` strings
- **18 / 75** native e-line surfaces resolve by explicit name or alias
- **5460** of those resolved to a catalog entry
