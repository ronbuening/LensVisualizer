...
- **382** lenses scanned (**374** visible)
- **3494 / 4264** non-air surfaces use strict catalog Sellmeier data (81.9%)
- **3524 / 4264** non-air surfaces use trusted chromatic data (Sellmeier or measured line indices, 82.6%)
- **2** mismatch surfaces in Sweep 1 across **1** lens files
- **2** Sweep 1 surfaces have a matching untracked local patent PDF
- **236** code-only missing-Sellmeier elements in Sweep 2
- **141** unresolved named-token elements in Sweep 2B
