...
- **3340 / 4124** non-air surfaces use strict catalog Sellmeier data (81.0%)
- **3364 / 4124** non-air surfaces use trusted chromatic data (Sellmeier or measured line indices, 81.6%)
- **0** mismatch surfaces in Sweep 1 across **0** lens files
- **0** Sweep 1 surfaces have a matching untracked local patent PDF
- **208** code-only missing-Sellmeier elements in Sweep 2
...
| S-TIF6 | 2 | 2 | patents/US20150212302A1.pdf<br>patents/US20200049962A1.pdf | [FUJIFILM FUJINON XF 56mm f/1.2 R](../../src/lens-data/fujifilm/FujifilmXF56mmf12.data.ts) Element 9 (1.66680 / 33.00; abbe)<br>[NIKON AF-S NIKKOR 80-400mm f/4.5-5.6 G ED VR](../../src/lens-data/nikon/NikonNikkorAFS80400mmf4556G.data.ts) Element 18 (1.64769 / 33.70; abbe) |
