...
- **412** lenses scanned (**404** visible)
- **3707 / 4546** non-air surfaces use strict catalog Sellmeier data (81.5%)
- **3740 / 4546** non-air surfaces use trusted chromatic data (Sellmeier or measured line indices, 82.3%)
- **0** mismatch surfaces in Sweep 1 across **0** lens files
- **0** Sweep 1 surfaces have a matching untracked local patent PDF
- **270** code-only missing-Sellmeier elements in Sweep 2
...
| 796409 | 3 | 2 | patents/US5751485.pdf<br>patents/US4699475.pdf | 2/3 representative rows reviewed | [NIKON AF MICRO-NIKKOR 200mm f/4D IF-ED](../../src/lens-data/nikon/NikonAFMicroNikkor200mmf4D.data.ts) Element 4 (1.79631 / 40.90)<br>[Nikon AI Zoom-Nikkor 35–105mm f/3.5–4.5S](../../src/lens-data/nikon/NikonAIZoomNikkor35105mmf3545.data.ts) Element 8 (1.79600 / 40.90)<br>[Nikon AI Zoom-Nikkor 35–105mm f/3.5–4.5S](../../src/lens-data/nikon/NikonAIZoomNikkor35105mmf3545.data.ts) Element 16 (1.79600 / 40.90) |
