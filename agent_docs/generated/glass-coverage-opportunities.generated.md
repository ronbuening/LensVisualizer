...
- **3361 / 4124** non-air surfaces use strict catalog Sellmeier data (81.5%)
- **3385 / 4124** non-air surfaces use trusted chromatic data (Sellmeier or measured line indices, 82.1%)
- **0** mismatch surfaces in Sweep 1 across **0** lens files
- **0** Sweep 1 surfaces have a matching untracked local patent PDF
- **230** code-only missing-Sellmeier elements in Sweep 2
