...
- **9** hidden/reference fixtures scanned
- **1** fixtures include second-surface mirror metadata
- **2** fixtures include tilted meridional plane metadata
...
### [REFERENCE Folded Diffractive Plate](../../src/lens-data/reference/ReferenceFoldedDiffractivePlate.data.ts)

- Key: `reference-folded-diffractive-plate`
- Path mode: explicit
- Hit order: `STO` -> `PF` -> `FOLD`
- Image plane: IMG: z=120, y=-100, n=(0, 1)
- Reflective surfaces: `FOLD`
- Blocking surfaces: None
- Annular surfaces: None
- Second-surface coatings: None
- Tilted planes: `FOLD` -> `FOLDB`
- Validation: OK
