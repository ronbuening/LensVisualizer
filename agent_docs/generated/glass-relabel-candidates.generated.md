...
**Scope**: 31 mismatched surfaces across 27 unique groups.
...
## stored (nd=1.95375, vd=32.33)  — 1 surface, current label resolves to S-LAH79
...
- **26** (nd, vd) groups have at least one candidate (30 surfaces) — actionable relabels.
