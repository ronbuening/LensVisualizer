...
- Direct subfolders: 0
- Main outbound areas: same folder (30), src/types (15), package:react (7), src/utils/state (4), src/components/layout (3), src/optics/optics.ts (3), src/utils/style (3), src/optics/lensMovement.ts (2), +9 more
...
| `comparisonReducer.ts` | Comparison Reducer module with default export | same folder, src/types | same folder (3), src/utils/state | SET_COMPARISON_FOCUS_ZOOM, SET_PANE_COORDINATES, SET_SCALE_MODE, SET_SHARED_FOCUS_T, SET_SHARED_STOPDOWN_T, SET_SHARED_ZOOM_T, SET_SHARED_SHIFT_MM, SET_SHARED_TILT_DEG, +4 more |
...
| `comparisonTypes.ts` | Comparison Types helper module | none | same folder (3), src/types | PaneCoordinates, ComparisonPositions, ComparisonFocusZoomState, SharedSlidersSlice, ComparisonAction |
