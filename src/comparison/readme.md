...
flowchart LR
  ...
  n_src_comparison_src_comparison_useComparisonOrchestration_ts --> |2| n_external_src_utils_state
...
- Direct subfolders: 0
- Main outbound areas: same folder (35), src/types (19), package:react (7), src/utils/state (6), src/optics/optics.ts (4), src/components/layout (3), src/utils/style (3), src/components/controls (2), +9 more
...
| --- | --- | --- | --- | --- |
| `ComparisonContent.tsx` | React component module | same folder (9), src/types (2), package:react, src/components/errors, src/utils/state | src/components/layout | default, ComparisonContent |
...
| `comparisonReducer.ts` | Comparison Reducer module with default export | same folder, src/types | same folder (3), src/utils/state (2) | RELINK_COMPARISON, SELECT_PANE_SOURCE_STATE, SET_COMPARISON_FOCUS_ZOOM, SET_PANE_COORDINATES, SET_SCALE_MODE, SET_SHARED_FOCUS_T, SET_SHARED_STOPDOWN_T, SET_SHARED_ZOOM_T, +6 more |
| `comparisonSliders.ts` | Comparison Sliders helper module | same folder, src/optics/focusDistance.ts, src/optics/lensMovement.ts, src/optics/optics.ts, src/types, +1 more | same folder (7), src/components/layout | FocusPairResult, AperturePairResult, ZoomPairResult, MovementPairResult, computeFocusPair, computeAperturePair, formatSharedFocusDist, sharedFNumber, +5 more |
...
| `useComparisonOrchestration.ts` | React hook module | same folder (6), src/utils/state (2), package:react, package:react-router, src/types, +1 more | src/components/layout | isComparisonOk, ComparisonLensesResult, ComparisonOrchestration, default, useComparisonOrchestration |
