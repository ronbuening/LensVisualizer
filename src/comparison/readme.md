...
| `comparisonReducer.ts` | Comparison Reducer module with default export | same folder, src/types | same folder (3), src/utils/state | RELINK_COMPARISON, SELECT_PANE_SOURCE_STATE, SET_COMPARISON_FOCUS_ZOOM, SET_PANE_COORDINATES, SET_SCALE_MODE, SET_SHARED_FOCUS_T, SET_SHARED_STOPDOWN_T, SET_SHARED_ZOOM_T, +6 more |
