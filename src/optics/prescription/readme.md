...
| `variables.ts` | Variables helper module | src/optics/math (2), same folder, src/types | src/optics/state (2), same folder, src/optics/internal | DEFAULT_FOCUS_POSITIONS, compileVariableGaps, compileVariableLabels, resolveVariableThickness, resolveAberrationThickness, resolveControlledThickness |
