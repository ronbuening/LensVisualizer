...
| `sourceLaunch.ts` | Source Launch helper module | same folder (2), src/optics/trace (2), src/optics/math, src/optics/types.ts, src/types | src/optics/analysis (3), src/optics/diagram | SourceFieldLaunch, sourceObjectPoint, sourceLaunchRay, prepareSourceFieldLaunch |
