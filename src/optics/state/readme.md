...
flowchart LR
  ...
  n_src_optics_state_src_optics_state_prepareState_ts --> n_external_src_optics_apertureStop_ts
...
- Direct subfolders: 0
- Main outbound areas: src/optics/types.ts (3), same folder, src/optics/apertureStop.ts, src/optics/math, src/optics/prescription, src/types
...
| `prepareState.ts` | Prepare State helper module | src/optics/types.ts (2), same folder, src/optics/apertureStop.ts, src/optics/math, src/optics/prescription, +1 more | src/optics/diagram (2), src/optics/first-order (2), src/optics/compat.ts, src/optics/field, src/optics/trace | PrepareStateOptions, preparedStateCacheKey, prepareState |
