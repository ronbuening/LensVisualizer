...
/* ──────────────────────────────────────────────────────────────────────────
 * GLASS CATALOG — 283 vendor-verified entries (Phase 20, May 2026)
 *
...
export const RAW_CATALOG: readonly GlassEntry[] = [
  ...
  /* ────── Phase 20 coverage buildout additions (May 2026) ──────
   * High-value unresolved named-token and six-digit-code targets selected from
   * sellmeier-coverage.generated.md. Coefficients are vendor AGF rows mirrored
   * by refractiveindex.info and validated through assertCatalogConsistent.
   */
  {
    name: "S-LAL12",
    vendor: "Ohara",
    ...
    PgF: 0.546,
    code6: "678553",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-LAL12 page (formula 2).",
  },
  {
    name: "S-LAM7",
    vendor: "Ohara",
    ...
    PgF: 0.587,
    code6: "750353",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-LAM7 page (formula 2).",
  },
  {
    name: "S-BAH10",
    vendor: "Ohara",
    ...
    PgF: 0.562,
    code6: "670473",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-BAH10 page (formula 2).",
  },
  {
    name: "S-BSM10",
    vendor: "Ohara",
    ...
    PgF: 0.545,
    code6: "623570",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-BSM10 page (formula 2).",
  },
  {
    name: "S-BSM15",
    vendor: "Ohara",
    ...
    PgF: 0.5444,
    code6: "623582",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-BSM15 page (formula 2).",
  },
  {
    name: "S-APL1",
    vendor: "Ohara",
    polynomial: [2.2762403, -0.0096874647, 0.0092330378, 0.00038940853, -0.000038018733, 0.0000020693225],
    nd: 1.517277,
    vd: 69.563209,
    PgF: 0.5302,
    code6: "517696",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-APL1 page (formula 3 polynomial).",
  },
  {
    name: "S-LAL61",
    vendor: "Ohara",
    B: [1.11073292, 0.859347773, 1.26707433],
    C: [0.00464181248, 0.0192989261, 87.3917698],
    nd: 1.740999,
    vd: 52.636502,
    PgF: 0.5457,
    code6: "741527",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-LAL61 page (formula 2).",
  },
  {
    name: "S-NBH53",
    vendor: "Ohara",
    ...
    vd: 32.261312,
    PgF: 0.5901,
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-NBH53 page (formula 2).",
  },
  {
    name: "M-TAF101",
    vendor: "Hoya",
    ...
    PgF: 0.5529,
    code6: "768492",
    source: "Hoya Zemax catalog 2017-04-01 via refractiveindex.info; M-TAF101 page (formula 3 polynomial).",
  },
  {
    name: "M-TAC80",
    vendor: "Hoya",
  ...
  },
  {
    name: "TAF1",
    vendor: "Hoya",
    polynomial: [3.0736378, -0.015501284, 0.023627699, 0.00066300852, -0.000028353438, 0.0000022090799],
    nd: 1.7725,
    vd: 49.62,
    PgF: 0.5517,
    code6: "773496",
    source: "Hoya Zemax catalog 2017-04-01 via refractiveindex.info; TAF1 page (formula 3 polynomial).",
  },
  {
    name: "NBFD10",
    vendor: "Hoya",
    ...
    PgF: 0.5789,
    code6: "834373",
    source: "Hoya Zemax catalog 2017-04-01 via refractiveindex.info; NBFD10 page (formula 3 polynomial).",
  },
  {
    name: "NBFD12",
    vendor: "Hoya",
    polynomial: [3.1513655, -0.013052015, 0.029502111, 0.00067643437, 0.0000036679701, 0.0000018233293],
    nd: 1.7995,
    vd: 42.34,
    PgF: 0.5654,
    code6: "800423",
    source: "Hoya Zemax catalog 2017-04-01 via refractiveindex.info; NBFD12 page (formula 3 polynomial).",
  },
  {
    name: "BACD4",
    vendor: "Hoya",
  ...
  },
  {
    ...
    PgF: 0.5733,
    code6: "606437",
    source: "Schott Zemax catalog 2017-01-20b via refractiveindex.info; N-BAF4 page (formula 2).",
  },
  {
    name: "N-LAK9",
    vendor: "Schott",
    ...
    PgF: 0.5447,
    code6: "691547",
    source: "Schott Zemax catalog 2017-01-20b via refractiveindex.info; N-LAK9 page (formula 2).",
  },
  {
    name: "N-LAF2",
    vendor: "Schott",
    ...
    PgF: 0.5657,
    code6: "744449",
    source: "Schott Zemax catalog 2017-01-20b via refractiveindex.info; N-LAF2 page (formula 2).",
  },

  {
    ...
    vd: 37.08945,
    PgF: 0.5827,
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-LAM73 page (formula 2).",
  },
  {
    name: "S-BAM12",
    vendor: "Ohara",
    B: [1.50161605, 0.126987445, 1.43544052],
    C: [0.00940761826, 0.0472602195, 141.666499],
    nd: 1.6393,
    vd: 44.872804,
    PgF: 0.5677,
    code6: "639449",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-BAM12 page (formula 2).",
  },
  {
    name: "S-BSM2",
    vendor: "Ohara",
    B: [0.867168676, 0.672848343, 1.18456107],
    C: [0.00369311003, 0.0181652804, 132.376147],
    nd: 1.607379,
    vd: 56.816076,
    PgF: 0.5469,
    code6: "607568",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-BSM2 page (formula 2).",
  },
  {
    name: "S-BSM25",
    vendor: "Ohara",
    B: [1.34814257, 0.347530319, 1.38798368],
    C: [0.00695364366, 0.0277863478, 142.138122],
    nd: 1.658441,
    vd: 50.877554,
    PgF: 0.5551,
    code6: "658509",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-BSM25 page (formula 2).",
  },
  {
    name: "S-LAL52",
    vendor: "Ohara",
    polynomial: [2.7418702, -0.012719153, 0.016306977, 0.00061414226, -0.000048242632, 0.0000028875864],
    nd: 1.669999,
    vd: 57.327972,
    PgF: 0.5425,
    code6: "670573",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-LAL52 page (formula 3 polynomial).",
  },
  {
    name: "S-PHM51",
    vendor: "Ohara",
  ...
  },
  {
    name: "S-BAH32",
    vendor: "Ohara",
    B: [1.5802363, 0.137504632, 1.60603298],
    C: [0.0103578062, 0.0548393088, 147.982885],
    nd: 1.669979,
    vd: 39.271035,
    PgF: 0.5812,
    code6: "670393",
    source: "Ohara Zemax catalog 2017-11-30 via refractiveindex.info; S-BAH32 page (formula 2).",
  },
  {
    name: "N-BAK4",
    vendor: "Schott",
    ...
    PgF: 0.5486,
    code6: "569560",
    source: "Schott Zemax catalog 2017-01-20b via refractiveindex.info; N-BAK4 page (formula 2).",
  },
  {
    name: "N-BASF2",
    vendor: "Schott",
    B: [1.53652081, 0.156971102, 1.30196815],
    C: [0.0108435729, 0.0562278762, 131.3397],
    nd: 1.66446,
    vd: 36,
    PgF: 0.5889,
    code6: "664360",
    source: "Schott Zemax catalog 2017-01-20b via refractiveindex.info; N-BASF2 page (formula 2).",
  },
  {
    name: "N-LAF7",
    vendor: "Schott",
    B: [1.74028764, 0.226710554, 1.32525548],
    C: [0.010792558, 0.0538626639, 106.268665],
    nd: 1.7495,
    vd: 34.82,
    PgF: 0.5894,
    code6: "749348",
    source: "Schott Zemax catalog 2017-01-20b via refractiveindex.info; N-LAF7 page (formula 2).",
  },
  {
    name: "N-LAK10",
    vendor: "Schott",
    B: [1.72878017, 0.169257825, 1.19386956],
    C: [0.00886014635, 0.0363416509, 82.9009069],
    nd: 1.72003,
    vd: 50.62,
    PgF: 0.5515,
    code6: "720506",
    source: "Schott Zemax catalog 2017-01-20b via refractiveindex.info; N-LAK10 page (formula 2).",
  },
  {
    name: "E-FD7",
    vendor: "Hoya",
    ...
    PgF: 0.5912,
    code6: "640346",
    source: "Hoya Zemax catalog 2017-04-01 via refractiveindex.info; E-FD7 page (formula 3 polynomial).",
  },
  {
    name: "E-FEL6",
    vendor: "Hoya",
    polynomial: [2.3068946, -0.0096888755, 0.01309702, 0.00065013927, -0.000042328222, 0.0000035888777],
    nd: 1.53172,
    vd: 48.84,
    PgF: 0.5668,
    code6: "532488",
    source: "Hoya Zemax catalog 2017-04-01 via refractiveindex.info; E-FEL6 page (formula 3 polynomial).",
  },
  {
    name: "FCD10A",
    vendor: "Hoya",
    ...
    PgF: 0.5415,
    code6: "459902",
    source: "Hoya Zemax catalog 2017-04-01 via refractiveindex.info; FCD10A page (formula 3 polynomial).",
  },
];
