...
flowchart LR
  ...
  n_src_optics_TypeScript_modules --> |5| n_src_optics_src_optics_diagram
  ...
  n_src_optics_TypeScript_modules --> |3| n_src_optics_src_optics_prescription
...
| `diagramGeometry.ts` | Diagram Geometry helper module | src/optics/compat.ts, src/optics/diagram | src/components/hooks (4), src/benchmarks, src/components/diagram | computeElementRenderDiagnostics, computeElementShapes, computeStandaloneMirrorPaths, createCoordinateTransforms, DiagramPointTransform, prepareSourceDiagramFan |
...
| `layout.ts` | Layout helper module | src/optics/internal (3), src/optics/focusDistance.ts, src/types | src/optics/analysis (5), src/optics/aberration (4), src/optics/first-order (2), src/optics/chromatic, src/optics/optics.ts, +4 more | SVG_PATH_SUBDIVISIONS, FOCUS_INFINITY_THRESHOLD, renderSag, sagSlope, gapTrimHeight, slopeTrimHeight, thick, doLayout, +13 more |
...
| `sourceStates.ts` | Source States helper module | src/types | src/optics/analysis (3), src/components/display, src/optics/diagram, src/utils/state | lensSourceStates, resolveLensSourceState, sourceFiniteConjugate |
...
| `types.ts` | Shared TypeScript types | src/optics/dispersion.ts, src/optics/glassCatalog.ts, src/types | src/optics/analysis (21), src/optics/perspective (20), src/components/display (15), src/optics/trace (12), src/optics/math (6), +10 more | Vec3, Ray3, Plane3, SurfaceProfile, CompiledSurfaceInteraction, CompiledRadialPhaseTerm, CompiledDiffractivePhase, CompiledSurface, +16 more |
| `validateLensData.ts` | Validate Lens Data module with default export | src/optics/internal (5), src/types (2), src/optics/prescription, src/utils/catalog | src/optics/runtimeLens.ts, src/utils/state | LENS_KEY_PATTERN, default, validateLensData |
