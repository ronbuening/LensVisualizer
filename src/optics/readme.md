...
| `layout.ts` | Layout helper module | src/optics/internal (3), src/optics/focusDistance.ts, src/types | src/optics/aberration (4), src/optics/analysis (4), src/optics/first-order (2), src/optics/chromatic, src/optics/optics.ts, +4 more | SVG_PATH_SUBDIVISIONS, FOCUS_INFINITY_THRESHOLD, renderSag, sagSlope, gapTrimHeight, slopeTrimHeight, thick, doLayout, +13 more |
...
| `mtf.ts` | Mtf helper module | src/optics/analysis (2) | src/components/display, src/components/hooks | assessMtfSupport, MTF_FIELDS, MTF_FREQUENCIES, MTF_PHOTOPIC_LINES, resolveMtfSpectrum, computeMtf, computeMtfSteps, resolveMtfGeometry |
...
| `spectralLines.ts` | Spectral Lines helper module | none | src/optics/chromatic (2), src/optics/analysis, src/optics/constants.ts, src/optics/glassCatalog.ts, src/optics/math | LINE_NM |
...
| `types.ts` | Shared TypeScript types | src/optics/dispersion.ts, src/optics/glassCatalog.ts, src/types | src/optics/perspective (20), src/optics/analysis (19), src/components/display (14), src/optics/trace (12), src/optics/math (6), +10 more | Vec3, Ray3, Plane3, SurfaceProfile, CompiledSurfaceInteraction, CompiledRadialPhaseTerm, CompiledDiffractivePhase, CompiledSurface, +16 more |
