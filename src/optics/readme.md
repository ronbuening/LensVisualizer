...
| `sourceStates.ts` | Source States helper module | src/types | src/optics/analysis (3), src/components/display, src/optics/diagram | lensSourceStates, resolveLensSourceState, sourceFiniteConjugate |
