...
| `sourceStates.ts` | Source States helper module | src/types | src/optics/analysis (2), src/optics/diagram | lensSourceStates, resolveLensSourceState, sourceFiniteConjugate |
