...
flowchart LR
  subgraph n_src_optics["src/optics"]
    ...
    n_src_optics_TypeScript_modules["TypeScript modules (34)"]
  end
...
| `lensMovement.ts` | Lens Movement helper module | src/types | src/components/hooks (5), src/comparison, src/components/controls, src/components/diagram, src/components/layout, +1 more | LensMovementState, ResolvedLensMovement, LensMovementTransform, MOVEMENT_SHIFT_ENVELOPE_MM, MOVEMENT_TILT_ENVELOPE_DEG, ZERO_LENS_MOVEMENT, perspectiveControlSteps, isIdentityLensMovement, +6 more |
