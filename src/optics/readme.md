...
flowchart LR
  subgraph n_src_optics["src/optics"]
    ...
    n_src_optics_src_optics_workers["workers/"]
  ...
  n_src_optics_TypeScript_modules --> |20| n_src_optics_src_optics_analysis
  n_src_optics_TypeScript_modules --> |19| n_src_optics_src_optics_internal
  ...
  n_src_optics_TypeScript_modules --> |7| n_src_optics_src_optics_math
  ...
  n_src_optics_TypeScript_modules --> |5| n_src_optics_src_optics_trace
  ...
  n_src_optics_TypeScript_modules --> |4| n_src_optics_src_optics_state
...
- Direct subfolders: 15
- Main outbound areas: src/types (24), src/optics/analysis (20), src/optics/internal (19), src/optics/compat.ts (11), src/optics/glassCatalogEntries (8), src/optics/optics.ts (8), src/optics/chromatic (7), src/optics/math (7), +27 more
- External consumers: src/benchmarks, src/comparison, src/components/controls, src/components/diagram, src/components/display, src/components/hooks, src/components/layout, src/optics/aberration, +14 more
...
| [workers/](workers/readme.md) | src/optics/workers source folder |
...
| `buildLens.ts` | Build Lens module with default export | src/optics/compat.ts, src/optics/runtimeLens.ts | src/benchmarks, src/comparison, src/components/hooks, src/optics/workers | paraxialTrace, realTraceToStop, default |
...
| `compat.ts` | Compat helper module | src/optics/analysis (13), src/optics/chromatic (4), src/optics/diagram (4), src/optics/field (3), src/optics/first-order (3), +7 more | src/components/display (15), src/components/layout (2), src/benchmarks, src/comparison, src/components/controls, +9 more | prepareRuntimeState, buildLens2, engineLensFromRuntime, doLayout2, thick2, eflAtZoom2, epAtZoom2, fopenAtZoom2, +173 more |
| `constants.ts` | Constants helper module | src/optics/internal, src/optics/spectralLines.ts, src/types | src/optics/math (5), src/optics/trace (4), src/optics/analysis (3), src/components/display, src/optics/diagram, +2 more | DEFAULT_MAX_RIM_ANGLE_DEG, FLAT_R_THRESHOLD, MAX_RIM_SLOPE_TAN, VECTOR_EPSILON, INTERSECTION_TOLERANCE, INTERSECTION_MAX_ITERATIONS, INTERSECTION_BRACKET_SAMPLES, CHROMATIC_CHANNEL_WAVELENGTH_NM, +2 more |
...
| `layout.ts` | Layout helper module | src/optics/first-order (2), src/optics/constants.ts, src/optics/internal, src/optics/math, src/optics/prescription, +2 more | src/optics/aberration (4), src/optics/analysis (2), src/optics/chromatic, src/optics/optics.ts, src/optics/opticsFormat.ts, +3 more | SVG_PATH_SUBDIVISIONS, FOCUS_INFINITY_THRESHOLD, renderSag, sagSlope, gapTrimHeight, slopeTrimHeight, thick, doLayout, +13 more |
...
| `optics.ts` | Optics helper module | src/optics/compat.ts (4), src/optics/analysis (3), src/optics/math (2), src/optics/trace (2), src/optics/cameraLayout.ts, +6 more | src/components/display (11), src/optics/analysis (8), src/components/hooks (6), src/comparison (3), src/components/diagram (3), +8 more | FLAT_R_THRESHOLD, conicPolySag, sag, sagSlopeRaw, anchorLayoutToCamera, CameraAnchoredLayout, FOCUS_INFINITY_THRESHOLD, SVG_PATH_SUBDIVISIONS, +84 more |
...
| `types.ts` | Shared TypeScript types | src/optics/dispersion.ts, src/optics/glassCatalog.ts, src/types | src/optics/perspective (20), src/components/display (15), src/optics/analysis (14), src/optics/trace (14), src/optics/math (7), +11 more | Vec3, Ray3, Plane3, SurfaceProfile, CompiledSurfaceInteraction, CompiledRadialPhaseTerm, CompiledDiffractivePhase, CompiledSurface, +16 more |
