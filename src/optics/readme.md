...
- Main outbound areas: src/types (24), src/optics/analysis (20), src/optics/internal (20), src/optics/compat.ts (11), src/optics/glassCatalogEntries (8), src/optics/optics.ts (8), src/optics/chromatic (7), src/optics/math (7), +27 more
...
| `layout.ts` | Layout helper module | src/optics/first-order (2), src/optics/internal (2), src/optics/constants.ts, src/optics/math, src/optics/prescription, +1 more | src/optics/aberration (4), src/optics/analysis (2), src/optics/chromatic, src/optics/optics.ts, src/optics/opticsFormat.ts, +3 more | SVG_PATH_SUBDIVISIONS, FOCUS_INFINITY_THRESHOLD, renderSag, sagSlope, gapTrimHeight, slopeTrimHeight, thick, doLayout, +13 more |
