...
- Direct subfolders: 0
- Main outbound areas: same folder (7), src/optics/types.ts (4), src/types (4), src/optics/constants.ts, src/optics/internal, src/optics/state
...
| `runtimeDiagramAdapter.ts` | Runtime Diagram Adapter helper module | same folder (4), src/optics/state, src/optics/types.ts, src/types | src/optics/compat.ts | createCoordinateTransforms2, computeElementRenderDiagnostics2, computeElementShapes2, stateForRuntimeDiagram2 |
