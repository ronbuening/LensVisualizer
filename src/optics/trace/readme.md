...
flowchart LR
  ...
  n_src_optics_trace_src_optics_trace_workingFNumber_ts --> n_external_src_optics_field
  ...
  n_src_optics_trace_src_optics_trace_workingFNumber_ts --> n_external_src_optics_math
...
- Direct subfolders: 0
- Main outbound areas: same folder (40), src/optics/math (15), src/optics/types.ts (14), src/types (14), src/optics/constants.ts (4), src/optics/field, src/optics/prescription, src/optics/spectralLines.ts, +1 more
...
| `workingFNumber.ts` | Working FNumber helper module | same folder, src/optics/field, src/optics/math, src/optics/prescription, src/optics/types.ts | src/optics/first-order | RealWorkingAperture, apertureObjectDistance, realWorkingApertureForState |
