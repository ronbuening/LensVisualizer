...
| `workingFNumber.ts` | Working FNumber helper module | src/optics/math (2), same folder, src/optics/constants.ts, src/optics/prescription, src/optics/types.ts | src/optics/first-order | RealWorkingAperture, apertureObjectDistance, realWorkingApertureForState |
