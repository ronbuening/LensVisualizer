...
- Direct subfolders: 0
- Main outbound areas: same folder (36), src/optics/math (14), src/optics/types.ts (12), src/types (12), src/optics/constants.ts (4), src/optics/prescription, src/optics/spectralLines.ts, src/optics/state
...
| `encounterMedia.ts` | Encounter Media helper module | same folder (2), src/optics/math, src/types | same folder (2) | MediumEncounterHit, mediumAfterEncounter |
...
| `spectralThroughput.ts` | Spectral Throughput helper module | same folder (5), src/optics/math (2), src/optics/constants.ts, src/optics/types.ts, src/types | src/optics/optics.ts | dielectricReflectance, throughputForTrace, traceSpectralThroughput |
...
| `types.ts` | Shared TypeScript types | src/optics/math, src/optics/types.ts, src/types | same folder (9), src/optics/field, src/optics/perspective | TraceFailureReason, TraceHit, EngineTraceResult, TraceOptions, TraceDiagnosticsInput, MediumEncounterHit |
| `utils.ts` | Utils helper module | same folder (2), src/optics/math (2), src/optics/types.ts, src/types | same folder (4), src/optics/perspective | sensorPointForTrace, directionSlopes, projectCoordinateToZ, normalizeTraceDirection, finalizeTraceResult, clampTraceCount, resolveReturnVertexIndex |
