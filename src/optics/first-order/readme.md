...
- Direct subfolders: 0
- Main outbound areas: src/optics/types.ts (4), same folder (3), src/optics/math (3), src/types (3), src/optics/prescription (2), src/optics/state (2), src/optics/layout.ts, src/optics/trace
- External consumers: src/optics/analysis, src/optics/compat.ts, src/optics/layout.ts, src/optics/perspective
