...
flowchart LR
  ...
  n_src_optics_first_order_src_optics_first_order_aperture_ts --> |2| n_external_src_optics_math
  n_src_optics_first_order_src_optics_first_order_aperture_ts --> |2| n_external_src_types
  n_src_optics_first_order_src_optics_first_order_aperture_ts --> n_external_src_optics_layout_ts
  ...
  n_src_optics_first_order_src_optics_first_order_fNumber_ts --> n_external_src_optics_prescription
...
- Direct subfolders: 0
- Main outbound areas: src/optics/math (5), src/optics/types.ts (5), src/types (5), same folder (4), src/optics/prescription (3), src/optics/state (3), src/optics/layout.ts, src/optics/trace
