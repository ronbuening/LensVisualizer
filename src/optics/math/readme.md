...
| `rootSolve.ts` | Root Solve helper module | none | src/optics/perspective (2), src/optics/analysis, src/optics/field | ScalarRootEvaluation, ScalarRootSolveStatus, ScalarRootSolveOptions, ScalarRootSolveResult, solveScalarRoot |
