...
| `paraxial.ts` | Paraxial helper module | same folder, src/optics/constants.ts, src/optics/types.ts, src/types | src/optics/first-order (4), src/optics/field, src/optics/internal, src/optics/perspective, src/optics/state | ParaxialSurface, ParaxialState, ParaxialTraceOptions, ParaxialTraceResult, transferParaxialRay2, interactParaxialSurface2, traceParaxialSurfaces2 |
...
| `uniformInterpolation.ts` | Uniform Interpolation helper module | none | src/optics/prescription (2), src/optics/compat.ts, src/optics/first-order, src/optics/layout.ts, src/optics/state | uniformInterpolationSegment, interpolateUniformSchedule |
