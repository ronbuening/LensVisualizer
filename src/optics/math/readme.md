...
| `rootSolve.ts` | Root Solve helper module | none | src/optics/analysis (2), src/optics/perspective (2), src/optics/field | ScalarRootEvaluation, ScalarRootSolveStatus, ScalarRootSolveOptions, ScalarRootSolveResult, solveScalarRoot |
