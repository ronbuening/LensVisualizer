...
const FUJIFILM_X_MOUNT = {
  ...
  cameraSideFeatures: [
    ...
    },
    {
      ...
      outerRadiusMm: v(25, "photo_scaled", J),
      depthMm: naV(),
      matesWith: "",
    ...
    },
    {
      ...
      startAngleDeg: v(10, "photo_scaled", J),
      endAngleDeg: v(50, "photo_scaled", J),
    ...
    },
    {
      ...
      startAngleDeg: v(130, "photo_scaled", J),
      endAngleDeg: v(170, "photo_scaled", J),
      innerRadiusMm: v(22, "photo_scaled", J),
      outerRadiusMm: v(24.5, "photo_scaled", J),
      depthMm: v(1.6, "photo_scaled", J),
    ...
    },
    {
      ...
      profileId: "fujifilm-x/base",
      count: 1,
      centerAngleDeg: v(290, "photo_scaled", J),
      startAngleDeg: v(270, "photo_scaled", J),
      endAngleDeg: v(310, "photo_scaled", J),
      innerRadiusMm: v(22, "photo_scaled", J),
      outerRadiusMm: v(24.5, "photo_scaled", J),
      depthMm: v(1.6, "photo_scaled", J),
    ...
    },
    {
      ...
      outerRadiusMm: v(25.5, "photo_scaled", J),
      depthMm: naV(),
  ...
  lensSideFeatures: [
    ...
    },
    {
      ...
      outerRadiusMm: v(24, "photo_scaled", J),
      thicknessMm: naV(),
      matesWith: "",
  ...
  axialStack: [
    ...
    },
    {
      ...
      thicknessMm: v(1.6, "photo_scaled", J),
      diameterMm: v(46, "photo_scaled", J),
    },
    {
  ...
  contacts: [
    ...
    },
    {
      ...
      contactNo: 2,
      profileId: "fujifilm-x/base",
      centerAngleDeg: v(145, "photo_scaled", J),
      centerRadiusMm: v(20.5, "photo_scaled", J),
      widthMm: v(1.3, "photo_scaled", J),
      heightMm: v(2.6, "photo_scaled", J),
      shape: "pad",
  ...
  openQuestions: [
    {
      issue:
        "Lug angular spans, the mounting-index clock position, and the lock rotation angle/direction are photo-scaled or undocumented; per-contact clock positions are interpolated within the documented 4:30–7:30 band.",
