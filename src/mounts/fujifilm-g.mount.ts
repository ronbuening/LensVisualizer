...
const FUJIFILM_G_MOUNT = {
  ...
  cameraSideFeatures: [
    ...
    },
    {
      ...
      innerRadiusMm: v(32.5, "photo_scaled", J),
      outerRadiusMm: v(36, "photo_scaled", J),
      depthMm: v(2.2, "photo_scaled", J),
    ...
    },
    {
      ...
      outerRadiusMm: v(39.5, "photo_scaled", J),
      depthMm: naV(),
  ...
  lensSideFeatures: [
    ...
    },
    {
      ...
      startAngleDeg: v(0, "photo_scaled", J),
      endAngleDeg: v(360, "photo_scaled", J),
      innerRadiusMm: v(31.5, "photo_scaled", J),
      outerRadiusMm: v(38, "photo_scaled", J),
      thicknessMm: naV(),
      matesWith: "",
    ...
    },
    {
      ...
      innerRadiusMm: v(32.5, "photo_scaled", J),
      outerRadiusMm: v(36, "photo_scaled", J),
      thicknessMm: v(2.2, "photo_scaled", J),
    ...
    },
    {
      ...
      endAngleDeg: unknownV(J),
      innerRadiusMm: unknownV(J),
      outerRadiusMm: v(38.5, "photo_scaled", J),
      thicknessMm: naV(),
  ...
  contacts: [
    {
      ...
      profileId: "fujifilm-g/base",
      centerAngleDeg: v(150, "photo_scaled", J),
      centerRadiusMm: v(30, "photo_scaled", J),
  ...
  screwsGasketsBaffles: [
    {
      ...
      pcdMm: v(74, "photo_scaled", J),
      diameterMm: v(2.5, "photo_scaled", J),
