...
flowchart LR
  subgraph n_src_content["src/content"]
    ...
    n_src_content_src_content_AboutSite_md["AboutSite.md"]
    n_src_content_src_content_CardinalElementsPrimer_md["CardinalElementsPrimer.md"]
    n_src_content_src_content_from_achromat_to_apo_v4_1_md["from_achromat_to_apo_v4.1.md"]
    n_src_content_src_content_heliar_monograph_md["heliar_monograph.md"]
    n_src_content_src_content_LensDimensionsPrimer_md["LensDimensionsPrimer.md"]
    n_src_content_src_content_OpticsPrimerIntermediate_md["OpticsPrimerIntermediate.md"]
    n_src_content_src_content_OpticsPrimerSimple_md["OpticsPrimerSimple.md"]
    n_src_content_src_content_StartHere_md["StartHere.md"]
  end
```
