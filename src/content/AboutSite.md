...
Lens and comparison pages keep the current shareable view in the browser URL. Copy the address bar to share the selected element, glass map, chromatic aberration overlay, Petzval curvature overlay, analysis drawer, active analysis tab, and focus/aperture/zoom settings.
