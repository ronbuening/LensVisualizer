...
While not a Voigtländer product, the Kodak Ektar 100mm f/3.5 lens deserves mention in any comprehensive account of Heliar-type designs. In 1942, Kodak's lens designer Fred Altman designed ten Heliar-type lenses of varying focal lengths, speeds, and coverage specifications, one of which—the 100mm f/3.5—became the standard lens for the Kodak Medalist medium-format camera.[^20] Altman's designs were fully single-coated, even on the internal cemented surfaces, making them among the most anti-reflection-treated lenses produced to that date.
...
It is essential to understand from the outset that Cosina's Heliar lenses, while bearing the family name, are not continuations of the specific glass prescriptions of Harting or Tronnier. The optical formulas are entirely new, computed from scratch using modern optical design software, contemporary glass catalogs (including rare-earth lanthanum, fluorite, and aspherical glass types unavailable in the classical period), and modern manufacturing capabilities including CNC precision grinding and multi-layer anti-reflection coating.[^27] What was carried forward was not a formula but a *philosophy*: the Heliar as a mark of considered design, moderate speed, smooth rendering, and precision construction.
...
The **40mm f/2.8 Heliar Aspherical**, introduced in 2022 for both LTM and M-mount, represents a return to the classical Heliar formula at a semi-wide focal length. Its construction—five elements in three groups, with one aspherical element—is the closest of any current-production Cosina Heliar to the topological structure of the 1902 design.[^36] The collapsible barrel echoes the aesthetics of the 50mm f/3.5 Heliar in its LTM-mount 2001 incarnation and of classical Leica Elmar collapsible lenses.
...
Before either the Heliar Classic 50mm f/1.5 or the Portrait Heliar, Cosina produced a lens that receives less attention than it deserves: the **Heliar Classic 75mm f/1.8 VM**, released for Leica M-mount around 2014 and discontinued sometime around 2019.[^40] It is the direct M-mount antecedent of the Portrait Heliar 75mm f/1.8, and understanding it clarifies exactly what the Portrait Heliar advances beyond.
...
Contemporary reviews confirmed this character in practice. At f/1.8, the lens exhibited visible axial chromatic aberration, moderate field curvature, and a generally soft quality that some reviewers found charming and others found insufficient for demanding work. Sharpness at the center reached a genuinely excellent level only by f/4–f/5.6, with very good corners requiring f/8.[^41] The aperture blades were straight rather than curved, producing distinctive, well-defined sunstars rather than smooth out-of-focus specular highlights—a minor but telling detail about where the design priorities lay. One rangefinder forum analysis found that "the 75/1.8 at f/5.6 performs like the 75/2.5 at f/4," capturing the tradeoff precisely: the faster lens achieves parity with its slower predecessor, but at a greater aperture penalty.
...
The **Portrait Heliar 75mm f/1.8**, announced by Cosina in May 2025 for Sony E-mount and subsequently released for Nikon Z and Canon RF mounts in January 2026, represents the most technically sophisticated expression of the Heliar family's defining philosophical preoccupation: the deliberate management of spherical aberration as an expressive tool.[^42] Where the Universal-Heliar (c. 1926) offered a user-adjustable group-spacing mechanism for large-format soft-focus work, and where the Heliar Classic 50mm f/1.5 fixed its aberration character at a single calibrated level, the Portrait Heliar provides fully stepless, user-directed control over spherical aberration from under-correction to over-correction—the broadest range of bokeh expression available from any production Heliar.

### 20.1 Optical Construction

The Portrait Heliar employs six elements in three groups in a Heliar-type configuration, retaining the fundamental triplet-with-doublets topology while achieving an f/1.8 maximum aperture. Cosina specifies the construction as 3 groups and 6 elements; the official product pages do not identify any aspherical element, and the designation "Aspherical" appearing in some retail listings has not been confirmed by a primary Cosina technical source.[^42a] Cosina describes the normal correction state as delivering high resolution maintained to the image periphery with well-controlled color shifts—a baseline of competent modern performance, from which the SA control ring then departs.[^42] The nine-blade circular aperture diaphragm was chosen to maintain rounded highlight shapes across the aperture range. Physical dimensions: 88mm length, 70mm maximum diameter, 560g, 62mm filter thread, 0.7m minimum focus distance, 33.2° angle of view.
...
[^1]: Camerapedia contributors. "Heliar." *Camerapedia (Fandom)*. Accessed 2024. The description of the rendering as "sunlike" (*helios* = sun in Greek) is noted in multiple period sources and cited in subsequent photographic literature.

[^2]: Taylor, H.D. "Optical designing as an art." *Transactions of the Optical Society* 24 (1923): 143. For a modern treatment, see: Shaw, Joseph A. *Optical System Design: Triplets* (course notes, Montana State University, EELE 582).

[^3]: Kingslake, Rudolf. *A History of the Photographic Lens*. Academic Press, 1989. p. 100.

[^4]: Kingslake, p. 112; see also: "Tessar Lens Design." *Optics for Hire* (blog), September 23, 2024.

[^5]: Camera-wiki contributors. "Heliar." *Camera-wiki.org*. Citing: US Patent 716035 (1902), in the name of Carl Harting for Voigtländer. The British and German patents were granted in 1901.

[^6]: Smith, Warren J. *Modern Optical Engineering*, 4th ed. SPIE / McGraw-Hill, 2007. Chapter 11.

[^7]: Kingslake, Rudolf. *A History of the Photographic Lens*, pp. 115–116. Kingslake specifically attributes the first symmetric Heliar's failure to "excessive astigmatism and a large Petzval Sum."

[^8]: Camerapedia contributors. "Heliar." Citing Kingslake. The 1902 patent describes the revised design as "improvements of the previous design, for a lens not rendering the image perfectly true, but therefore correcting astigmatism, curvature and coma better than the original design."

[^9]: Greenleaf, Allen R. *Photographic Optics*. Macmillan, New York, 1950. pp. 80, 83.

[^10]: Period Voigtländer advertising, as quoted in multiple secondary sources including Camerapedia. See also: Rangefinderforum contributors. "Triumph of the Triplet" (forum thread), 2024.

[^11]: Camerapedia contributors. "Heliar." US Patent 756006 (Dynar). See also: Croell, Arne. *Voigtländer Large Format Lenses from 1949–1972*, p. 2 (arnecroell.com/voigtlaender.pdf).

[^12]: Croell, p. 2: "In performance terms, the Dynar was superior to the Heliar in all aspects but astigmatism." See also lens-db.com entry for Heliar 50mm f/2 (Cosina, 2009).

[^13]: Camera-wiki contributors. "Voigtländer." Citing the firm's New York branch office operations.

[^14]: Croell, p. 2, describes the glass types (flint outer meniscus, crown inner biconvex) in detail.

[^15]: Largeformatphotography.info forum contributors. "Voigtlander Heliar lens the ones from the late 1800–1900" (thread). Noting: "Around 1923, the Original Heliar layout was changed to the new 'Dynar' optics in the f/4.5 Heliar."

[^16]: Camera-wiki contributors. "Heliar." Citing the 1927 Voigtländer catalog at Camera Eccentric. The f/3.5 field angle of approximately 50° versus the f/4.5's 58° is confirmed in this source.

[^17]: Camera-wiki, "Heliar." 1927 catalog citation.

[^18]: Camerapedia, "Heliar." The Universal-Heliar ring settings from 0 (full definition) to 5 (maximum softness) are described, with the note that the lens used the original 1902 formula, not the Dynar layout.

[^19]: Croell, p. 4 (table of Universal-Heliar focal lengths and production notes).

[^20]: Camerapedia, "Heliar," citing Fred Altman's 1942 designs at Kodak.

[^21]: Camera-wiki, "Heliar." Tronnier is noted as having joined Voigtländer as a consultant in 1944.

[^22]: Camerapedia, "Heliar," citing US Patent 2,645,156 (1949). The Color-Heliar is confirmed as a recalculation of the f/3.5 Heliar.

[^23]: Camera-wiki, "Heliar." "A true redesign by Tronnier with the new Lanthan glass had better lens fault corrections, but was explicitly not marketed as Heliar but as APO-Lanthar since the Heliar's remaining lens faults were seen as the lens' characteristics!"

[^23a]: The use of ThO₂ in lanthanum optical glass was common across multiple manufacturers through the 1970s. For the Voigtländer Apo-Lanthar and related Lanthar series, see collector documentation at cameraquest.com and largeformatphotography.info. The radioactivity of thoriated glass is low-level and well within safe limits for photographic use, but measureable with a Geiger counter; specimens sometimes show elevated readings compared to background. Thoriated glass production was largely phased out in favor of rare-earth alternatives by the late 1970s.

[^24]: Camera-wiki, "Heliar." "Another good reason was that the new lens was the world's first apochromatic lens, meaning color-corrected for 3 instead of 2 spectral colors."

[^25]: Largeformatphotography.info forum. "A 1964 catalog that lists new production coated Heliars in Compounds." Link to cameraeccentric.com cited.

[^26]: Camerapedia, "Heliar." The 58mm f/2.4 Pentax lens is cited as a related Heliar-type 35mm design, but no classic-era Voigtländer 35mm Heliar is documented.

[^27]: Wikipedia contributors. "Cosina Voigtländer." "Note that while the lenses feature familiar Voigtländer names, the optical formulas are all new."

[^28]: Camera-wiki, "Heliar." The characterization of the Color-Heliar 75mm f/2.5 as resembling "a bastard of Voigtländer's Ultron and Zeiss's medium format Planar 2.8/100" is from a secondary analyst; Cosina specifies 5 groups/6 elements. See Cosina discontinued page for Color-Heliar 75mm F2.5 Silver L(L39), which lists 5群6枚 (5 groups, 6 elements).

[^28a]: Cosina Corporation. Discontinued product page: COLOR-HELIAR 75mm F2.5 Silver L(L39). cosina.co.jp/discontinued/color-heliar-75mm-f2-5-silver. Release date listed as September 1999 (発売日: 1999年9月); construction: 5 groups, 6 elements (レンズ構成: 5群6枚).

[^29]: *Popular Photography*, March 2002, p. 74. As quoted by CameraQuest (cameraquest.com/voig101.htm) and corroborated by multiple secondary sources.

[^30]: Lens-db.com entry for "Cosina Voigtlander Heliar 50mm f/2 LSM 'Cosina 50th Anniversary.'" "Cosina managed to increase the speed…to F/2 by using the newest ultra-high refractive index glass, while retaining the advantages of Heliar's original 5-element, 3-group optical design."

[^31]: B&H Photo product specification for Voigtlander Super Wide-Heliar 15mm f/4.5 Aspherical II. "Eight elements, six groups optical design incorporates one rear aspherical element." Consistent with the primary Cosina specification for V.I; the main change from V.I to V.II was the M-mount with rangefinder coupling, not the optical formula.

[^31a]: Cosina Corporation. Discontinued product page: SUPER WIDE-HELIAR 15mm F4.5 Aspherical L(L39). cosina.co.jp/discontinued/super-wide-heliar-15mm-f4-5-aspherical. Specifies 6 groups/8 elements (6群8枚). Product text: "非球面レンズをはじめとする最新のテクノロジー" — aspherical lens and other current-technology elements employed. Released February 1999; discontinued [date not listed on this page].

[^32]: B&H Photo product specification for Voigtlander Super Wide-Heliar 15mm f/4.5 Aspherical III. "11 elements, 9 groups design, incorporates one rear aspherical element."

[^33]: B&H Photo specification for Voigtlander Ultra Wide-Heliar 12mm f/5.6 Aspherical III. "12 elements, 10 groups."

[^34]: B&H Photo specification for Voigtlander Heliar-Hyper Wide 10mm f/5.6 (M-mount). "Two aspherical elements employed in the 13 elements, 10 groups optical design." The E-mount version specifies one aspherical element; the M-mount version two—representing an iterative improvement.

[^35]: Reeve, Phillip. "Review: Voigtländer 10mm 5.6 E Hyper Wide Heliar." *phillipreeve.net*. "Similar to the Voigtlander 12mm 5.6 Ultra Wide Heliar M39…this lens has a symmetrical optical design which allows for quite compact wide angle lenses with very low distortion."

[^36]: PetaPixel. "Cosina Unveils Voigtlander Heliar 40mm f/2.8 for L39 and VM-Mount." February 15, 2022. "Five lens in three group arrangement that includes a single aspherical element."

[^37]: B&H Photo Q&A section for Voigtlander Heliar 40mm f/2.8 Aspherical. Assessment attributed to Fred Miranda laboratory evaluation.

[^38]: B&H Photo specification for Voigtlander Heliar Classic 50mm f/1.5. "Six elements in three groups for vintage Heliar optical design…single coating only."

[^39]: CameraQuest (shop.cameraquest.com). "Voigtlander HELIAR Classic 50mm F1.5 VM." "Wide open the Voigtlander Heliar F1.5 uses coma and spherical aberration to provide a unique classic image signature that is impossible to achieve with modern highly corrected lenses."

[^40]: Cosina product page for the Heliar Classic 75mm f/1.8 VM (now archived; the page at cosina.co.jp/seihin/voigtlander/vm-mount/vm-75mm/ now returns a discontinued notice). See also: LeicaRumors, "Voigtlander Heliar 75mm f/1.8 VM lens review (with the Leica M10)," March 26, 2017; Steve Huff Photo, "The Voigtlander 75 1.8 VM Heliar Classic Lens Quick Review," May 2014. Specifications: 6 elements, 3 groups; 10-blade diaphragm; 52mm filter; 0.9m MFD; 427g.

[^41]: Reeve, Phillip. "Short Review: Voigtlander Heliar 75mm F1.8." *phillipreeve.net*. "At f/2.8 it is sharp in the center but it takes until f/4 until the center reaches an excellent level. For very good corners you should stop down to f/8." Also: Rangefinderforum.com, "Quantifying the 75/1.8 Heliar performance" thread: "the 75/1.8 at f5.6 performs like the 75/2.5 at f4."

[^42]: Cosina Corporation. "PORTRAIT HELIAR 75mm F1.8." Product page, cosina.co.jp, 2025. PetaPixel, "New Voigtlander Portrait Heliar 75mm f/1.8 Lens Lets Photographers Adjust Aberration and Bokeh," May 16, 2025. PRONEWS, "Voigtländer PORTRAIT HELIAR 75mm F1.8 Released," January 16, 2026 (Nikon Z / Canon RF). Berger Brothers full specification listing confirms: 6 elements, 3 groups, f/1.8–f/11, 9-blade aperture, 0.7m MFD, 33.2° AoV, 88mm length, 70mm diameter, 560g, 62mm filter. Announced May 2025 (E-mount); Nikon Z and Canon RF versions announced January 2026.

[^42a]: Cosina's Sony E-mount and Nikon Z-mount product pages both specify "3 groups / 6 elements" for the Portrait Heliar, with no aspherical notation in the official specification tables. The descriptor "Aspherical" appearing in some retail listings (notably B&H Photo) has not been confirmed by any primary Cosina technical document reviewed for this monograph and should be treated as unverified.

[^42b]: Cosina Corporation. Sony E-mount Portrait Heliar page: "the built-in distance encoder enables support for 5-axis image stabilization on the body side." Cosina Z-mount page (and consistent language across the Nikon Z series): "in addition to Exif information and in-body image stabilization (3 axes)." Canon RF mount stabilization support is not specified in reviewed sources; readers should consult the current Cosina RF-mount product page for current specifications.
...
| Design | Year | Patent | Elements / Groups | Topology | Marketed Name | Primary Change from Predecessor |
|---|---|---|---|---|---|---|
| Symmetric Heliar | 1901–02 | US716035A (filed 1901, pub. 1902) | 5 / 3 | Cemented doublet – singlet – cemented doublet; symmetric | Heliar | Original formulation |
| Asymmetric Heliar | 1902 | (revised from above) | 5 / 3 | Same topology; front and rear groups differ in scale and focal length | Heliar | Asymmetry reduces astigmatism and Petzval sum |
| Dynar | 1903–04 | US756006 | 5 / 3 | Doublet orientation reversed vs. 1902 Heliar; convex cemented faces inward | Dynar | Orientation reversal; better resolution, marginally worse astigmatism |
| Commercial f/3.5 Heliar | c. 1923–25 | — | 5 / 3 | Dynar layout adopted under Heliar name | Heliar f/3.5 | Faster aperture; Dynar formula marketed as Heliar |
| Universal-Heliar | c. 1926 | — | 5 / 3 | 1902 asymmetric formula + adjustable central-element spacing | Universal-Heliar | User-adjustable SA via central-element ring (settings 0–5) |
| Color-Heliar (Tronnier) | 1949–50 | US2645156A (filed 1949) | 5 / 3 | Dynar-type recalculated with postwar glass; single-coated | Color-Heliar | Coated; chromatic correction for color film |
| Color-Heliar 75mm f/2.5 | 1999 | — | 6 / 5 | Multi-group design; secondary sources suggest Gauss-derived heritage | Color-Heliar 75mm F2.5 | First Cosina-era Heliar in portrait tradition; modern glass |
| Super Wide-Heliar 15mm V.I | 1999 | — | 8 / 6 | Near-symmetric ultra-wide; one aspherical element | Super Wide-Heliar 15mm F4.5 Aspherical | First Cosina ultra-wide rectilinear Heliar |
| Super Wide-Heliar 15mm V.II | c. 2004 | — | 8 / 6 | Same formula as V.I; M-mount with rangefinder coupling added | Super Wide-Heliar 15mm F4.5 Aspherical | Mount and rangefinder coupling |
| 50mm f/3.5 Heliar | 2001 | — | 5 / 3 | Classical 1902 topology recomputed in modern glass; multi-coated | Heliar 50mm F3.5 | First true classical-topology Cosina Heliar |
| 50mm f/2 Heliar | 2009 | — | 5 / 3 | Same topology at f/2 via ultra-high-index glass | Heliar 50mm F2 | One-stop speed gain within classical topology |
| Super Wide-Heliar 15mm V.III | c. 2015 | — | 11 / 9 | Redesigned for digital sensor telecentricity; one aspherical element | Super Wide-Heliar 15mm F4.5 Aspherical III | Digital-era redesign; 3 additional elements |
| Ultra Wide-Heliar 12mm | (current) | — | 12 / 10 | Near-symmetric; aspherical element(s) | Ultra Wide-Heliar 12mm F5.6 Aspherical III | Wider AoV; more complex than 15mm V.III |
| Heliar-Hyper Wide 10mm | c. 2016 | — | 13 / 10 | Near-symmetric; two aspherical elements | Heliar-Hyper Wide 10mm F5.6 | Widest rectilinear Heliar; two asphericals |
| Heliar Classic 75mm f/1.8 VM | c. 2014 | — | 6 / 3 | Heliar-type with intentional aberration at wide aperture | Heliar Classic 75mm F1.8 VM | First "Classic" sub-brand; M-mount; discontinued c. 2019 |
| Heliar 40mm f/2.8 Aspherical | 2022 | — | 5 / 3 + 1 asp. | Classical topology + one aspherical surface | Heliar 40mm F2.8 Aspherical | Classical revival; aspherical for digital performance |
| Heliar Classic 50mm f/1.5 | 2021 | — | 6 / 3 | Heliar-type; intentional SA/coma; single-coated | Heliar Classic 50mm F1.5 | Fixed intentional aberration; fastest production Heliar |
| Portrait Heliar 75mm f/1.8 | 2025 | — | 6 / 3 | Heliar-type; user-adjustable SA control ring with inter-group compensation | Portrait Heliar 75mm F1.8 | First mechanized user-adjustable SA control in a Cosina Heliar |
