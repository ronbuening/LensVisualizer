...
```mermaid
flowchart LR
  subgraph n_src_content_pupils["src/content/pupils"]
    n_src_content_pupils_src_content_pupils_ApertureStopMonograph_md["ApertureStopMonograph.md"]
    n_src_content_pupils_src_content_pupils_CornerIllumination_md["CornerIllumination.md"]
    n_src_content_pupils_src_content_pupils_EntrancePupil_md["EntrancePupil.md"]
    n_src_content_pupils_src_content_pupils_ExitPupil_md["ExitPupil.md"]
    n_src_content_pupils_src_content_pupils_MirrorlessDesign_md["MirrorlessDesign.md"]
    n_src_content_pupils_src_content_pupils_ProjectionCenter_md["ProjectionCenter.md"]
    n_src_content_pupils_src_content_pupils_PupilGeometryIndex_md["PupilGeometryIndex.md"]
    n_src_content_pupils_src_content_pupils_Telecentricity_md["Telecentricity.md"]
    n_src_content_pupils_src_content_pupils_WorkingFNumber_md["WorkingFNumber.md"]
  end
```
