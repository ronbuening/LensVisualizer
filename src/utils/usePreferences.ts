...
export default function usePreferences(state: LensState): void {
  ...
  useEffect(() => {
    const prefs = {
      ...
      showCardinalPrincipal: rays.showCardinalPrincipal,
      showCardinalNodal: rays.showCardinalNodal,
      showCardinalDimensions: rays.showCardinalDimensions,
      showCardinalEfl: rays.showCardinalEfl,
      showCardinalBfd: rays.showCardinalBfd,
      showCardinalFfd: rays.showCardinalFfd,
      showCardinalHiatus: rays.showCardinalHiatus,
      showCardinalTotalTrack: rays.showCardinalTotalTrack,
