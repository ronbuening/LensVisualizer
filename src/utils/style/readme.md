...
- External consumers: src/comparison, src/components/content, src/components/controls, src/components/display, src/components/layout, src/components/relationshipMap, src/pages/ArticlePage.tsx, src/pages/ArticlesPage.tsx, +14 more

## Files

| File | Role | Imports from | Imported by | Exports |
| --- | --- | --- | --- | --- |
| `pageStyles.ts` | Page Styles helper module | package:react | src/components/content (2), src/pages/lensIndex (2), src/components/layout, src/components/relationshipMap, src/pages/ArticlePage.tsx, +14 more | STICKY_NAV_SCROLL_MARGIN, PAGE_BASE_STYLE, H1_STYLE, SECTION_HEADING_BASE_STYLE, LENS_LINK_BASE_STYLE |
