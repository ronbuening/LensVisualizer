...
| `patentRecords.ts` | Patent Records helper module | same folder (2), src/types | same folder (2), src/components/content | PatentJurisdiction, PatentRecord, AggregatePatentOptions, isPatentPublicationNumber, espacenetPatentUrl, patentJurisdiction, aggregatePatentRecords |
