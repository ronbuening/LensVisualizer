...
flowchart LR
  ...
  n_src_utils_catalog_src_utils_catalog_lensSummaries_ts --> n_src_utils_catalog_src_utils_catalog_lensTaxonomy_ts
...
- Direct subfolders: 0
- Main outbound areas: same folder (17), src/generated (6), src/types (4), src/utils/seo (3), glob:../../lens-data/**/*.analysis.md, glob:../../lens-data/**/*.data.ts, src/comparison, src/lens-data/defaults.ts, +1 more
...
| --- | --- | --- | --- | --- |
| `assigneeCatalog.ts` | Assignee Catalog helper module | src/generated | same folder (2), src/components/relationshipMap (2), src/pages/RelationshipMapPage.tsx | AssigneeMetadata, ASSIGNEES, getAssigneeBySlug, getAssigneeByName |
| `authorAssignees.ts` | Author Assignees helper module | same folder (2) | src/pages/AuthorsIndexPage.tsx | ALL_AUTHOR_ASSIGNEES, UNASSIGNED_AUTHORS, AuthorDirectoryEntry, AuthorAssigneeStratum, AUTHOR_DIRECTORY_ENTRIES, AUTHOR_ASSIGNEE_STRATA, UNASSIGNED_AUTHOR_COUNT, filterAuthorsByAssignee |
...
| `lensCatalog.ts` | Lens Catalog helper module | glob:../../lens-data/**/*.analysis.md, glob:../../lens-data/**/*.data.ts, src/lens-data/defaults.ts, src/types, src/utils/chunkLoadRetry.ts | src/components/layout (4), src/components/hooks (2), src/benchmarks, src/comparison, src/pages/ComparePage.tsx, +2 more | OpticalConfigurationOption, LENS_CATALOG, ALL_CATALOG_KEYS, CATALOG_KEYS, DEBUG_CATALOG_KEYS, isDebugLensKey, opticalConfigurationOptionsForKey, hasMdForKey, +2 more |
