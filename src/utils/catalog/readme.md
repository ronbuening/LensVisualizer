...
| `collation.ts` | Collation helper module | none | same folder (8), src/pages/lensIndex (3), src/pages/AuthorsIndexPage.tsx, src/pages/MakersIndexPage.tsx, src/pages/MountPage.tsx, +1 more | catalogCollator |
...
| `lensSummaries.ts` | Lens Summaries helper module | src/generated (2), same folder, src/types | same folder (4), src/components/homepage (2), src/pages/lensIndex (2), src/pages/HomePage.tsx, src/pages/LensIndexPage.tsx, +4 more | LensSummary, LENS_SUMMARIES, ALL_SUMMARY_KEYS, SUMMARY_KEYS, DEBUG_SUMMARY_KEYS, isDebugSummaryKey, ALL_LENSES_BY_DATE, RECENT_LENS_KEYS, +1 more |
...
| `patentCatalog.ts` | Patent Catalog helper module | same folder (8), src/types | src/pages/PatentsIndexPage.tsx | aggregatePatentRecords, patentJurisdiction, PatentJurisdiction, PatentRecord, PatentLens, PatentAssigneeGroup, PatentCountryGroup, PatentIndex, +5 more |
| `patentRecords.ts` | Patent Records helper module | same folder (2), src/types | same folder (2) | PatentJurisdiction, PatentRecord, AggregatePatentOptions, patentJurisdiction, aggregatePatentRecords |
