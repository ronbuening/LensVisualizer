...
| `collation.ts` | Collation helper module | none | same folder (9), src/pages/lensIndex (3), src/components/relationshipMap, src/pages/AuthorsIndexPage.tsx, src/pages/MakersIndexPage.tsx, +2 more | catalogCollator |
...
| `universalRelationshipGraph.ts` | Universal Relationship Graph helper module | same folder (6) | src/components/relationshipMap (3), src/pages/UniversalRelationshipMapPage.tsx | UniversalNodeKind, UniversalPartyNode, UniversalPatentNode, UniversalCorporateNode, UniversalRelationshipNode, UniversalEdgeKind, UniversalRelationshipEdge, UniversalRelationshipStats, +4 more |
