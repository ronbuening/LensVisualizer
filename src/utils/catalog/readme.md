...
flowchart LR
  subgraph n_src_utils_catalog["src/utils/catalog"]
    ...
    n_src_utils_catalog_src_utils_catalog_groupByNamedParty_ts["groupByNamedParty.ts"]
    ...
    n_src_utils_catalog_src_utils_catalog_patentRecords_ts["patentRecords.ts"]
  ...
  n_src_utils_catalog_src_utils_catalog_universalRelationshipGraph_ts --> n_src_utils_catalog_src_utils_catalog_assigneeCatalog_ts
...
- External consumers: src/benchmarks, src/comparison, src/components/content, src/components/controls, src/components/display, src/components/homepage, src/components/hooks, src/components/layout, +32 more

## Files

| File | Role | Imports from | Imported by | Exports |
| --- | --- | --- | --- | --- |
| `assigneeCatalog.ts` | Assignee Catalog helper module | src/types (2), src/generated | same folder (3), src/components/relationshipMap (2), src/pages/RelationshipMapPage.tsx | AssigneeMetadata, ASSIGNEES, getAssigneeBySlug, getAssigneeByName |
...
| `collation.ts` | Collation helper module | none | same folder (10), src/components/relationshipMap (3), src/pages/lensIndex (3), src/pages/AuthorsIndexPage.tsx, src/pages/MakersIndexPage.tsx, +2 more | catalogCollator |
...
| `lensTaxonomy.ts` | Lens Taxonomy helper module | none | src/pages/lensIndex (7), same folder (3), src/types (3), src/optics/perspective (2), src/components/display, +8 more | LENS_MOUNTS, LensMountId, LensMountMetadata, LENS_MOUNT_BY_ID, isLensMountId, IMAGE_FORMATS, ImageFormatId, ImageFormatMetadata, +4 more |
...
| `patentRecords.ts` | Patent Records helper module | same folder (2), src/types | same folder (3), src/components/content | PatentJurisdiction, PatentRecord, AggregatePatentOptions, isPatentPublicationNumber, docdbPublicationNumber, espacenetPatentUrl, patentJurisdiction, aggregatePatentRecords |
