...
const T = {
  dark: createTheme({
    ...
    asphStroke: "rgba(255,110,180,0.65)", asphLabel: "rgba(255,130,190,0.80)", asphStrokeWidth: 1.4,
  ...
  light: createTheme({
    ...
    asphStroke: "rgba(180,40,100,0.60)", asphLabel: "rgba(160,30,90,0.85)", asphStrokeWidth: 1.4,
  ...
  darkHC: createTheme({
    ...
    asphStroke: "rgba(255,100,170,0.80)", asphLabel: "rgba(255,120,185,0.90)", asphStrokeWidth: 1.7,
  ...
  lightHC: createTheme({
    ...
    asphStroke: "rgba(165,30,85,0.75)", asphLabel: "rgba(150,20,75,0.92)", asphStrokeWidth: 1.7,
