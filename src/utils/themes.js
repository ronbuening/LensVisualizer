...
const T = {
  dark: createTheme({
    ...
    rayOffDash: "5,3",
    rayChromR: "rgba(255,60,60,0.55)", rayChromG: "rgba(60,200,60,0.55)", rayChromB: "rgba(60,100,255,0.55)",
    chromDispHigh: "rgba(255,100,60,0.70)", chromDispMid: "rgba(200,180,80,0.55)", chromDispLow: "rgba(80,200,120,0.45)",
    ...
    asphStroke: "rgba(255,110,180,0.65)", asphLabel: "rgba(255,130,190,0.80)", asphStrokeWidth: 1.4, asphDiamondFill: "rgba(255,110,180,0.18)",
  ...
  light: createTheme({
    ...
    rayOffDash: "5,3",
    rayChromR: "rgba(200,30,30,0.55)", rayChromG: "rgba(20,150,20,0.55)", rayChromB: "rgba(30,60,200,0.55)",
    chromDispHigh: "rgba(200,50,20,0.70)", chromDispMid: "rgba(140,120,30,0.55)", chromDispLow: "rgba(30,140,60,0.45)",
    ...
    asphStroke: "rgba(180,40,100,0.60)", asphLabel: "rgba(160,30,90,0.85)", asphStrokeWidth: 1.4, asphDiamondFill: "rgba(180,40,100,0.14)",
  ...
  darkHC: createTheme({
    ...
    rayOffDash: "5,3",
    rayChromR: "rgba(255,50,50,0.70)", rayChromG: "rgba(50,220,50,0.70)", rayChromB: "rgba(50,90,255,0.70)",
    chromDispHigh: "rgba(255,90,50,0.85)", chromDispMid: "rgba(220,200,70,0.70)", chromDispLow: "rgba(70,220,110,0.60)",
    ...
    asphStroke: "rgba(255,100,170,0.80)", asphLabel: "rgba(255,120,185,0.90)", asphStrokeWidth: 1.7, asphDiamondFill: "rgba(255,100,170,0.22)",
  ...
  lightHC: createTheme({
    ...
    rayOffDash: "5,3",
    rayChromR: "rgba(180,20,20,0.70)", rayChromG: "rgba(10,130,10,0.70)", rayChromB: "rgba(20,50,180,0.70)",
    chromDispHigh: "rgba(180,40,10,0.85)", chromDispMid: "rgba(120,100,20,0.70)", chromDispLow: "rgba(20,120,50,0.60)",
    ...
    asphStroke: "rgba(165,30,85,0.75)", asphLabel: "rgba(150,20,75,0.92)", asphStrokeWidth: 1.7, asphDiamondFill: "rgba(165,30,85,0.18)",
