 ...
 *
 * Semi-diameters: the patent publishes ray-used effective-aperture radii, not physical rims. The initial
 * model uses 1.02× those radii where geometry permits. S7A/S8A are reduced together to preserve 0.020 mm
 * minimum L4 edge thickness because the raw Table-4 aspheres cross at the published S7 effective radius.
 * S13A/S14A are capped just below a 60° actual aspheric rim-slope crossing. These are modeled clear rims,
 * not manufacturing dimensions, and the source effective-aperture inconsistency is retained in the audit.
 *
 * Model limitation: the geometry-safe rims do not preserve the full nominal f/1.5 axial pupil under an independent
 * exact meridional replay of the final aspheres. The default 0.83 wide-open pupil sample reaches S7A at
 * 1.117804589 mm, outside the 1.060261096 mm modeled rim; the largest clear axial launch is about
 * 1.150091158 mm (EFL/diameter proxy f/1.87525). Enlarging L4 enough to pass that bundle conflicts with the
 * unmodified S7A/S8A source geometry, so no unsupported prescription edit is made.
 *
 * Aspheres: the patent equation uses a negative conic-base term. LensVisualizer uses the opposite sag
 * sign, so R and K are retained while every published polynomial coefficient A…J is negated into A4…A20.
 * No scale is applied. Focus status is NO_INTERNAL_RECONSTRUCTION: no focus-dependent spacing is invented.
 */
...
const LENS_DATA = {
  ...
  subtitle: "US 2021/0149156 A1 Example 1 — Galaxy S9 correlation inferred, not manufacturer-confirmed",
  specs: [
    "7 ELEMENTS / 7 GROUPS",
    "4.3 mm NOMINAL",
  ...
  surfaces: [
    ...
    { label: "2A", R: 6.2991055, d: 0.145, nd: 1.0, elemId: 0, sd: 1.35762 },
    { label: "3A", R: 8.2729295, d: 0.2, nd: 1.661, elemId: 2, sd: 1.27908 },
    { label: "4A", R: 3.5690962, d: 0.17, nd: 1.0, elemId: 0, sd: 1.173 },
    { label: "5A", R: 3.731059, d: 0.334, nd: 1.544, elemId: 3, sd: 1.173 },
    { label: "6A", R: 3.7619952, d: 0.047, nd: 1.0, elemId: 0, sd: 1.1934 },
    { label: "7A", R: 2.662169, d: 0.23, nd: 1.544, elemId: 4, sd: 1.060261095779862 },
    { label: "8A", R: 5.1499618, d: 0.469, nd: 1.0, elemId: 0, sd: 1.060261095779862 },
    { label: "9A", R: -1000.0, d: 0.311, nd: 1.661, elemId: 5, sd: 1.326 },
    { label: "10A", R: -1000.0, d: 0.197, nd: 1.0, elemId: 0, sd: 1.57896 },
    { label: "11A", R: 1000.0, d: 0.567, nd: 1.639, elemId: 6, sd: 1.75542 },
    { label: "12A", R: -1000.0, d: 0.143, nd: 1.0, elemId: 0, sd: 2.295 },
    { label: "13A", R: 1.6880487, d: 0.535, nd: 1.534, elemId: 7, sd: 2.4595999593659976 },
    { label: "14A", R: 1.1730407, d: 1.019463768115942, nd: 1.0, elemId: 0, sd: 2.2711305108534736 },
  ],
