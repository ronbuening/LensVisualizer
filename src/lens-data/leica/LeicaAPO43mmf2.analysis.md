...
The parallel plate P (nd = 1.51680, νd = 64.2) is an N-BK7-class plate (S-BSL7 is the 1.51633 variant). In the Q3 43, this represents the combined IR-cut / low-pass filter stack in front of the sensor. The data file models the 1.40 mm plate and its 1.00 mm air gap to the image in `rearPlates`, with the patent's 3.60 mm gap from L11 to the plate on the last lens surface: every analysis traces the plate, but it is not drawn. Its paraxial equivalent is an air-equivalent rear space of 3.60 + 1.40/1.5168 + 1.00 = 5.52 mm, which reproduces the patent's infinity focus to 0.01 mm; the patent's own BF figure of 6.00 mm (used in Inequality (4)) is the geometric distance including the plate.
