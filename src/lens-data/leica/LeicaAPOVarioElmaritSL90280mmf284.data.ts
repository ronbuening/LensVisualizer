...
const LENS_DATA = {
  ...
  specs: [
    ...
    "2ω = 26.4–8.8°",
    "ALL SPHERICAL — NO ASPHERICAL SURFACES",
    "7 APD ELEMENTS (3× S-FPL55, S-FPL51, 2× 593/670, S-FSL5)",
    "OIS (G4C, 3 elements)",
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 67.0,
      fl: -119.3,
      glass: "Phosphate crown, 593/670 code (unmatched OHARA; closest CDGM H-ZPK2A)",
      apd: "inferred",
    ...
    },
    {
      ...
      vd: 67.0,
      fl: -186.5,
      glass: "Phosphate crown, 593/670 code (same as L5, unmatched OHARA)",
      apd: "inferred",
    ...
    },
    {
      ...
      apd: false,
      cemented: "D6",
      role: "Niobium flint carrying bulk of G5 negative power; mildly anomalous partial dispersion.",
    },
