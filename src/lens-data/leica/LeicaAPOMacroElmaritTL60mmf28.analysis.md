...
A parallel flat plate (surfaces 21–22, 1.500 mm thick, nd = 1.52249, νd = 59.48) representing the sensor cover glass and filter stack follows Gr3, 13.369 mm behind the last lens surface and 0.800 mm ahead of the image. The data file models it in `rearPlates` (S-NSL5 class): every analysis traces it, but it is not drawn. Its air-equivalent back focus, 13.369 + 1.500/1.52249 + 0.800 = 15.154 mm, matches the patent's printed BF.
