...
The source rear plane-parallel plate PT (surfaces 22–23: 1.410 mm, nd = 1.51680, νd = 64.20), which the patent describes as equivalent to the image-sensor cover glass, is modeled in `rearPlates`: surface 21A keeps the printed 21.790 mm air gap to PT, and the plate is followed by the printed 0.800 mm air gap to the image plane. Every analysis traces the plate, but the diagram does not draw it. Its paraxial air equivalent is 21.790 + 1.410/1.51680 + 0.800 = 23.5195886 mm from 21A to the image plane, so effective focal length and paraxial image position are identical to an all-air normalization; the physical track includes the plate and is 1.410 × (1 − 1/1.51680) = 0.480 mm longer than that air-equivalent path.
...
The patent publishes no clear-aperture semi-diameters. The front surface is estimated at 26.5 mm from FIG. 1 optical rims. Rear L32 uses 21.5 mm at 20A and 19.5 mm at 21A: the latter is capped below the polynomial slope reversal near 20 mm, even though the schematic suggests a larger rim. L15’s front S8 rim is 24.8 mm, matching the S9 cemented-interface height in FIG. 1 and removing an unsupported overhang. Remaining apertures retain the ray-envelope estimates. These are modeled optical extents, not mechanical blank diameters or production dimensions.
