...
| L8 | 15–16 | 1.80809 | 22.74 | +172.4 | Pos. meniscus (concave to obj.) | S-NPH1-type (ΔPgF ≈ +0.029); 4th ED candidate | G3/GR |
| L9 | 17–(18) | 1.85451 | 25.15 | −62.7 | Biconcave negative | Anomalous high-index flint | G3/GR |
| L10 | (18)–19 | 1.59319 | 67.90 | +276.3 | Pos. meniscus (convex to obj.) | Phosphate crown | G3/GR |
...
Although the low Abbe number might suggest L8 is an ordinary high-dispersion flint, the OHARA catalog reveals that S-NPH1 possesses strong positive anomalous partial dispersion: ΔPgF = +0.0261 on OHARA's normal line, or approximately +0.029 relative to the patent's own normal-line formula (0.6415 − 0.00162 × νd). This anomalous dispersion is larger than L5's patent-stated ΔPgF of +0.010 and approaches L1's (SR) value of +0.035. In other words, S-NPH1 bends short-wavelength light disproportionately more than a "normal" glass of the same Abbe number would, making it functionally analogous to an ED glass for purposes of secondary spectrum correction — but operating from the high-dispersion side of the Abbe diagram rather than the low-dispersion side.

**Regarding the fourth ED element:** The production NIKKOR Z 135mm f/1.8 S Plena is marketed as having four ED elements. The patent Example 1 contains exactly three elements using traditional high-νd fluorophosphate ED glass (L2, L3, L4 at νd = 82.57). The fourth element counted as "ED" cannot be definitively identified from the patent prescription alone. The strongest candidate is L8: while its Abbe number is low, its strong anomalous partial dispersion serves the same secondary-spectrum-correcting function that defines the ED glass category in modern lens design. Nikon may classify L8 under a broader "ED" designation based on chromatic correction function rather than Abbe number alone. Alternatively, the production lens could differ from Example 1 in one glass substitution. This identification remains inferential.
...
L9 (nd = 1.85451, νd = 25.15, same glass as L5) and L10 (nd = 1.59319, νd = 67.90) form a cemented doublet within G3. Like the L4+L5 doublet in the front group, the patent designates this combination as a 接合負レンズ — a cemented negative lens. L9 is biconcave (fl = −62.7 mm) and L10 is a weak positive meniscus (fl = +276.3 mm), giving the pair a net thick-lens focal length of approximately −80 mm. The net negative power contributes to Petzval sum correction, while the pairing of L9's anomalous-dispersion flint (ΔPgF = +0.010, same glass as L5) with L10's phosphate crown provides local chromatic balancing within G3. The glass for L10 (nd = 1.59319, νd = 67.90) is consistent with OHARA S-PHM52 or a similar phosphate crown glass with moderate index and low dispersion.
...
**G3 (L8–L12):** The main rear corrector group, containing five elements in three optical subassemblies: L8 alone (high anomalous dispersion, ΔPgF ≈ +0.029), the L9+L10 cemented doublet (net-negative, fl ≈ −80 mm, contributing Petzval correction), and L11+L12 as an air-spaced corrector pair. L11 (Pr) is the strongest positive element in the rear group (fl = +48.9 mm), providing the converging power needed to form the image. The chromatic pairing within this group — L8's anomalous high-dispersion glass balanced against L10 and L12's moderate crowns — counterbalances the chromatic contributions of the front group.
...
- OHARA optical glass catalog (glass identification reference; S-NPH1 datasheet for ΔPgF = +0.0261)
