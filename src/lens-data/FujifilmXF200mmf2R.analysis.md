...
| Element | Role | R₁ | R₂ | n\_d / ν\_d | f (mm) |
|---|---|---:|---:|---|---:|
| **L3a** | Negative meniscus (front concave) | +36.13 | +23.92 | 1.60342 / 38.03 | −126.19 |
...
| **L3c** | Negative meniscus — lanthanum crown | −91.48 | +42.92 | 1.73400 / 51.47 | −39.61 |
| **L3d** | Negative meniscus — dense lanthanum flint | −217.24 | +66.63 | 1.80100 / 34.97 | −63.52 |
...
| **L3f** | Negative meniscus — NPH flint | −77.96 | +145.86 | 1.80809 / 22.76 | −62.70 |
...
| **L3i** | Negative meniscus — rear of cemented pair | −53.25 | +154.30 | 1.80000 / 29.84 | −49.29 |
...
* **L3f is a strongly negative meniscus** in the same **OHARA S‑NPH1** (808 228) niobophosphate ultra‑high‑dispersion flint as L1g. L3f follows L3e across a thin air gap (1.06 mm) and precedes L3g across a larger air gap (4.43 mm); the close L3e–L3f coupling functions as an achromatic pair (positive high‑index + negative ultra‑high‑dispersion), while the larger L3f–L3g separation lets L3g act as a separate positive relay rather than as part of a true triplet.
...
|---|---|---:|---:|---:|---|---|
| L1a | 673 321 | 1.67270 | 32.10 | 0.599 | OHARA **S‑TIM25** (673 323; ν\_d differs by 0.02, nd differs by 0.00003) | Dense flint |
...
| L1h | 800 298 | 1.80000 | 29.84 | 0.602 | OHARA **S‑NBH55** (800 299; ν\_d differs by 0.01) | Niobium flint |
...
| L3e | 904 313 | 1.90366 | 31.31 | 0.595 | OHARA **S‑LAH95** (904 313; exact match) | Dense lanthanum flint |
...
| L3h | 654 397 | 1.65412 | 39.73 | 0.574 | OHARA **S‑NBH5** (654 397; exact match) | Niobium flint |
| L3i | 800 298 | 1.80000 | 29.84 | 0.602 | OHARA **S‑NBH55** (same as L1h) | Niobium flint |

All identifications were made by matching the patent's reported n\_d and ν\_d values against the current OHARA pocket catalog (May 2023 edition). Twelve of the nineteen elements have exact OHARA catalog matches; one element (L1f, 911 353) has no current OHARA equivalent and corresponds to a HOYA TAFD35‑family ultra‑dense lanthanum flint per the HOYA cross‑reference table. Where catalogues differ in the second decimal of ν\_d (L1a, L1h, L3i), the residuals (0.01–0.02) are within typical melt‑to‑melt tolerances. Since Fujifilm is based in Japan, OHARA and HOYA are the most plausible vendors; SUMITA and HIKARI also offer equivalents at the same six‑digit codes under different trade names. Note that OHARA's current catalog is entirely "eco" (lead‑ and arsenic‑free) — the S‑ prefix — and older leaded equivalents are no longer manufactured; the identifications above refer to optical formulations, not to specific product codes.
...
Fujifilm's published "three ED elements" specification (one Super ED + two ED) therefore understates the chromatic correction complexity: the full system also relies on two S‑NPH1 ultra‑high‑dispersion flint elements (L1g, L3f, each with Δθ\_gF ≈ +0.026) and one S‑NPH3 ultra‑dense flint element (L3b, Δθ\_gF ≈ +0.046) to support the secondary‑spectrum correction. In total, **six** of the nineteen elements carry meaningfully anomalous partial dispersion (|Δθ\_gF| exceeding 0.02).
...
Glass identifications were made by matching the patent's published n\_d and ν\_d values against the OHARA pocket catalog (May 2023 edition) and the HOYA optical glass cross‑reference table. Twelve of nineteen elements have exact OHARA S‑prefix (eco glass) matches; one (L1f, 911 353) has no current OHARA equivalent and matches HOYA TAFD35; the remaining six elements have OHARA matches within a second‑decimal ν\_d tolerance consistent with melt‑to‑melt variation.
