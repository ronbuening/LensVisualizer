 ...
 * ║                                                                                     ║
 * ║  SPECTRAL FIELDS:                                                                ║
 * ║    Numerical Data 4 publishes nd, νd and θgF, but not nC/nF/ng or ΔPgF.            ║
 ...
 * ║    manufacturer-constrained or Unmatched. Runtime Sellmeier resolution is used only ║
 * ║    where the annotation round-trips against the stored patent nd/νd coordinates.║
 * ║                                                                                     ║
...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 95.1,
      fl: 109.196204,
      glass: "Canon Super UD (manufacturer-constrained; public catalog unresolved)",
      cemented: "D1",
    },
    {
      id: 8,
    ...
    },
    {
      ...
      vd: 35.64,
      fl: 55.385866,
      glass: "Unmatched (nd=1.66565, vd=35.64, theta_gF=0.5824)",
      cemented: "D4",
    },
    {
      id: 16,
