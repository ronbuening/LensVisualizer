...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      glass: "497815 — K-PFK80 compatible low-dispersion spectral proxy; patent vendor unspecified",
      apd: "patent",
      dPgF: 0.032,
    ...
    },
    {
      ...
      glass: "497815 — K-PFK80 compatible low-dispersion spectral proxy; patent vendor unspecified",
      apd: "inferred",
      apdNote: "APD inferred from the coordinate-compatible K-PFK80 catalog dispersion curve; the patent does not identify the supplier or publish this element’s partial dispersion.",
    },
    {
      id: 14,
      name: "L14",
