...
- Glass: 666356 dense flint, nd = 1.66565, νd = 35.64, ΔθgF = −0.0018
...
The granted patent family publishes θgF and ΔθgF for the glass rows in Numerical Data 2. The data file stores those ΔθgF values as `dPgF` so the chromatic fallback path retains the patent's partial-dispersion intent for unresolved code-only glasses such as G5/G10's 666356 flint.
