...
The surface-by-surface Petzval sum, using `φ/(n·n′)` at every refracting surface, is `+0.001397834967 mm⁻¹`; its reciprocal radius is `+715.392034 mm`. The inferred apertures give a minimum element edge thickness of 0.328266 mm at L32, a maximum actual spherical rim angle of 53.8627° at surface 4, and a minimum 90%-gap margin of 0.012219 mm between surfaces 13 and 14. No hidden surface trim is required.
