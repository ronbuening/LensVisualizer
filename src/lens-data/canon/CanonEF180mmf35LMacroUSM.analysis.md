...
This is a **PUBLISHED** focus model, not a reconstructed mechanism. The data file stores all four published rows as exact focus keyframes at inverse-distance slider coordinates `0`, `0.22912992694228013`, `0.7323745404242055`, and `1`. Runtime motion between those source states is piecewise-linear visualization; it should not be mistaken for a claim that Canon's unreported continuous trajectories are linear.
