...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 18.0,
      fl: 61.7,
      glass: "946180 — ultra-high-index dense flint (nd=1.94595, νd=18.0)",
      apd: false,
    ...
    },
    {
      ...
      vd: 48.5,
      fl: 57.69,
      glass: "764485 — Hikari/CDGM lanthanum flint class (nd=1.76385, νd=48.5)",
      apd: false,
   ...
   */
  focusPositions: [0, 0.6930029866667374, 1],
  var: {
    STO: [3.1, 11.72, 27.41],
    "20": [27.41, 18.8, 3.1],
    "25": [4.17, 11.48, 29.5],
