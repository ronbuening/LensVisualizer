...
No `nC`, `nF`, `ng`, `PgF`, or `dPgF` values are authored because Example 1 does not publish them. All 20 elements resolve to coordinate-compatible catalog Sellmeier curves, including the supplier-unresolved six-digit class; this is spectral coverage rather than a production supplier identification. E3 (fluorite) and E4/E13 (UD) carry inferred APD tags based on compatible catalog dispersion and the matching production construction. These are not patent-listed partial-dispersion measurements or historical supplier identifications, and no APO classification is assigned. The diagram separates the fixed relay into the patent's Gf, Gm IS, and Gr subgroups.
...
Surface semi-diameters are likewise modeling values rather than source dimensions. They were constructed from the modeled F/4.1 marginal rays, the patent's `Y = 21.6 mm` field, the source optical section, and production mechanical bounds. A 600 dpi audit of Figure 1(a) on local PDF page 10 refined Gm to r25/r26 = 12.8 mm and r29 = 12.5 mm, with r27/r28 limited to 11.1 mm, Gr-1 to 13.4 mm, the Gr-2/Gr-3 cemented pair to 15.0 mm, and Gr-4 to 18.0 mm. The shared r27/r28 rim remains smaller than the roughly 12.5–13.0 mm drawn envelope because that radius would overlap the surfaces across D27; 11.1 mm passes the default cross-gap policy. The other Gm rims now follow the figure more closely. Surface and image-circle audits pass for the revised geometry. One outer-pupil sample at the tele state clips at the first surface; it is retained as ordinary off-axis vignetting rather than concealed by enlarging the prescription.
