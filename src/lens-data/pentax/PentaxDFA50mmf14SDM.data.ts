...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 44.3,
      fl: -60.7,
      glass: "Short-flint / KZFS-class glass (nd=1.61340, νd=44.3)",
      apd: false,
    ...
    },
    {
      ...
      vd: 35.2,
      fl: 43.0,
      glass: "High-index tantalum/lanthanum dense flint class (nd=1.91082, νd=35.2)",
      apd: false,
    ...
    },
    {
      ...
      vd: 63.4,
      fl: 105.2,
      glass: "Anomalous partial-dispersion phosphate crown class (nd=1.61800, νd=63.4)",
      apd: "inferred",
      dPgF: 0.003,
      apdNote: "Mild positive ΔPgF inferred from catalog-class match; front-group secondary-spectrum trim.",
    ...
    },
    {
      ...
      vd: 42.7,
      fl: 55.8,
      glass: "Lanthanum dense crown/flint class (nd=1.83481, νd=42.7)",
      apd: false,
    ...
    },
    {
      ...
      vd: 40.8,
      fl: 111.7,
      glass: "High-index lanthanum dense flint class (nd=1.88300, νd=40.8)",
      apd: false,
    ...
    },
    {
      ...
      vd: 49.5,
      fl: 36.9,
      glass: "Moldable lanthanum crown class (nd=1.77250, νd=49.5)",
      apd: false,
