...
const LENS_DATA = {
  ...
  patentNumber: "US 5,267,086",
  patentAuthors: ["Hiroyuki Hirano"],
  ...
  elements: [
    {
      ...
      vd: 50.9,
      fl: 49.2,
      glass: "N-SSK5 (Schott; exact 658509 coordinate match)",
      apd: false,
      cemented: "D1",
    ...
    },
    {
      ...
      vd: 25.7,
      fl: -82.6,
      glass: "FD110 (HOYA) / S-TIH11 equivalent (785257)",
      apd: false,
      cemented: "D1",
    ...
    },
    {
      ...
      vd: 28.5,
      fl: -56.0,
      glass: "S-TIH10 (OHARA; exact 728285 coordinate match)",
      apd: false,
