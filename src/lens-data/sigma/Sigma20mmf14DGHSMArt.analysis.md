...
nd = 1.76450, νd = 49.10. Glass: L-LAH91 (OHARA catalog-equivalent; patent supplier unspecified). f = +30.9 mm.
...
OHARA's current L-LAH91 row reproduces the stored nd/νd pair and is explicitly a low-softening-temperature glass, so it supplies a coefficient-backed dispersion curve without asserting Sigma's production supplier.
...
| E15 | 1.76450 | 49.10 | L-LAH91 | OHARA catalog-equivalent; patent supplier unspecified | Rear molded asphere |
