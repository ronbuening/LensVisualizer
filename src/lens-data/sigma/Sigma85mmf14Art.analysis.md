...
L1 is the front collector, receiving the full-aperture beam at its widest diameter. Its positive meniscus shape keeps the angle of incidence low on both surfaces, minimizing spherical aberration contribution despite the large clear aperture. The moderate refractive index of TAC8 (nd = 1.729) provides adequate refracting power while keeping the partial dispersion ratio PgF = 0.5452 comfortably low (ΔPgF = −0.0047). This negative anomalous partial dispersion is important: it suppresses secondary spectrum at the very first element, where the marginal ray height is greatest.

### L2 — Positive Meniscus, Convex to Object (SLD)

nd = 1.55032, νd = 75.50. Glass: FCD515 (HOYA) — SLD fluorophosphate crown. f = +180.9 mm. ΔPgF = +0.0275.
...
nd = 1.61340, νd = 44.27. Glass: E-ADF10 (HOYA) — anomalous-dispersion flint. f = −164.3 mm. ΔPgF = −0.0053.

L3 is the first negative element in G1 and bears the strongest negative anomalous partial dispersion of the three negative elements (ΔPgF = −0.0053). E-ADF10 is a HOYA glass specifically engineered for anomalous partial dispersion characteristics — its moderate refractive index (nd = 1.613) is offset by its chromatic role. L3 acts as a secondary-spectrum corrector: paired with L2, it balances the g-line to F-line partial dispersion ratio against primary (F–C) achromatism, enabling correction of both first-order and second-order chromatic aberration simultaneously.
...
nd = 1.55032, νd = 75.50. Glass: FCD515 (HOYA) — SLD fluorophosphate crown, same as L2. f = +114.2 mm. ΔPgF = +0.0275.
...
**L10:** nd = 1.69895, νd = 30.05. Glass: TAFD37 (HOYA) — lanthanum flint. f = −60.3 mm (standalone).
...
**L11:** nd = 1.73800, νd = 32.26. Glass: NBFD3 (HOYA) — niobium flint, same as L4/L5. f = −26.8 mm (standalone).
...
The doublet is weakly negative overall (f = −207.8 mm), allowing it to function as a partial Petzval corrector in the rear group while the individual elements provide strong chromatic correction via the high-dispersion–low-dispersion pairing of NBFD3 (νd = 32.26) and TAFD30 (νd = 40.80).
...
| L2, L7 | 1.55032 | 75.50 | 0.5399 | +0.0275 | FCD515 | HOYA | SLD fluoro­phosphate crown |
| L3 | 1.61340 | 44.27 | 0.5633 | −0.0053 | E-ADF10 | HOYA | Anomalous-dispersion flint |
| L4, L5, L11 | 1.73800 | 32.26 | 0.5898 | −0.0005 | NBFD3 | HOYA | Niobium flint |
...
| L10 | 1.69895 | 30.05 | 0.6028 | +0.0086 | TAFD37 | HOYA | Lanthanum flint |
...
The chromatic correction strategy relies on three tiers of anomalous partial dispersion:
...
The second tier is the high-index anomalous element L6 (E-FDS1-W, ΔPgF = +0.028), which carries positive power at extremely high dispersion — an unusual choice that works only because the large positive ΔPgF at low Abbe number creates a partial-dispersion ratio (PgF/νd = 0.0306) far above the normal line, enabling the designer to balance g-line secondary spectrum against the SLD elements.

The third tier is the three negative-ΔPgF flint elements (L3, L4, L5) that provide the complementary negative partial-dispersion contribution. The strongest contributor is L3 (E-ADF10, ΔPgF = −0.0053), a glass specifically designed for anomalous dispersion correction.
...
- HOYA Corporation, Optical Glass Catalog (glass codes referenced: TAC8, FCD515, E-ADF10, NBFD3, E-FDS1-W, TAFD30, TAF105, TAFD37, M-TAFD305).
