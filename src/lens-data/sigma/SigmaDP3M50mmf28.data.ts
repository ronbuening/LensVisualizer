...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      apd: "inferred",
      apdNote:
        "ΔPg,F ≈ +0.017 (FCD515 catalog value at Vd = 68.62). Positive APD glass enables secondary-spectrum correction in the DB1 achromat.",
      cemented: "DB1",
    ...
    },
    {
      ...
      vd: 36.3,
      fl: -42.7,
      glass: "E-F2 (HOYA catalog-equivalent; production supplier unspecified)",
      apd: false,
    ...
    },
    {
      ...
      vd: 40.92,
      fl: +56.3,
      glass: "MC-NBFD135 (HOYA catalog-equivalent; production supplier unspecified)",
      apd: false,
