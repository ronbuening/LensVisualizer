...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      indexReference: "d",
      fl: 30.945,
      glass: "J-LLF1 (coordinate-compatible dispersion proxy; historical supplier unconfirmed)",
      apd: false,
      cemented: "G4",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: 10.479,
      glass: "S-TIM3 (coordinate-compatible dispersion proxy; historical supplier unconfirmed)",
      apd: false,
      cemented: "G5",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: 22.178,
      glass: "C2 (coordinate-compatible dispersion proxy; historical supplier unconfirmed)",
      apd: false,
      cemented: "G6",
  ...
  closeFocusM: 0.16,
  focusDescription:
    "Infinity prescription only; the patent gives no focus travel. The production lens focuses to 0.16 m.",
