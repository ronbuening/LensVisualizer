...
const LENS_DATA = {
  ...
  specs: ["7 ELEMENTS / 4 GROUPS", "f ≈ 49.9995 mm", "F/4", "ALL-SPHERICAL", "6×6 FORMAT"],
  ...
  patentAssignees: ["Jenoptik Jena G.m.b.H."],
  patentYear: 1963,
  elementCount: 7,
  groupCount: 4,
  ...
  elements: [
    {
      ...
      indexReference: "d",
      fl: 102.957357064502,
      glass: "698536 class (supplier unresolved)",
      cemented: "I",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: -39.645847564237,
      glass: "542596 class (supplier unresolved)",
      cemented: "I",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: -18.859121688849,
      glass: "673322 / SF5-class (supplier unresolved)",
      cemented: "IIc",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: 46.12931706215,
      glass: "BK4 coordinate-compatible catalog proxy (historical supplier unproven)",
      cemented: "IIc",
  ...
  /* ── Focus ── */
  focusDescription:
    "NO_INTERNAL_RECONSTRUCTION — the patent publishes only the static infinity prescription. The 0.50 m production MFD is metadata only; no internal focus motion is modeled.",
  var: {},
  varLabels: [],
  closeFocusM: 0.5,
