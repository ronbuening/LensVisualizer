...
const LENS_DATA = {
  ...
  name: "CARL ZEISS JENA BIOGON 35mm f/2.8 (pre-war)",
  ...
  elements: [
    {
      ...
      vd: 47.2,
      fl: 40.111,
      glass: "N-BAF10 (Schott catalog-equivalent to vintage 672472 coordinate; supplier not identified)",
      apd: false,
