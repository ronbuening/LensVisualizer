...
| L3 | 574425 | 1.57380 | 42.5 | Light flint (LF) | HOYA FL1 optical equivalent (1.573091, 42.586); production supplier unspecified |
...
- **Catalog-level identification (mixed)**: Three of the four glasses have coefficient-backed catalog equivalents within ordinary tolerance — L1 ↔ Schott N-LaK12 (Δ*n* = 0.00004, Δ*ν* = 0.30), L3 ↔ legacy HOYA FL1 (Δ*n* = -0.000709, Δ*ν* = +0.086), and L4 ↔ Schott N-SSK5 (Δ*n* = -0.00236, Δ*ν* = +0.08). The OHARA cross-reference table maps the six-digit code 678555 directly to HOYA LAC12, with N-LaK12 (Schott code 678552) listed as the very-close Schott analog in the same code group. L2 remains a family-only legacy F3 reference.
...
2. **Glass identification**. Family-level identification (LaK, F, LF, SSK) is supported with high confidence by the (*n*<sub>d</sub>, *ν*<sub>d</sub>) data alone. Catalog-level review in §8 yields coefficient-backed equivalents for L1, L3, and L4; L2 remains family-only. These matches must not be read as identifications of the *physical* glass used in 1952 — that would have been a Jena house glass from the East-German Jenaer Glaswerk inventory rather than a modern Western catalog melt. The catalog rows are optical-model proxies only.
