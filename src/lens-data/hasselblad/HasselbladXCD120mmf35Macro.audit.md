...
- No defensible coefficient-backed public match was found for L31 / `893204`.
...
| L31 | `Ultra-high-dispersion flint, 893/204 (unmatched)` | `893204 - ultra-high-dispersion flint ...` | Unresolved; explicit code retained. |
...
- Updated element descriptions, glass table rows, and palette summary so only L31 remains unresolved among the reviewed code-only rows.
