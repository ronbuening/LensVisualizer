...
const LENS_DATA = {
  ...
  groups: [
    { text: "G1 (I neg)", fromSurface: "1", toSurface: "2A" },
    { text: "G2 (II pos)", fromSurface: "3", toSurface: "7" },
    { text: "G3 (III pos)", fromSurface: "9", toSurface: "11" },
    { text: "G4 (IV weak)", fromSurface: "12", toSurface: "13A" },
  ],
  doublets: [
