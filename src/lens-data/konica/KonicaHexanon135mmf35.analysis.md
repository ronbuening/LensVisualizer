# KONICA HEXANON 135mm f/3.5 — JP 1955-009472 B Example 1

## Patent Reference and Design Identification

**Patent:** JP 1955-009472 B\
...
JP 1955-009472 B Example 1 is the fixed prescription source for this model. The patent gives a four-element,
...
document explicitly identifies JP 1955-009472 B as the production patent.
...
and 12.5 mm from front to rear. JP 1955-009472 B publishes no numerical clear-aperture or semi-diameter table.
...
JP 1955-009472 B supplies d-line refractive index and Abbe number but names no glass manufacturer, catalog, or historical
...
JP 1955-009472 B Example 1 publishes no object-distance table, focus-spacing table, magnification state, or internal
...
It is a first-order calculation from the final model, not a value published by JP 1955-009472 B.

## Sources

- **Primary optical source:** 特許公告 昭30-9472, `JP 1955-009472 B`, 望遠写真レンズ, Example 1, supplied two-page patent
