...
$nd = 1.51895$, $\nu_d = 57.3$. Glass: Hikari J-K3 catalog equivalent to patent 519573; production supplier unspecified. $f = +48.88$ mm at 24 mm scale.
...
The patent prints only the d-line index and Abbe number and does not identify a glassmaker or partial-dispersion value. Hikari J-K3 is the best normalized coordinate match among coefficient-backed crowns in the runtime window, so it supplies a qualified spectral proxy without asserting Enna's production supplier.
...
| L4 | 1.51895 | 57.3 | J-K3 equivalent; patent 519573 | Patent coordinates verified; production supplier unspecified |
