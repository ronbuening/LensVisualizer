...
const LENS_DATA = {
  ...
  groups: [
    { text: "G1 (I)", fromSurface: "1A", toSurface: "3" },
    { text: "G2 (II)", fromSurface: "4", toSurface: "7" },
    { text: "G3 (III)", fromSurface: "9", toSurface: "11" },
    { text: "G4 (IV)", fromSurface: "12A", toSurface: "13A" },
  ],
