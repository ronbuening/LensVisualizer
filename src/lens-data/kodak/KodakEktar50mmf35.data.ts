 ...
 *
 * Stop: the patent gives no stop plane or diaphragm diameter. A model STO is inserted inside S2, splitting the scaled
 * 3.43 mm gap as 2.05 mm + 1.38 mm. The plane sits just behind element II's rim (R4 sag at the 6.7 mm rim is 1.96 mm),
 * so the diaphragm does not cut through the glass; R5's rim is 0.82 mm behind it. Its semi-diameter is calibrated to the modeled f/3.5 entrance
...
const LENS_DATA = {
  ...
  surfaces: [
    ...
    { label: "4", R: 12.45, d: 2.05, nd: 1.0, elemId: 0, sd: 6.7 },
    { label: "STO", R: 1e15, d: 1.38, nd: 1.0, elemId: 0, sd: 6.031744102409 },
