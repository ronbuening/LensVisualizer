...
const LENS_DATA = {
  ...
  surfaces: [
    ...
    { label: "2", R: 20.9441, d: 3.1601, nd: 1.0, elemId: 0, sd: 15.1 }, // L1 rear → air
    { label: "3", R: 33.3039, d: 6.1681, nd: 1.881, elemId: 2, sd: 15.5 }, // L2 front
    { label: "4", R: -131.595, d: 1.6754, nd: 1.0, elemId: 0, sd: 14.5 }, // L2 rear → air
