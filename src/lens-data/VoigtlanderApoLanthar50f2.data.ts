...
const LENS_DATA = {
  ...
  groups: [
    { text: "G1 (FRONT 101)", fromSurface: "1", toSurface: "10" },
    { text: "G2 (REAR 102)", fromSurface: "12", toSurface: "19A" },
  ],
