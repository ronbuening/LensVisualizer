...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      apd: false,
      cemented: "D2",
      role: "Negative component of the L15/L16 field-flattening cemented doublet (D2). Contributes negative Petzval sum to flatten the image surface. Power governed by condition (1): φ14/φ = −0.47.",
    },
    {
      id: 6,
      name: "L16",
      ...
      apd: false,
      cemented: "D2",
      role: "Positive component of cemented doublet D2. High index (nd = 1.883) keeps the cemented-interface curvature gentle. Governed by condition (2): φ15/φ = +0.25. Doublet composite: f = −137.4 mm. Satisfies condition (4): Nd15 > 1.8.",
    },
    {
      id: 7,
      name: "L17",
  ...
  groups: [
    ...
    { text: "G2 (+)", fromSurface: "13", toSurface: "27A" },
  ],
  doublets: [
    { text: "D1", fromSurface: "3", toSurface: "5A" },
    { text: "D2", fromSurface: "8", toSurface: "10" },
    { text: "D3", fromSurface: "17", toSurface: "19" },
    { text: "D4", fromSurface: "21", toSurface: "23A" },
  ],
