...
const LENS_DATA = {
  ...
  surfaces: [
    ...
    { label: "1", R: 70.017, d: 2.5, nd: 1.68893, elemId: 1, sd: 31.5 }, // L11 front
    { label: "2", R: 29.64, d: 10.58, nd: 1.0, elemId: 0, sd: 26.0 }, // L11 rear → air (sd<0.9×R to avoid TIR)
    { label: "3", R: 94.105, d: 2.4, nd: 1.713, elemId: 2, sd: 28.0 }, // L12 glass front
    { label: "4", R: 31.773, d: 0.05, nd: 1.5138, elemId: 3, sd: 24.0 }, // L12 glass→resin junction
    { label: "5A", R: 27.197, d: 9.49, nd: 1.0, elemId: 0, sd: 20.0 }, // L12 resin rear → air (asph; sd<0.9×R)
    { label: "6", R: 164.736, d: 4.94, nd: 1.84666, elemId: 4, sd: 26.5 }, // L13 front
    { label: "7", R: -131.025, d: 4.85, nd: 1.0, elemId: 0, sd: 26.0 }, // L13 rear → air
    { label: "8", R: -46.832, d: 2.15, nd: 1.56883, elemId: 5, sd: 28.0 }, // L14 front (LS doublet)
    { label: "9", R: 134.737, d: 4.17, nd: 1.883, elemId: 6, sd: 28.0 }, // L14→L15 cemented junction
    { label: "10", R: -366.912, d: 3.03, nd: 1.0, elemId: 0, sd: 27.5 }, // L15 rear → air
    ...
    { label: "13", R: 55.349, d: 4.2, nd: 1.72916, elemId: 8, sd: 21.0 }, // L21 front
    { label: "14", R: 289.177, d: 0.15, nd: 1.0, elemId: 0, sd: 20.0 }, // L21 rear → air
    { label: "15", R: 111.31, d: 4.0, nd: 1.6968, elemId: 9, sd: 19.0 }, // L22 front
    { label: "16", R: -158.345, d: 0.15, nd: 1.0, elemId: 0, sd: 17.5 }, // L22 rear → air
    { label: "17", R: 322.096, d: 5.79, nd: 1.59282, elemId: 10, sd: 17.5 }, // L23 front (ED, D1 doublet)
    { label: "18", R: -37.124, d: 1.5, nd: 1.738, elemId: 11, sd: 14.0 }, // L23→L24 cemented junction
    { label: "19", R: 37.221, d: 5.6, nd: 1.0, elemId: 0, sd: 13.0 }, // L24 rear → air
