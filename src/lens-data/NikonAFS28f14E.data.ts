...
const LENS_DATA = {
  ...
  surfaces: [
    ...
    { label: "14", R: 289.177, d: 0.15, nd: 1.0, elemId: 0, sd: 22.0 }, // L21 rear → air
    { label: "15", R: 111.31, d: 4.0, nd: 1.6968, elemId: 9, sd: 21.5 }, // L22 front
    { label: "16", R: -158.345, d: 0.15, nd: 1.0, elemId: 0, sd: 19.5 }, // L22 rear → air
