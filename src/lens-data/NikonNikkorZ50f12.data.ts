...
const LENS_DATA = {
  ...
  groups: [
    { text: "G1 (FRONT)", fromSurface: "1", toSurface: "17" },
    { text: "G2", fromSurface: "19", toSurface: "22" },
    { text: "G3", fromSurface: "23", toSurface: "26" },
    { text: "G4 (REAR)", fromSurface: "27", toSurface: "33" },
  ],
