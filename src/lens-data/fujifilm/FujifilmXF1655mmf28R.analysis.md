...
| Elem | nd | νd | Glass | f (mm) | Role |
|---|---|---|---|---|---|
| **L31** | 1.68458 | 30.88 | **685309** unresolved dense flint; L-TIM28 is a nearby comparison only | +39.1 | **Double-aspheric** positive singlet *before* the stop. Per patent [0065], its purpose is to receive the divergent beam from G2 and limit downstream diameters. The low Abbe number (~31) satisfies Conditional Formula (7), 20 < νd31 < 40. |
