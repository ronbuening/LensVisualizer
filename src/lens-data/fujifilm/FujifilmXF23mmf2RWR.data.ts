 ...
 * ║                                                                    ║
 * ║  NOTE ON ASPHERES:                                                  ║
 * ║    The exact Example 1 Table 3 odd/even A3...A20 polynomials are   ║
 * ║    stored on all four aspheres. Patent KA = 1 converts to the      ║
 * ║    standard spherical base K = 0.                                  ║
 * ║                                                                    ║
...
const LENS_DATA = {
  ...
  patentNumber: "US 2017/0351051 A1",
