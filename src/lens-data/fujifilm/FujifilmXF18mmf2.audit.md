...
## 2026-09-25 — Image-plane dispositions reconciled

The two 2026-09-24/25 audits above ran in parallel and reached different dispositions for the blank D18. The merged
data adopts the 2026-09-24 `rearPlates` PP with `gapAfterMm` = 3.212 mm at the prescription's paraxial focus. Table 7
prints no distance after surface 18 at all, so this fills a blank rather than overriding a printed value; the rule
against fitting a gap to focus applies to published distances. The S13 A10 correction (−1.41686834e-8) is kept.
