...
const LENS_DATA = {
  ...
  elements: [
    {
      ...
      indexReference: "d",
      fl: -14.707360301,
      glass: "593353 class (supplier unproven)",
      cemented: "D1",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: 8.752796205,
      glass: "883408 class (supplier unproven)",
      cemented: "D1",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: -53.929950983,
      glass: "583595 class (supplier unproven)",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: -32.51735629,
      glass: "805254 class (supplier unproven)",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: 25.275640846,
      glass: "904313 class (supplier unproven)",
  ...
  closeFocusM: 0.34,
  focusDescription:
    "NO_INTERNAL_RECONSTRUCTION — only the published infinity prescription is modeled; 0.34 m is marketed MFD metadata, not a reconstructed internal focus state.",
