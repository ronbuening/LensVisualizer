...
const LENS_DATA = {
  ...
  surfaces: [
    { label: "1", R: 80.042, d: 1.03, nd: 1.64769, elemId: 1, sd: 9.8 },
    { label: "2", R: 16.036, d: 3.44, nd: 1.8707, elemId: 2, sd: 8.2 },
    { label: "3", R: 90.657, d: 3.21, nd: 1.0, elemId: 0, sd: 8.2 },
    { label: "STO", R: 1e15, d: 6.76, nd: 1.0, elemId: 0, sd: 6.23287282501659 },
    { label: "5", R: -29.212, d: 1.01, nd: 1.61293, elemId: 3, sd: 8.2 },
    { label: "6", R: 21.196, d: 3.89, nd: 1.883, elemId: 4, sd: 8.2 },
    { label: "7", R: -30.375, d: 1.0, nd: 1.0, elemId: 0, sd: 7.5 },
    { label: "8", R: -16.556, d: 1.05, nd: 1.54814, elemId: 5, sd: 9.8 },
    { label: "9", R: 45.149, d: 5.26, nd: 1.6516, elemId: 6, sd: 9.8 },
    { label: "10", R: -18.741, d: 1.19, nd: 1.0, elemId: 0, sd: 10.0 },
    { label: "11A", R: -22.131, d: 1.5, nd: 1.7725, elemId: 7, sd: 12.2 },
    { label: "12A", R: -25.008, d: 5.46, nd: 1.0, elemId: 0, sd: 12.2 },
    { label: "13", R: -24.341, d: 3.63, nd: 1.84667, elemId: 8, sd: 12.4 },
    { label: "14", R: -117.508, d: 4.62, nd: 1.0, elemId: 0, sd: 15.8 },
