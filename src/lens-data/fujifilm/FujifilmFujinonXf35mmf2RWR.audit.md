...
- Read Example 1 Table 1 on PDF page 23 (printed page 7) at 160 dpi: surface 16 d = 8.806; surfaces 17–18 are the
  plane-parallel optical member PP, 2.850 mm, Ndj 1.51680, νdj 64.20; 18 → Sim is 1.787 mm. These reproduce the
  legacy folded 12.4719557 mm exactly.
- Surface 16 now stores 8.806 mm, with `rearPlates` PP (N-BK7; also matches CDGM H-K9L and Hikari J-BK7A) and
  gapAfter 1.787 mm. Paraxial check against the previous data: EFL identical; defocus unchanged (−0.004087 mm, the
  existing source-rounding residual). Physical track grows by 0.971 mm to 59.442 mm.
