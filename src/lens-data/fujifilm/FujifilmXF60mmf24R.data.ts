  ...
  sourceStates: [
    {
      ...
      focusT: 0,
      zoomT: 0,
      source: "US 2014/0247506 A1, Example 1 Tables 1–3, infinity column.",
      conjugate: { kind: "infinity" },
    },
    {
      id: "one-fifth-life-size",
      label: "One-fifth life-size",
      focusT: 0.6115561181433857,
      zoomT: 0,
      source: "US 2014/0247506 A1, Example 1 Tables 1–3, β=-0.2 column, D13=10.57 mm.",
      conjugate: {
        kind: "finite",
        objectDistanceMm: 363.1222763250309,
        distanceReference: "first-surface",
        distanceProvenance: "calculated",
        derivation: "Fixed-image-plane ABCD s=-B/A with physical GC and retained inferred 0.001 mm rear air; independent exact rays at 0.005/0.0025/0.00125 mm verify distance and magnification -0.199945886. See audit sidecar; distance is not published.",
        magnification: -0.2,
      },
    },
    {
      ...
      focusT: 1,
      zoomT: 0,
      source: "US 2014/0247506 A1, Example 1 Tables 1–3, β=-0.5 column, D13=23.73 mm.",
      conjugate: {
        kind: "finite",
        objectDistanceMm: 179.87873967230937,
        distanceReference: "first-surface",
        distanceProvenance: "calculated",
        derivation: "Fixed-image-plane ABCD s=-B/A with physical GC and retained inferred 0.001 mm rear air; independent exact rays at 0.005/0.0025/0.00125 mm verify distance and magnification -0.499930755. See audit sidecar; distance is not published.",
        magnification: -0.5,
      },
    },
  ],
