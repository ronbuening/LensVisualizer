...
const LENS_DATA = {
  ...
  surfaces: [
    ...
    { label: "6", R: -114.4807, d: 0.84, nd: 1.883, elemId: 4, sd: 8.8 },
    { label: "7", R: 54.623, d: 1.998, nd: 1.0, elemId: 0, sd: 8.6 },
    { label: "8", R: -39.704, d: 0.85, nd: 1.72916, elemId: 5, sd: 8.6 },
    { label: "9", R: 39.704, d: 2.2, nd: 1.92286, elemId: 6, sd: 8.6 },
    { label: "10", R: 503.7335, d: 15.857, nd: 1.0, elemId: 0, sd: 8.6 },
    ...
    { label: "16", R: 40.9271, d: 1.0, nd: 1.84666, elemId: 9, sd: 10.5 },
    { label: "17", R: 20.289, d: 6.488, nd: 1.0, elemId: 0, sd: 10.2 },
