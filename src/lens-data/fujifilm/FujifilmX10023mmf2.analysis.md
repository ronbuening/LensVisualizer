...
The combined focal length of G1 + G2 (through the stop) is 19.25 mm, shorter than the system EFL of 23.72 mm. The negative G3 diverges the converging cone from G1+G2, extending the back focal distance and compressing the total track — the hallmark of a telephoto-type configuration. The telephoto ratio (total track / EFL) is (DD + BF) / f = (32.37 + 5.53) / 23.72 = 1.60, indicating a moderately telephoto design. In a symmetric wide-angle, this ratio would typically exceed 2.0; the telephoto arrangement allows the 23.72 mm EFL to fit within a air-equivalent track of approximately 37.9 mm, enabling the X100's slim, non-collapsing lens barrel.
The rear path includes the source-listed PP plate: Table 1 gives 2.80 mm air after S15, then 2.33 mm of glass at nd = 1.51680 and vd = 64.2. Table 11 defines BF = 5.53 mm **in air**, so the physical gap after PP is 5.53 − 2.80 − 2.33/1.51680 = 1.1938713 mm. The modeled physical back distance is consequently 6.323871 mm and the physical track is 38.693871 mm. PP is traced in every analysis through `rearPlates` and hidden from the lens drawing. This replaces the previous incomplete image plane at PP's front face; the resulting paraxial offset is −0.003651 mm, within the census limit. The plate's published nd/vd support an Abbe estimate; no supplier identity or additional line indices are inferred.
