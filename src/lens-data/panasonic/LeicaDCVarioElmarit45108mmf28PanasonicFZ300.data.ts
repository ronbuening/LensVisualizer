...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      apd: "inferred",
      apdNote: "H-FK61 spectral proxy has ΔPgF ≈ +0.0315; APD is catalog-inferred, not patent-listed or a supplier identification.",
    },
    {
      id: 3,
      name: "L3",
      ...
      glass: "FCD505 (coordinate-compatible spectral proxy; supplier unconfirmed)",
      role: "Rear positive meniscus of G1, convex toward the object.",
      apd: "inferred",
      apdNote: "FCD505 spectral proxy has ΔPgF ≈ +0.0160; APD is catalog-inferred, not patent-listed or a supplier identification.",
    },
    {
      id: 4,
      name: "L4",
      ...
      glass: "M-TAFD307 (coordinate-compatible spectral proxy; supplier unconfirmed)",
    ...
    },
    {
      ...
      glass: "N-SF66 (coordinate-compatible spectral proxy; supplier unconfirmed)",
      cemented: "D2",
      role: "G2 positive cemented partner; its modeled thickness includes the collapsed 0.01000 mm adhesive layer.",
      apd: "inferred",
      apdNote: "N-SF66 spectral proxy has ΔPgF ≈ +0.0307; APD is catalog-inferred, not patent-listed or a supplier identification.",
    },
    {
      id: 7,
      name: "L7",
    ...
    },
    {
      ...
      glass: "E-FD2 (coordinate-compatible spectral proxy; supplier unconfirmed)",
      cemented: "D3",
  ...
  groups: [
    ...
    { text: "G3 (+)", fromSurface: "16A", toSurface: "23A" },
  ...
  closeFocusM: 0.01,
  focusDescription:
    "Not modeled — G4 moves imageward for close focus; the patent provides only infinity-focus zoom spacings.",
