  ...
  elements: [
    {
      ...
      fl: 88.7,
      glass:
        "Unmatched (ultra-dense niobium flint, 946/180 — no public catalog match; probable proprietary Chinese composition)",
      apd: false,
    ...
    },
    {
      ...
      vd: 54.7,
      fl: 42.3,
      glass: "H-LAK53A (CDGM) / S-LAL8 class (OHARA) — lanthanum crown, code 729/547",
      apd: false,
    ...
    },
    {
      ...
      vd: 68.6,
      fl: 32.9,
      glass: "ED phosphate crown, code 593/686 (probable S-FPM2 (OHARA) / CDGM equivalent)",
      apd: false,
      cemented: "D2",
    ...
    },
    {
      ...
      vd: 33.3,
      fl: -55.5,
      glass: "S-LAH55 (OHARA) / CDGM equivalent — dense lanthanum flint, code 806/333",
      apd: false,
      cemented: "D2",
    ...
    },
    {
      ...
      fl: 76.3,
      glass:
        "PGM moldable crown, code 516/565 (unmatched — probable proprietary low-Tg borosilicate for glass molding)",
      apd: false,
    ...
    },
    {
      ...
      vd: 56.5,
      fl: -69.3,
      glass: "PGM moldable crown, code 516/565 (same as L18, L31)",
      apd: false,
    ...
    },
    {
      ...
      vd: 56.5,
      fl: 55.9,
      glass: "PGM moldable crown, code 516/565 (same as L18, L21)",
      apd: false,
