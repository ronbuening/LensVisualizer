...
nd = 1.94595, νd = 18.0. Glass: ultra-dense flint, code 946/180. f = +88.7 mm.

L11 is the front element and uses the most extreme glass in the design: an ultra-high-index, ultra-high-dispersion flint with nd approaching 1.95 and νd = 18.0. The six-digit glass code 946/180 places it at the far upper-right edge of the nd–νd glass map — a region populated by specialty niobium-rich compositions such as Schott SF66 (nd = 1.923, νd = 20.9), though no public catalog glass matches L11's specific nd/νd pair exactly. The glass is likely a proprietary or limited-distribution composition from a Chinese supplier (consistent with the Xiamen manufacturing origin) or a special-order melt. Its purpose is to provide positive power with minimal surface curvature, keeping the front element diameter manageable for a fast f/1.8 lens. The high index means even a gentle meniscus shape (R1 = 66.55, R2 = 313.09) contributes meaningful convergence. The very low Abbe number (νd = 18.0) means L11 introduces strong chromatic aberration, but this is by design — it is the first half of a deliberate chromatic balancing strategy with the ED elements L12 and L14 downstream.
...
nd = 1.51602, νd = 56.5. Glass: precision-glass-molded (PGM) crown, code 516/565. f = +76.3 mm.  
...
nd = 1.51602, νd = 56.5. Glass: PGM crown, code 516/565. f = −69.3 mm.  
...
nd = 1.51602, νd = 56.5. Glass: PGM crown, code 516/565. f = +55.9 mm.  
...
|---|---|---|---|---|---|
| L11 | 1.94595 | 18.0 | 946/180 | Ultra-dense flint (unmatched — probable proprietary Chinese composition) | High-index positive collector; extreme nd minimizes front diameter |
...
| L18, L21, L31 | 1.51602 | 56.5 | 516/565 | PGM moldable crown (unmatched — probable proprietary low-Tg glass) | All three aspherical elements; single moldable material |
