...
Because the patent does not publish clear semi-diameters, the active model uses separately derived and verified modeled semi-diameters. At those modeled rims, the computed aspheric departures are approximately +0.2123 mm (7A at 7.7 mm), +0.3611 mm (8A at 7.5 mm), +0.0706 mm (16A), +0.1089 mm (17A), −0.1962 mm (22A), +0.0119 mm (23A), −0.0605 mm (26A), +0.1038 mm (27A), and +0.2838 mm (28A). These departures are properties of the modeled apertures, not patent-published rim departures.
