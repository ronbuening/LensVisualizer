...
**L6:** nd = 1.78630, νd = 27.5. Glass: 786275 patent-code dense flint. f = −10.98 mm.
**L7:** nd = 1.76864, νd = 49.7. Glass: 769497 patent-code lanthanum crown. f = +14.17 mm.
...
| L2 | 1.58542 | 41.7 | 585417 patent-code | — | Light flint | Aspherical corrector substrate |
| L3 | 1.88234 | 40.8 | 882408 patent-code | — | High-index lanthanum | High-power positive collector |
| L4 | 1.75409 | 26.0 | 754260 patent-code | — | Dense flint | Chromatic partner to L3 |
...
The Panasonic/Leica glass supply chain for this lens appears to draw from multiple Japanese glass families, but the patent table gives only refractive index and Abbe number for the flagged rows. The audit therefore keeps patent-code labels for L2-L7 where public catalog candidates were not unique enough to defend as vendor-level matches. Among the three aspherical elements, L2, L7, and L9 remain the most likely precision glass-molded substrates; the exact vendor labels for L2 and L7 are intentionally left open.
...
The three aspherical elements (L2, L7, L9) are likely manufactured by precision glass molding (PGM), consistent with Panasonic's established PGM production capabilities for consumer interchangeable lenses. L2 and L7 are retained as patent-code glasses after the catalog audit, while L9 remains a dense-flint class rear corrector. PGM is the expected fabrication method for consumer lenses at this price point when three or more aspherical elements are specified; polished-glass aspherics at this element count would be cost-prohibitive for a $600 retail product.
...
- OHARA and HOYA optical glass catalogs, checked during the 2026-05-20 audit; flagged L2-L7 rows remain patent-code labels where no unique coefficient-backed public match was found.
