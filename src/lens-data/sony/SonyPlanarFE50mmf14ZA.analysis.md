...
nd = 1.99502, νd = 29.3. Glass: unmatched 995293 ultra-high-index heavy flint (vendor unspecified). f = −37.6 mm.
...
The nd = 1.995 value pushes close to the upper practical limit of available optical glasses. The patent does not identify the glass composition or supplier. It does acknowledge the density trade-off at the upper end of its high-index condition: exceeding the upper conditional limit (nn > 2.20) would make the element unacceptably heavy for high-speed AF actuation (¶0025).
...
| L21 | 1.99502 | 29.3 | Unmatched 995293 | — | Ultra-high-index heavy flint — focus group negative |
...
The most distinctive glass choice is in GR2, where both elements use ultra-high-index glasses (nd ≈ 2.0 and 1.95). The patent does not name specific glass vendors. No reviewed public coefficient row safely reproduces L21's `1.99502 / 29.3` coordinate: OHARA S-LAH99, HOYA TAFD55, and Hikari J-LASFH16 are all near `2.001 / 29.1`, missing the d-line index guard by about `+0.00598`. CDGM H-ZLaF92 is not a plausible identification either; its published `1.92286 / 20.88` coordinate is substantially different. L21 therefore remains on the patent Abbe fallback as an explicit unmatched glass. The nd = 1.94594 / νd = 17.9 glass matches CDGM H-ZF88 or HIKARI E-FDS3-W, but that production identity also remains uncertain.
...
4. Glass identifications for Lp1 (851/401), Lp3 (593/686), and L22 (946/179) are tentative assignments based on nd/νd matching against available public catalogs (OHARA, HOYA, CDGM, HIKARI, Schott). L21 (995/293) has no public coefficient row inside the runtime safety window and remains explicitly unmatched. The actual production glasses may differ.
