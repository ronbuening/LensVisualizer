# Audit Log — SonyFE50mmf12GM

Patent: JP 2022-140076 A, Example 1; local JP2022140076A.pdf, Figure 1, PDF p. 48

## 2026-09-20 — Patent figure, glass, and display metadata review

Retained SDs. The rotated 600 dpi figure comparison has a median figure/data ratio of 1.163, but normalized element-shape ratios range only 0.91–1.09. This is a mostly uniform drawing-scale/rim difference, with no strong local shape discrepancy. The source-23 rim remains gap-limited; expanding the entire system would discard the documented clearance constraints.

Added HOYA M-TAFD405 from the manufacturer's 2026-07-07 obsolete-inclusive Zemax catalog: https://www.hoya-opticalworld.com/common/agf/HOYA20260707_include_obsolete.agf . The published polynomial and 1.95150 / 29.83 coordinates support G4's 1.95150 / 29.8 as a spectral proxy, not proof of Sony's supplier. G11 1.59208 / 61.0 remains unresolved: public candidates have less specific coordinates. Coverage: 13/14.

Romanized structured inventors as Yosuke Utagawa and Masaki Maruyama, matching the public patent metadata, and normalized the applicant to Sony Group Corporation. Japanese originals are 宇田川 洋祐 and 丸山 理樹. Source: https://patents.google.com/patent/JP2022140076A/en . This resolves the patentAuthors romanization contract failure.
