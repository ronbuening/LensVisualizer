 ...
 * ║  shift, measured Figure 8 proportions, and the 49 mm production filter.   ║
...
const LENS_DATA = {
  ...
  surfaces: [
    ...
    { label: "3", R: 23.3824, d: 3.6557, nd: 1.91082, elemId: 2, sd: 9.8 },
    { label: "4", R: 55.6626, d: 1.0221, nd: 1.0, elemId: 0, sd: 8.4 },
    { label: "5", R: 263.1267, d: 0.9, nd: 1.72825, elemId: 3, sd: 11.4 },
    { label: "6", R: 15.5392, d: 6.1331, nd: 1.0, elemId: 0, sd: 11.0 },
    { label: "7", R: -140.202, d: 0.8, nd: 1.8061, elemId: 4, sd: 10.2 },
    { label: "8", R: 67.9694, d: 4.575, nd: 1.0, elemId: 0, sd: 10.2 },
    { label: "STO", R: 1e15, d: 1.5, nd: 1.0, elemId: 0, sd: 9.631 },
    { label: "10", R: 30.4655, d: 0.7, nd: 1.84666, elemId: 5, sd: 10.2 },
    { label: "11", R: 18.0217, d: 4.7707, nd: 1.83481, elemId: 6, sd: 10.1 },
    { label: "12", R: -80.3201, d: 1.796, nd: 1.0, elemId: 0, sd: 9.9 },
    { label: "13", R: -142.554, d: 0.7, nd: 1.62041, elemId: 7, sd: 8.9 },
    ...
    { label: "17", R: -25.3869, d: 2.0, nd: 1.80518, elemId: 9, sd: 10.6 },
    { label: "18", R: -38.0301, d: 15.468565, nd: 1.0, elemId: 0, sd: 11.2 },
  ],
