...
$n_d = 1.77002$, $ν_d = 49.4$. Glass: unmatched MC-TAF115-class coordinate. Standalone $f = -39.29$ mm.
...
The retained Hoya record cannot support a catalog assignment: its nominal `nd = 1.777047` conflicts with the same row's polynomial, which evaluates to `nd = 1.770473`. The latter is close to the patent coordinate, but the internally inconsistent source is not treated as reliable coefficient evidence. L11 therefore remains on the authored patent Abbe model.
...
$n_d = 1.85235$, $ν_d = 40.1$. Glass: Hoya M-TAFD305 catalog equivalent (patent code 852401; supplier unspecified). Standalone $f = -126.92$ mm.
...
Hoya M-TAFD305's first-party coefficient row evaluates to $n_d = 1.85135$, $ν_d = 40.10$, making it a coordinate-compatible precision-molding equivalent for this rear XA element. The annotation retains patent code 852401 and does not assert Hoya as the production supplier.
...
The design uses ten glass entries across thirteen elements. All are catalog-resolvable or documented catalog-class equivalents; L27 now uses the coefficient-backed M-TAFD305 curve.

| Glass assignment | $n_d$ | $ν_d$ | Elements | Confidence / role |
|---|---:|---:|---|---|
| Unmatched MC-TAF115 class | 1.77002 | 49.4 | L11 | Vendor source nominal/polynomial conflict; patent Abbe fallback retained |
...
| M-TAFD305 equivalent / 852401 | 1.85235 | 40.1 | L27 | Rear XA negative element; coefficient-backed curve, supplier unspecified |
...
5. Hoya optical glass catalog/product data for the unresolved MC-TAF115 class, TAFD33 class, PCD40, and M-TAFD305.
