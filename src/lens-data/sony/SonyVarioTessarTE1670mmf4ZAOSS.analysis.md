...
Likewise, the patent publishes no clear apertures for the glass surfaces. Every surface semi-diameter in the data file is a modeling value derived from ray envelopes and checked against the wide-end Figure 1 proportions. The rim review enlarged the rear groups and restored the stronger stepped profile visible in the patent without forcing 7A, surface 16, or the cemented groups past their local geometry limits. Across all three zoom states and both infinity and reconstructed-close focus, the validated geometry has a maximum actual rim angle of 52.6999°, a minimum element edge thickness of 0.525151 mm, and a worst cross-gap intrusion ratio of 0.886806 against the 0.90 policy limit. The project surface-domain and image-circle audits pass for the final set. These quantities validate the model geometry; they are not source-published apertures.
