...
const LENS_DATA = {
  ...
  specs: [
    ...
    "2 COMPOUND ASPHERICAL SURFACES",
  ],
   ...
   * Six-digit strings below are coordinate classes derived from the stored d-line nd/vd pair.
   * They do not assert a vendor melt. The two compound-asphere layers remain explicitly Unmatched.
   */
  elements: [
    {
      id: 1,
    ...
    },
    {
      ...
      indexReference: "d",
      fl: -21.52816,
      glass: "911352 class (vendor unresolved)",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: 31.16461,
      glass: "806407 class (vendor unresolved)",
