...
Source: local `patents/GB_135853_A.pdf`, p. 3, Fig. 2 / Example 2; 600 dpi review. Hatch marks and leaders contaminate automatic axial-span extraction, so the enlarged crop was checked manually.

| Surfaces | Before SD (mm) | After SD (mm) | Evidence |
| --- | --- | --- | --- |
| 4 / 5 | 14.5 / 13.25 | 16.5 / 15.8 | Near-stop meniscus has approximately equal optical rims |
