...
|-----------|----------|------|------|
| I | L11 | Positive meniscus, convex to object | Front power supplement |
| II | L21 | Positive meniscus, convex to object | Power distribution |
| III | L31 + L32 (cemented) | Negative meniscus, convex to object | Front achromatic doublet |
| *Stop* | — | Aperture diaphragm | — |
| IV | L41 + L42 (cemented) | Weakly positive meniscus, concave to object | Rear achromatic doublet |
| V | L51 | Plano-convex, flat rear | Rear power element |
| VI | L61 + L62 (cemented) | Positive meniscus, convex to object | Rear achromatic corrector |

The design philosophy, as described by Nikon, was to **lower the power of individual lens elements** compared to the alternative Sonnar-type approach (used by Zunow and others). By distributing the positive power across more elements — particularly the three lanthanum-glass positive elements (L31, L42, L51) — individual surface contributions to spherical aberration and coma are reduced. This is an especially attractive strategy for super-fast lenses, where aberrations scale rapidly with aperture.
...
During transcription of the patent, the radius of curvature of the cemented interface between L31 and L32 (surface r₆) required correction. The patent prints this value as **r₆ = +872.1** in both the worked example (page 2, column 2) and the repeated prescription in Claim 3 (page 3, column 2). Since the same value appears in two independently typeset sections of the document, this is a **typographical error in the original 1958 patent publication**, not a modern OCR artifact.
...
|---------|--------|--------|----|---------|----------------------|
| r₁ | +167.6 | 8.7 | 1.6073 | L11 | Glass (L11) |
| r₂ | +428.3 | 0.6 | 1.0 | — | Air |
| r₃ | +93.0 | 8.5 | 1.6073 | L21 | Glass (L21) |
| r₄ | +163.8 | 1.4 | 1.0 | — | Air |
| r₅ | +53.5 | 19.4 | 1.7700 | L31 | Glass (L31) |
| r₆ | +122.5* | 4.1 | 1.5927 | L32 | Glass (L32, cemented) |
| r₇ | +33.3 | 25.2 | 1.0 | — | Air (stop gap) |
| *STO* | ∞ | — | 1.0 | — | *Aperture stop* |
| r₈ | −42.6 | 5.4 | 1.6483 | L41 | Glass (L41) |
| r₉ | +135.7 | 20.5 | 1.7170 | L42 | Glass (L42, cemented) |
| r₁₀ | −58.1 | 0.6 | 1.0 | — | Air |
| r₁₁ | +116.3 | 11.0 | 1.7170 | L51 | Glass (L51) |
| r₁₂ | ∞ (flat) | 0.6 | 1.0 | — | Air |
| r₁₃ | +142.3 | 2.9 | 1.6259 | L61 | Glass (L61) |
| r₁₄ | +96.9 | 7.8 | 1.6385 | L62 | Glass (L62, cemented) |
...
| Surface | R (mm) | d (mm) | nd | Element | Medium after surface |
|---------|--------|--------|----|---------|----------------------|
| r₁ | +83.8 | 4.35 | 1.6073 | L11 | Glass (L11) |
| r₂ | +214.15 | 0.30 | 1.0 | — | Air |
| r₃ | +46.5 | 4.25 | 1.6073 | L21 | Glass (L21) |
| r₄ | +81.9 | 0.70 | 1.0 | — | Air |
| r₅ | +26.75 | 9.70 | 1.7700 | L31 | Glass (L31) |
| r₆ | +61.25* | 2.05 | 1.5927 | L32 | Glass (L32, cemented) |
| r₇ | +16.65 | 12.6 total gap | 1.0 | — | Air (6.3 mm to stop + 6.3 mm from stop) |
| *STO* | ∞ | — | 1.0 | — | *Aperture stop* |
| r₈ | −21.3 | 2.70 | 1.6483 | L41 | Glass (L41) |
| r₉ | +67.85 | 10.25 | 1.7170 | L42 | Glass (L42, cemented) |
| r₁₀ | −29.05 | 0.30 | 1.0 | — | Air |
| r₁₁ | +58.15 | 5.50 | 1.7170 | L51 | Glass (L51) |
| r₁₂ | ∞ (flat) | 0.30 | 1.0 | — | Air |
| r₁₃ | +71.15 | 1.45 | 1.6259 | L61 | Glass (L61) |
| r₁₄ | +48.45 | 3.90 | 1.6385 | L62 | Glass (L62, cemented) |
...
|-----------|-------------|----------------------|-----------|
| f_I (L11) | +447.7 | +447.8 | ✓ |
| f_II (L21) | +338.9 | +338.9 | ✓ |
| f_III (L31+L32) | −823.7 | −823.7 | ✓ |
| f_IV (L41+L42) | +2,309.5 | +2,308.2 | ✓ |
| f_V (L51) | +162.2 | +162.2 | ✓ |
| f_VI (L61+L62) | +300.2 | +300.2 | ✓ |
...
### L11 — Component I: Front Positive Meniscus
...
- **Role:** L11 is a low-power positive meniscus that serves primarily to extend the front group, distributing the convergence burden more gently across the front half of the lens. Its weak power means it contributes minimally to aberration while allowing the subsequent elements to work at reduced incidence angles. This element is *not* one of the three lanthanum elements — it uses conventional barium-based dense crown glass, likely a HIKARI (Nikon subsidiary) equivalent of Schott SK4 or a similar 1950s-era dense crown.

### L21 — Component II: Second Positive Meniscus

- **Shape:** Positive meniscus, convex to object (R₃ = +93.0, R₄ = +163.8)
- **Glass:** nd = 1.6073, νd = 59.5 — same glass as L11
- **Focal length:** +338.9 mm (moderate weak positive, 3.4× EFL)
- **Role:** L21 is the stronger of the two front meniscus elements. It works together with L11 to gradually converge the on-axis marginal ray bundle before it enters the more strongly curved Component III. The pair L11 + L21 contributes gentle positive power from the front, akin to a "power supplement" that transforms the classical four-element Gauss core into a wider-aperture design. Using the same glass as L11 simplifies manufacturing and ensures matched chromatic behavior.

### L31 — Component III, front element (cemented doublet D1)
...
- **Role:** L31 is the first and most powerful of the three lanthanum elements. It carries the highest refractive index in the entire system (nd = 1.77). Its strongly curved front surface (r₅ = +53.5) does the bulk of the refracting in the front group, while the high refractive index keeps the surface curvatures more moderate than they would otherwise need to be — directly reducing spherical aberration contributions.
...
### L32 — Component III, rear element (cemented doublet D1)
...
- **Role:** L32 is the chromatic correction partner to L31. Its lower Abbe number (higher dispersion) balances the chromatic aberration introduced by L31's positive power. The cemented pair III has a combined focal length of −823.7 mm — a very weak negative meniscus that acts primarily as a chromatic corrector rather than a significant power element.
...
### L41 — Component IV, front element (cemented doublet D2)
...
- **Role:** L41 is the strongest negative element in the system. Positioned immediately behind the aperture stop, it forms the front half of the rear achromatic doublet (Component IV). Its high dispersion (low νd) and strong negative power are essential for chromatic correction of the rear group.

  The patent requires n₆ > n₅ (1.717 > 1.648) and n₆ > 1.70, ensuring that the lanthanum positive element L42 dominates the refractive behavior of this cemented pair. The combined Component IV has an extremely weak positive focal length of +2,309 mm — it is nearly afocal and serves primarily for aberration correction rather than power contribution.

### L42 — Component IV, rear element (cemented doublet D2)
...
- **Role:** L42 is the second lanthanum element and the strongest single positive element in the rear group. Its biconvex form provides strong convergence immediately behind the stop. The lanthanum glass (shared with L51) provides high refractive index with moderate dispersion, allowing the biconvex curvatures to be less extreme than they would with conventional crown glass.

  The rear surface r₁₀ = −58.1 (|r₁₀|/f = 0.580, satisfying the patent's 0.50f–0.65f condition) is critical for the aberration balance of the rear group. L42 is extraordinarily thick (d₉ = 20.5 mm at f = 100, or 10.25 mm at the 50 mm production scale used here) — one of the most massive individual elements in any normal-focal-length photographic lens of this era.

### L51 — Component V: Single Plano-Convex

- **Shape:** Plano-convex (R₁₁ = +116.3, R₁₂ = flat)
- **Glass:** nd = 1.7170, νd = 47.9 — **Lanthanum Crown (LaK)**, same glass as L42, code 717/479
- **Focal length:** +162.2 mm (1.62× EFL)
- **Role:** L51 is the third lanthanum element and the principal power element of the rear group — at f = 162.2, it is the shortest focal length of any single component. Its plano-convex form with the flat surface facing the image is geometrically simple but optically significant: the single curved surface contributes positive power while the flat rear surface contributes zero power and no primary (Seidel) aberrations, making L51 a clean, efficient power contributor.

  Using the same lanthanum glass as L42 was a practical choice — it reduces the number of distinct glass types that must be stocked and melted, and ensures consistent chromatic behavior between these two key rear-group elements.

### L61 — Component VI, front element (cemented doublet D3)
...
The three negative elements (L32, L41, L61) use conventional flint glasses with νd in the 33–36 range. These are paired with the high-index positive elements in cemented doublets to form achromatic correctors:

| Element | nd | νd | Code | Family |
|---------|-----|-----|------|--------|
| L32 | 1.5927 | 35.4 | 593/354 | Light Flint (LLF) |
| L41 | 1.6483 | 33.8 | 648/338 | Flint (F) |
| L61 | 1.6259 | 35.6 | 626/356 | Light Flint (LF) |
...
Seven distinct glass types are used across nine elements, with two duplications (L11 = L21 and L42 = L51):

| Glass type | nd | νd | Elements | Family |
|-----------|-----|-----|----------|--------|
| 607/595 | 1.6073 | 59.5 | L11, L21 | Dense Crown (SK) |
| 770/479 | 1.7700 | 47.9 | L31 | Lanthanum Crown/Flint (LaK/LaF) |
| 717/479 | 1.7170 | 47.9 | L42, L51 | Lanthanum Crown (LaK) |
| 593/354 | 1.5927 | 35.4 | L32 | Light Flint (LLF) |
| 648/338 | 1.6483 | 33.8 | L41 | Flint (F) |
| 626/356 | 1.6259 | 35.6 | L61 | Light Flint (LF) |
| 639/555 | 1.6385 | 55.5 | L62 | Dense Crown (SK) |

The use of identical glass for L42 and L51 is notable: both are lanthanum crown elements in the rear group, and sharing a glass type was a practical decision that reduced manufacturing complexity.
...
| 40 < ν₃ < 55 | Abbe number of L31 | ν₃ = 47.9 | ✓ |
...
| n₆ > 1.70 | Refractive index of L42 | n₆ = 1.717 | ✓ |
| 37 < ν₆ < 55 | Abbe number of L42 | ν₆ = 47.9 | ✓ |
