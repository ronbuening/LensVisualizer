...
const LENS_DATA = {
   ...
   */
  elements: [
    { id: 1, name: "L11", label: "Element 1",  type: "Neg. Meniscus (1× Asph)", nd: 1.68948, vd: 31.02, fl: -104.1, glass: "L-TIM28 (OHARA)",  apd: false, role: "Front field lens — bends off-axis bundles inward, aspherical rear surface controls SA and astigmatism. PGM glass." },
    { id: 2, name: "L12", label: "Element 2",  type: "Biconcave Negative",      nd: 1.59270, vd: 35.31, fl:   -9.3, glass: "S-FTM16 (OHARA)",  apd: false, role: "G1 doublet flint — provides high-dispersion medium for chromatic correction at cemented junction.", cemented: "D1" },
    { id: 3, name: "L13", label: "Element 3",  type: "Biconvex Positive",       nd: 1.88300, vd: 40.76, fl:    7.1, glass: "S-LAH58 (OHARA)",  apd: false, role: "G1 doublet crown (nd=1.883) — main positive power generator of G1; quasi-symmetric partner to L21.", cemented: "D1" },
    { id: 4, name: "L21", label: "Element 4",  type: "Biconvex Positive",       nd: 1.88300, vd: 40.76, fl:    6.9, glass: "S-LAH58 (OHARA)",  apd: false, role: "G2 doublet crown — most powerful converging element; mirrors L13 across stop.", cemented: "D2" },
    { id: 5, name: "L22", label: "Element 5",  type: "Biconcave Negative",      nd: 1.69895, vd: 30.13, fl:   -8.8, glass: "S-TIM35 (OHARA)",  apd: false, role: "G2 doublet flint — rear surface forms air lens AL2 for coma and diameter control.", cemented: "D2" },
    { id: 6, name: "L23", label: "Element 6",  type: "Pos. Meniscus (2× Asph)", nd: 1.76802, vd: 49.24, fl:  127.7, glass: "S-LAH53 (OHARA)",  apd: false, role: "Weak positive meniscus — fine-tunes off-axis aberrations far from stop. S-prefix: likely CNC/MRF asphere." },
    { id: 7, name: "L31", label: "Element 7",  type: "Neg. Meniscus (2× Asph)", nd: 1.80139, vd: 45.45, fl:  -46.1, glass: "M-TAF101 (HOYA)",  apd: false, role: "Fixed negative rear element (G3) — field flattener and distortion corrector. HOYA M-series PGM glass, both surfaces heavily aspherical (>1 mm departure)." },
  ],
  ...
  surfaces: [
    //                                                                         ┌─ G1 ─────────────────────────────
    { label: "1",   R:   13.353, d: 0.70, nd: 1.68948, elemId: 1, sd:  7.8 },  // L11 front (spherical)
    { label: "2A",  R:   11.258, d: 2.40, nd: 1.0,     elemId: 0, sd:  7.2 },  // L11 rear → air (aspherical)
    { label: "3",   R:  -17.988, d: 0.65, nd: 1.59270, elemId: 2, sd:  5.5 },  // L12 front
    { label: "4",   R:    7.957, d: 2.64, nd: 1.88300, elemId: 3, sd:  5.2 },  // L12→L13 junction — elemId: L13
    { label: "5",   R:  -29.283, d: 1.14, nd: 1.0,     elemId: 0, sd:  4.3 },  // L13 rear → air
    //                                                                         └─ G1 ─────────────────────────────
    { label: "STO", R:     1e15, d: 1.20, nd: 1.0,     elemId: 0, sd:  3.2 },  // aperture stop
    //                                                                         ┌─ G2 ─────────────────────────────
    { label: "7",   R:   16.939, d: 2.60, nd: 1.88300, elemId: 4, sd:  4.0 },  // L21 front
    { label: "8",   R:   -9.407, d: 0.50, nd: 1.69895, elemId: 5, sd:  4.6 },  // L21→L22 junction — elemId: L22
    ...
    { label: "11A", R:  -13.531, d: 3.10, nd: 1.0,     elemId: 0, sd:  6.5 },  // L23 rear → air (aspherical) — D23 gap
    //                                                                         └─ G2 ─────────────────────────────
    //                                                                         ┌─ G3 (fixed) ─────────────────────
    { label: "12A", R:  -26.270, d: 0.75, nd: 1.80139, elemId: 7, sd:  8.0 },  // L31 front (aspherical)
