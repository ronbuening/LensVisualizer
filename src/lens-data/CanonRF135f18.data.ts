...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      glass: "S-TIH6 (OHARA)",
      apd: "inferred",
      apdNote: "Titanium flint — anomalous partial dispersion above the normal line, complementary to UD partner.",
      cemented: "D1",
    ...
    },
    {
      ...
      glass: "S-TIH6 (OHARA)",
      apd: "inferred",
      apdNote: "Titanium flint — anomalous dispersion complementary to UD.",
      cemented: "D2",
  ...
  groups: [
    ...
    { text: "G2 (−)", fromSurface: "12", toSurface: "13" },
    { text: "G3 (+)", fromSurface: "14", toSurface: "30" },
  ],
