...
const LENS_DATA = {
  ...
  patentNumber: "US 3,874,771",
  patentAuthors: ["Karl-Heinrich Behrens", "Erhard Glatzel"],
  ...
  elements: [
    {
      ...
      vd: 47.99,
      fl: 72.7,
      glass: "LAF3 catalog equivalent (patent coordinate; production supplier unspecified)",
      apd: false,
    ...
    },
    {
      ...
      vd: 47.37,
      fl: 65.4,
      glass: "N-LAF21 catalog equivalent (historical LaF 21 family; production supplier unspecified)",
      apd: false,
    ...
    },
    {
      ...
      vd: 31.17,
      fl: -33.5,
      glass: "J-SF8 catalog equivalent (patent coordinate; production supplier unspecified)",
      apd: false,
    ...
    },
    {
      ...
      vd: 28.68,
      fl: -22.7,
      glass: "SF10 catalog equivalent (historical SF 10 family; production supplier unspecified)",
      apd: false,
    ...
    },
    {
      ...
      vd: 44.77,
      fl: 98.4,
      glass: "N-LAF2 catalog equivalent (historical LaF 2 family; production supplier unspecified)",
      apd: false,
