...
The normalized model preserves the raw source value in the supporting evidence but implements the independently solved source-precision correction d22 = 22.083 mm. Surface 22A stores that corrected 22.083 mm gap. The printed 2.500 mm, nd 1.5168, νd 64.20 cover glass CG and the following 1.000 mm air space are modeled in `rearPlates`. Every analysis traces them, but the diagram does not draw them. Their paraxial air equivalent is 24.731206751055 mm from surface 22A to the image, only +0.000196 mm from the independently calculated Gaussian BFD. This is a documented modeling correction, not a silent alteration of the patent.
