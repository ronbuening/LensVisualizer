...
const LENS_DATA = {
  ...
  specs: [
    ...
    "GEOMETRIC MODEL f/4.0036 / PRODUCTION f/4.5",
    "135 FULL-FRAME",
  ...
  elements: [
    {
      ...
      glass: "517642 — BK7/K9L crown class (supplier unresolved)",
      apd: false,
    ...
    },
    {
      ...
      glass: "518603 — BaLK3-class (supplier unresolved)",
      apd: false,
    ...
    },
    {
      ...
      glass: "561453 — LLF4-class (supplier unresolved)",
      apd: false,
  ...
  closeFocusM: 3.5,
  focusDescription: "NO_INTERNAL_RECONSTRUCTION — fixed patent optics; external bellows focus to 3.5 m.",
