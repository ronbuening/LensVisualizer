...
const LENS_DATA = {
  ...
  surfaces: [
    ...
    { label: "5", R: -67.2399, d: 1.25, nd: 1.62588, elemId: 3, sd: 17.5 },
    { label: "6", R: 27.2189, d: 0.8, nd: 1.0, elemId: 0, sd: 17.0 },
    ...
    { label: "11", R: -168.1721, d: 0.96, nd: 1.673, elemId: 6, sd: 11.0 },
