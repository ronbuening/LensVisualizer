...
**L6:** $n_d = 1.7865$, $\nu_d = 50.1$. Glass: YGH52 (OHARA catalog-equivalent; patent supplier unspecified). $f = -14.97$ mm.

**L7:** $n_d = 1.6032$, $\nu_d = 42.3$. Glass: BAM25 (OHARA catalog-equivalent; patent supplier unspecified). $f = +15.19$ mm.
