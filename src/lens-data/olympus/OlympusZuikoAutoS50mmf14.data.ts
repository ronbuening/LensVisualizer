...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 50.8,
      fl: 76.3,
      glass: "694508 — LaK-type A (patent nd=1.69350, νd=50.8; no exact current catalog match)",
      apd: false,
    ...
    },
    {
      ...
      vd: 50.8,
      fl: 74.9,
      glass: "694508 — LaK-type A (same glass as L2; no exact current catalog match)",
      apd: false,
