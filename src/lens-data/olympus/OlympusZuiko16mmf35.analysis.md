...
**nd = 1.51728, νd = 69.6. Glass: S-APL1 (OHARA; 517696). Standalone f = 62.10 mm.**
...
**L7b: nd = 1.51728, νd = 69.6. Glass: S-APL1 (OHARA; 517696). Standalone f = 19.16 mm.**
...
| L6, L7b | S-APL1 (OHARA) | 1.51728 | 69.6 | 517/696 | Low-index high-Abbe crown used after the stop and in the rear doublet; catalog-backed from OHARA's discontinued-glass data. |
...
Glass-catalog identifications checked against OHARA catalog pages for S-BAL35, S-LAH51, S-LAL14, S-TIM35, S-TIH11, S-TIM5, and S-TIH6, plus the historical OHARA S-APL1 record in the vendor's all-products catalog. The patent does not name the glass supplier; all glass names in this document are catalog-equivalent identifications by $n_d$ and $\nu_d$.
