...
The glass is identified as legacy Schott F2 standard flint. Its catalog curve gives $n_e = 1.624080$ and $\nu_e = 36.108$, reproducing the patent's $1.62408 / 36.12$ pair to the printed precision. Earlier analysis compared the patent e-line coordinate with a d-line value and incorrectly characterized this as a marginal match.
