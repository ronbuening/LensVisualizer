...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 55.1,
      fl: 15.2,
      glass: "SSK class (614/551, Schott — probable discontinued formulation)",
      apd: false as const,
      cemented: "TF",
    ...
    },
    {
      ...
      vd: 45.3,
      fl: -27.1,
      glass: "BaLF class (561/453, Schott — uncertain identification)",
      apd: false as const,
      cemented: "TF",
    ...
    },
    {
      ...
      vd: 56.3,
      fl: 13.7,
      glass: "SSK class (614/563, Schott — probable discontinued formulation)",
      apd: false as const,
      cemented: "TR",
    ...
    },
    {
      ...
      vd: 41.1,
      fl: -46.1,
      glass: "BaSF class (702/411, Schott — probable discontinued formulation)",
      apd: false as const,
      cemented: "TR",
    ...
    },
    {
      ...
      vd: 63.6,
      fl: -47.6,
      glass: "K/BK class (520/636, Schott — uncertain identification)",
      apd: false as const,
