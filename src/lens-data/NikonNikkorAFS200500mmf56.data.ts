...
const LENS_DATA = {
  ...
  groups: [
    ...
    { text: "G2 (−, fixed)", fromSurface: "6", toSurface: "16" },
    { text: "G3 (+)", fromSurface: "17", toSurface: "19" },
    { text: "G4 (+, fixed)", fromSurface: "20", toSurface: "24" },
    { text: "G5 (−, focus)", fromSurface: "26", toSurface: "28" },
    { text: "G6 (fixed)", fromSurface: "29", toSurface: "32" },
  ],
