...
const LENS_DATA = {
  ...
  surfaces: [
    ...
    { label: "1",   R:   30.960,  d: 5.472,  nd: 1.61320, elemId: 1, sd: 16.5 },  // L1 front (convex)
    ...
    { label: "4",   R:   29.952,  d: 4.320,  nd: 1.0,     elemId: 0, sd: 13.1 },  // L2 rear (strongly convex) → air

    /* ── Aperture stop ── */
    { label: "STO", R:      1e15, d: 4.320,  nd: 1.0,     elemId: 0, sd: 11.1 },  // diaphragm

    /* ── Rear group: L3 + L4 (cemented doublet) ── */
    { label: "5",   R: -160.272,  d: 1.584,  nd: 1.52110, elemId: 3, sd: 12.4 },  // L3 front (gently concave)
    { label: "6",   R:   36.288,  d: 4.320,  nd: 1.61132, elemId: 4, sd: 12.4 },  // cemented junction → L4 glass
  ...
  /* ── Focus configuration ── */
  closeFocusM:      2.0,
  focusDescription: "Unit focusing — entire lens assembly moves forward.  No variable internal spacings.  Front-element focusing also used on mid-range cameras (L1 moves ~⅓ the distance of unit focus due to ~2.8× power ratio).",
