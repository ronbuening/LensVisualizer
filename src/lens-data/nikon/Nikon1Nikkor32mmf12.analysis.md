...
The patent's plane filter/sensor-cover stack, surfaces 18-23 (filter group FL), is modeled in the data file through `rearPlates`: three plane plates with nd = 1.5168 and νd = 63.88, 0.50 mm, 1.59 mm, and 0.70 mm thick, followed by 1.11 mm, 0.30 mm, and 0.70 mm of air. Every analysis traces the plates, but they are not drawn.

Surface 17 therefore stores the physical gap to the first plate: 10.20169 mm at infinity, 10.43169 mm at the intermediate state, and 11.97169 mm at close focus, preserving the patent's +0.23 mm and +1.77 mm shifts. The infinity value keeps the previous image plane, the independently traced paraxial focus: its air-equivalent back focus from surface 17 is 14.15109 mm, 0.0017 mm more than the 14.1494 mm that the printed d17 = 10.20 gives, a rounding-level difference. The physical track now includes the plates and matches the patent's TL = 52.60 mm and Bf = 15.10 mm to that rounding. Piecewise-linear movement between keyframes is only a visualization approximation.
