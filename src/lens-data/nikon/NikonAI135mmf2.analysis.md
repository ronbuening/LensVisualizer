...
The patent prescription is normalized to a 100 mm focal length. The production Nikkor 135mm f/2 is uniformly scaled by a factor of approximately **1.350** to reach the marketed 135 mm focal length. The runtime data stores physical millimetres after this conversion, including the 18.09 mm reconstructed close-focus stroke. Calculated EFL is 134.995 mm throughout unit focusing. All values in this analysis are given at both patent scale (f = 100 mm) and production scale (f = 135 mm) where appropriate.
