...
**Optical Filter (FL)** — Source surfaces 25–26 describe the removable, interchangeable filter FL: a 1.600 mm plate of nd = 1.51680 and νd = 64.1, 10.500 mm behind L33 with D26 = 1.000 mm to the image plane at both focus states. The model carries it in `rearPlates` as a J-BK7A-class plate: every analysis traces it, but the diagram does not draw it. Its paraxial equivalent is the patent's air-equivalent back focus, 10.5 + 1.6/1.5168 + 1 = 12.555 mm (BFa 12.554), and the modeled physical track equals the patent's 92.330 mm. At close focus, D0 = 307.67 mm therefore gives the source's 400 mm object-to-image distance.
