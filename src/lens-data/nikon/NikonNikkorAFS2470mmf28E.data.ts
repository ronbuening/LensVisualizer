...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 29.1,
      fl: 80.2,
      glass: "S-LAH99 / TAFD55 (001291, HRI)",
      apd: false,
    ...
    // ── G4 (rear positive group) ──
    {
      ...
      vd: 71.7,
      fl: 106.8,
      glass: "553717 - ASP/ED fluorophosphate crown (patent nd=1.55332, vd=71.70)",
      apd: "inferred",
      apdNote: "Nikon ASP/ED element; patent supplies nd/vd only, with no partial-dispersion table.",
    ...
    },
    {
      ...
      apd: "inferred",
      apdNote: "ED candidate by nd/vd region; no exact public catalog match or patent partial-dispersion data.",
      cemented: "Jb",
    ...
    },
    {
      ...
      vd: 82.6,
      fl: 44.8,
      glass: "S-FPL51 / FCD1 class (ED fluorophosphate, vd=82.6)",
      apd: "inferred",
      apdNote: "S-FPL51/FCD1-family ED glass; patent supplies nd/vd only.",
      cemented: "Tc",
    ...
    },
    {
      ...
      vd: 53.3,
      fl: 180.6,
      glass: "694533 - lanthanum crown (patent nd=1.69350, vd=53.30)",
      apd: false,
      cemented: "Tc",
