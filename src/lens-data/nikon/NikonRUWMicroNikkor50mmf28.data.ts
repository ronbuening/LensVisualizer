...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 40.3,
      fl: 48.9,
      glass: "BAFD3 (HOYA catalog equivalent; production supplier unspecified; patent 607403)",
      apd: false,
  ...
  focusPositions: [0, 0.6967361668974719, 1],
  var: {
    "2": [43.0605, 24.2389, 5.4172],
    "15": [4.4407, 23.2623, 42.084],
  },
  varLabels: [
    ["2", "D2"],
    ["15", "D15"],
