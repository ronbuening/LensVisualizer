...
Visually rechecked Example 1, Tables 8 and 10 in local `patents/WO2019131993A1.pdf`, then cross-matched the patent coordinates against the official OHARA 2026-07-01, HOYA 2026-07-07, and HIKARI catalog files. No row below has a candidate inside both runtime tolerances (`Δnd ≤ 0.0001`, `Δνd ≤ 0.15`), so the code-based fallbacks remain intentional rather than unreviewed opportunities.
