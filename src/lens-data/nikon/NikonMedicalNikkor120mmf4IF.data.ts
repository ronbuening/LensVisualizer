 ...
 * ║                                                                            ║
 * ║ SEMI-DIAMETERS: not published. They are modeling inferences constrained  ║
 * ║ by the patent optical section, paraxial marginal/chief rays, the 43.28 mm║
 * ║ image circle, Nikon's production section, positive edge thickness, rim   ║
 * ║ slope, cross-gap clearance, and off-axis containment.                    ║
 * ║                                                                            ║
...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      indexReference: "d",
      fl: 63.12315,
      glass: "785261 — dense-flint class (vendor unresolved)",
      apd: false,
      cemented: "D2",
    ...
    },
    {
      ...
      indexReference: "d",
      fl: -42.149938,
      glass: "723380 — barium dense-flint/BASF class (vendor unresolved)",
      apd: false,
      cemented: "D3",
  ...
  surfaces: [
    ...
    { label: "9", R: 26.35, d: 13.6, nd: 1.713, elemId: 6, sd: 14.0 },
    { label: "10", R: 250.0, d: 2.9, nd: 1.72342, elemId: 7, sd: 13.0 },
    { label: "11", R: 27.045, d: 25.7, nd: 1.0, elemId: 0, sd: 12.5 },
    { label: "12", R: -15.884, d: 2.4, nd: 1.7847, elemId: 8, sd: 13.8 },
    { label: "13", R: -21.077, d: 0.1, nd: 1.0, elemId: 0, sd: 14.5 },
