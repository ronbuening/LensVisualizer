...
The glass identification is an exact match to **OHARA S-BSM16** (nd = 1.62041, νd = 60.29; residuals Δnd = 0.00000, Δνd = 0.01). Cross-catalog equivalents include Schott N-SK16. This is a barium silicate crown — a workhorse optical glass offering moderate refractive index with high Abbe number, well-suited for positive power elements where chromatic contribution must be minimized.
...
L2 is the element Matsui added to the classical Ernostar to create the 5-element variant. It uses the same glass type as L1 (S-BSM16), simplifying manufacturing and procurement. Its shape factor (q ≈ +2.75) indicates even deeper meniscus bending than L1, with both surfaces convex toward the object side but the front surface substantially steeper.
