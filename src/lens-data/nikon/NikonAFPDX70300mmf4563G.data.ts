  ...
  elements: [
    {
      ...
      vd: 63.88,
      fl: 150.7,
      glass: "Crown glass (517/639; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 31.26,
      fl: -98.7,
      glass: "Anomalous-dispersion flint class (612/313; patent-specified)",
      apd: "patent",
    ...
    },
    {
      ...
      vd: 52.2,
      fl: 87.5,
      glass: "Medium-dispersion crown (517/522; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 55.52,
      fl: -26.6,
      glass: "High-index crown (697/555; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 22.74,
      fl: 35.7,
      glass: "Dense flint (808/227; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 32.35,
      fl: -48.2,
      glass: "Dense flint / lanthanum-flint class (850/324; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 61.22,
      fl: 70.5,
      glass: "Crown glass (589/612; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 81.73,
      fl: 40.4,
      glass: "ED fluorophosphate crown class (497/817; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 70.31,
      fl: 70.0,
      glass: "Low-dispersion crown (487/703; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 34.92,
      fl: 28.3,
      glass: "Dense flint / high-index medium-dispersion class (801/349; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 48.11,
      fl: -15.9,
      glass: "High-index flint class (700/481; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 38.03,
      fl: 35.8,
      glass: "Medium-index flint (603/380; catalog identity not asserted)",
      apd: false,
    ...
    },
    {
      ...
      vd: 49.62,
      fl: -67.8,
      glass: "High-index medium-dispersion flint class (773/496; catalog identity not asserted)",
      apd: false,
