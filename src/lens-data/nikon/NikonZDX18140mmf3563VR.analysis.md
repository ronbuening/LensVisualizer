...
nd = 1.80809, νd = 22.74. Glass: J-SFH1 (Hikari) — dense flint with very high dispersion. f = +20.6 mm (standalone thick-lens).
...
nd = 1.60342, νd = 38.03. Glass: S-TIM5 (OHARA) — titanium flint. f = +86.3 mm (standalone thick-lens).
...
nd = 1.66755, νd = 41.87. Glass: J-BASF6 (Hikari) — barium short flint. f = −131.9 mm (standalone thick-lens).

L36 is cemented to L35's glass substrate, forming a weakly negative meniscus that controls field curvature and coma generated by the VR decentering. The Hikari J-BASF6 catalog row matches the patent's nd/vd pair exactly and supplies coefficient-backed dispersion. The combined GVR sub-group has a focal length of +28.9 mm, matching the patent's stated fVR = +28.900 mm. The two-element VR construction (¶0083) helps suppress chromatic variation during image stabilization.
...
nd = 1.90265, νd = 35.77. Glass: J-LASFH9 (Hikari) — dense lanthanum flint. f = −37.7 mm (standalone thick-lens).
...
The L36 identification is now J-BASF6 (Hikari): the public Hikari catalog gives nd = 1.66755 and νd = 41.87 with power-series coefficients, matching the patent row exactly.
