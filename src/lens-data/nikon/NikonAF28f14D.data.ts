...
const LENS_DATA = {
  ...
  elements: [
    ...
    // ── G2: Main positive group (5 elements, 4 groups) ──
    {
      ...
      vd: 49.4,
      fl: +75.4,
      glass: "S-LAH66 (OHARA) — near nd=1.77250/νd=49.62",
      apd: false,
    ...
    },
    {
      ...
      vd: 46.5,
      fl: +30.8,
      glass: "S-LAH65V (OHARA) — near nd=1.80400/νd=46.58",
      apd: false,
    ...
    },
    {
      ...
      vd: 49.4,
      fl: +95.1,
      glass: "S-LAH66 (OHARA) — same as L2",
      apd: false,
    ...
    // ── G4: Final positive group (2 elements, 1 group) ──
    {
      ...
      vd: 46.5,
      fl: +25.5,
      glass: "S-LAH65V (OHARA) — same as L5",
      apd: false,
