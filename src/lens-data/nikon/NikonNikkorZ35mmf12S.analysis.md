...
Glass code 946180. **OHARA S-NPH7** — an ultra-high-index, ultra-high-dispersion glass with **strong anomalous partial dispersion**. The front surface is convex (R = +90.1 mm) and the rear junction is flat (R = ∞). This element is identified in the patent as "Lens Lp" — a special element satisfying condition (14): θgF + 0.0021×νd > 0.670 (value: 0.692) and condition (15): 15.00 < νd < 35.00 (value: 17.98). S-NPH7 has one of the most extreme partial dispersion characteristics of any commercial glass — its θgF of 0.6546 places it far from the normal line on the θgF-νd diagram. This anomalous dispersion allows L42 to correct secondary chromatic aberration (the residual color that persists after primary achromatization). The patent notes that Lp is preferably located in the final group R of the rear section — placing the secondary-spectrum corrector near the image plane maximizes its effect on lateral (transverse) color while minimizing its contribution to axial aberrations.
