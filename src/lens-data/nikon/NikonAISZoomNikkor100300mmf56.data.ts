...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 70.24,
      fl: 140.76183,
      glass: "487702 - S-FSL5 catalog equivalent (production supplier unspecified)",
      cemented: "L11",
    ...
    },
    {
      ...
      vd: 53.97,
      fl: -43.622977,
      glass: "713540 - J-LAK8 catalog equivalent (production supplier unspecified)",
      cemented: "L22",
  ...
  surfaces: [
    ...
    { label: "4", R: 83.989, d: 6.5, nd: 1.48749, elemId: 3, sd: 30.0 },
    { label: "5", R: 3244.26, d: 1.211, nd: 1.0, elemId: 0, sd: 30.0 },
  ...
  groups: [
    ...
    { text: "G4 (+) / RELAY", fromSurface: "15", toSurface: "24" },
  ],
  doublets: [
