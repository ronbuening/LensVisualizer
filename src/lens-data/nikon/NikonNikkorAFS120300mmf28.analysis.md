...
**Candidate 2 — L25 (G2, positive meniscus):** nd = 1.755750, νd = 24.71, θgF = 0.629. No current catalog entry round-trips this exact pair while preserving the patent's anomalous partial-dispersion context, so the lens data keeps the six-digit 756247 code annotation rather than forcing a nearby dense flint.
...
| L25 | 1.755750 | 24.71 | 0.629 | 756247 code glass | code fallback | High (patent data) |
...
**L24+L25 (cemented doublet, f = −99 mm):** This is the main power element of G2. L24 (biconcave, S-LAH52, νd = 46.60) provides the bulk of the negative power, while L25 (positive meniscus, 756247 code glass, νd = 24.71, θgF = 0.629) is a high-dispersion, anomalous-partial-dispersion glass. L25 is identified in the patent as the "second lens" (第2レンズ) and satisfies conditions (6)–(8), which specify its glass properties for secondary spectrum correction. The L24+L25 combination ensures that G2's strong negative power does not introduce excessive longitudinal chromatic aberration or secondary spectrum.
...
**L52 (biconvex positive, S-LAL18, f = +94 mm):** Immediately after the stop, this moderate-power positive element begins reconverging the beam.
