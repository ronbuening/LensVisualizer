...
**nd = 1.61375, νd = 56.3. Glass: 614563 - SK6 / BSM6 class (historical vendor unresolved). Standalone f = +119.347 mm.**
...
A legacy OHARA BSM6 row and the corresponding Schott SK6 class match the stored index exactly and differ in Abbe number by only 0.1. This is a coordinate-class match; the patent does not identify the historical glass vendor or melt.
