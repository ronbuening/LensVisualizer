  ...
  elements: [
    {
      ...
      apd: "inferred",
      apdNote:
        "ED assignment from Nikon's three-element production specification and the prescription's three 1.49782/82.52 positions; the patent publishes nd/νd only.",
