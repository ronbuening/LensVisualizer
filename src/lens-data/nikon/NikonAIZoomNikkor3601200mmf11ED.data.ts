...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 36.9,
      fl: -651.0,
      glass: "F3 (SUMITA catalog equivalent for patent coordinate; production supplier unspecified)",
    ...
    },
    {
      ...
      vd: 45.0,
      fl: 290.1,
      glass: "BAF12 (SUMITA catalog equivalent for patent coordinate; production supplier unspecified)",
