...
const LENS_DATA = {
  ...
  elements: [
    // ── G1: Front Objective (fixed, f = +143.95 mm) ──
    {
      ...
      vd: 29.37,
      fl: -327.1,
      glass: "950294 - ultra-high-index dense flint (patent nd=1.95000, vd=29.37)",
      apd: false,
    ...
    // ── G2: Variator (moves during zoom, f = −45.57 mm) ──
    {
      ...
      vd: 50.27,
      fl: -93.9,
      glass: "720503 - lanthanum crown (patent nd=1.71999, vd=50.27)",
      apd: false,
    ...
    },
    {
      ...
      apd: false,
      role: "ED-candidate fluorophosphate crown; plano-convex form minimizes spherical aberration for near-collimated beams",
    },
    {
      id: 10,
      name: "L33",
    ...
    },
    {
      ...
      vd: 35.73,
      fl: 47.5,
      glass: "903357 - high-index lanthanum flint (patent nd=1.90265, vd=35.73)",
      apd: false,
    ...
    },
    {
      ...
      glass: "593679 - fluorophosphate crown (patent nd=1.59319, vd=67.90)",
      apd: false,
      role: "ED-candidate fluorophosphate crown cemented to L42; net positive doublet (f ≈ +170 mm) maintains color correction through focus",
      cemented: "D3",
    },
    ...
    },
    {
      ...
      glass: "593679 - fluorophosphate crown (patent nd=1.59319, vd=67.90)",
      apd: false,
      role: "Third 593679 fluorophosphate crown element; corrects chromatic shifts introduced by VR lateral decentering",
    },
    {
      id: 22,
      name: "L56",
      ...
      glass: "720503 - lanthanum crown (patent nd=1.71999, vd=50.27)",
      apd: false,
      role: "Final element; positive meniscus controls back-focal field curvature and reuses the 720503 lanthanum crown family",
    },
  ],
