...
const LENS_DATA = {
  ...
  patentAuthors: ["幸介 町田", "治 五味渕", "賢一 北野", "瑞葵 和湯", "渡邉　常雄", "誠 堀越", "一郎 今榮"],
  ...
  elements: [
    ...
    // ── Group 2 — Variator, Negative (f = −22.1 mm) ──
    {
      ...
      vd: 49.53,
      fl: -27.6,
      glass: "744495 — moldable lanthanum crown (patent nd=1.74389, νd=49.53; no exact public catalog match)",
      apd: false,
    ...
    },
    {
      ...
      vd: 40.15,
      fl: -54.9,
      glass: "852402 — dense lanthanum flint (patent nd=1.85207, νd=40.15; no exact public catalog match)",
      apd: false,
