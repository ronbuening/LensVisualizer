...
const LENS_DATA = {
  ...
  elements: [
    ...
    // ── Group 2 — Variator, Negative (f = −22.1 mm) ──
    {
      ...
      vd: 49.53,
      fl: -27.6,
      glass: "744495 - moldable lanthanum crown (patent nd=1.74389, vd=49.53)",
      apd: false,
    ...
    },
    {
      ...
      vd: 82.57,
      fl: 29.7,
      glass: "498826 - fluorophosphate ED (patent nd=1.49782, vd=82.57)",
      apd: false,
    ...
    // ── Group 6 — 2nd Focus Group, Positive (f = +100.4 mm) ──
    {
      ...
      vd: 45.04,
      fl: 100.4,
      glass: "792450 - dense lanthanum crown (patent nd=1.79189, vd=45.04)",
      apd: false,
    ...
    },
    {
      ...
      vd: 40.15,
      fl: -54.9,
      glass: "852402 - dense lanthanum flint (patent nd=1.85207, vd=40.15)",
      apd: false,
