...
nd = 1.67025, νd = 57.53. Glass: S-LAL52 catalog equivalent for patent 670575; production supplier unspecified. f = +13.34 mm standalone in air.
...
The patent gives refractive index and Abbe number but no glass names. Current manufacturer catalogs support class-level identifications for L1 and L2 and a coefficient-compatible optical equivalent for L3.
...
| L3 | 1.67025 | 57.53 | 670575 | OHARA S-LAL52 is a coefficient-backed optical equivalent (`Δnd = -0.000251`, `Δνd = -0.202`); supplier unspecified. | `S-LAL52 catalog equivalent (patent 670575)` |
