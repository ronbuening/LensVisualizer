...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 25.15,
      fl: -88.0,
      glass: "855252 — high-index APD flint (source patent not locally available; no exact public catalog match verified)",
      apd: "patent",
      dPgF: 0.0095, apdNote: "θgF = 0.6103, ΔθgF = +0.0095 (patent conditions 4–6)",
    ...
    },
    {
      ...
      vd: 25.15,
      fl: -65.8,
      glass: "855252 — high-index APD flint (same as L12; source patent not locally available; no exact public catalog match verified)",
      apd: "patent",
      dPgF: 0.0095, apdNote: "θgF = 0.6103, ΔθgF = +0.0095 (patent conditions 17–19)",
