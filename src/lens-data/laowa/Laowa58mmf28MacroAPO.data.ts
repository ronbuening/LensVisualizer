...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      vd: 25.02,
      fl: -12.4,
      glass: "NBFD26 (HOYA catalog equivalent; production supplier unspecified)",
      apd: false,
      cemented: "Da",
    ...
    },
    {
      ...
      vd: 20.88,
      fl: 14.6,
      glass: "PBH21 (OHARA catalog equivalent; production supplier unspecified)",
      apd: false,
      cemented: "Da",
    ...
    },
    {
      ...
      vd: 29.9,
      fl: 43.5,
      glass: "Unmatched (patent nd=1.89782, νd=29.90; prior H-ZLAF68N annotation rejected on dispersion)",
      apd: false,
    ...
    },
    {
      ...
      vd: 41.79,
      fl: 18.2,
      glass: "Unmatched (patent nd=1.86602, νd=41.79; prior H-ZLAF55C annotation rejected on dispersion)",
      apd: false,
      cemented: "Dc",
