 ...
 * local JP1976-053823 PDF p. 4 at 600 dpi. The remaining ray-clearance apertures
 * are retained; the full-format corner chief ray clears, but peripheral pupil
...
const LENS_DATA = {
  ...
  elements: [
    ...
    },
    {
      ...
      indexReference: "d",
      fl: 39.645363,
      glass: "S-LAM54 — supplier-neutral catalog proxy; patent nd/vd retained, production identity unproven",
    },
    {
      id: 3,
      name: "L3",
      ...
      indexReference: "d",
      fl: 91.870867,
      glass: "S-BAM12 — supplier-neutral catalog proxy; patent nd/vd retained, production identity unproven",
    },
    {
      id: 4,
      name: "L4",
      ...
      indexReference: "d",
      fl: -17.479837,
      glass: "SF1 — supplier-neutral catalog proxy; patent nd/vd retained, production identity unproven",
    },
    {
      id: 5,
      name: "L5",
  ...
  surfaces: [
    ...
    { label: "5", R: 16.933, d: 2.835, nd: 1.6393, elemId: 3, sd: 9.5 },
    { label: "6", R: 22.239, d: 2.625, nd: 1, elemId: 0, sd: 8.2 },
    ...
    { label: "10", R: -23.366, d: 0.098, nd: 1, elemId: 0, sd: 9.1 },
    { label: "11", R: 412.79, d: 3.269, nd: 1.62041, elemId: 6, sd: 9.65 },
    { label: "12", R: -17.6575, d: 38.325, nd: 1, elemId: 0, sd: 9.65 },
  ],
