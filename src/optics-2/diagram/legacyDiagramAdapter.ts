...
export function computeElementRenderDiagnostics2(L: RuntimeLens, zPos: number[]): ElementRenderDiagnostics[] {
  return computeElementRenderDiagnosticsForState2(stateForLegacyDiagram2(L, zPos));
}
...
export function computeElementShapes2(
  ...
  return computeElementShapesForState2(stateForLegacyDiagram2(L, zPos), sx, sy, pointTransform);
}

export function stateForLegacyDiagram2(L: RuntimeLens, zPos: readonly number[]): PreparedOpticalState {
