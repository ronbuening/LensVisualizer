...
export interface LegacySkewRayTraceResult {
  x: number;
  y: number;
  ux: number;
  uy: number;
...
export function engineTraceToLegacyRayResult(
...
export function engineTraceToLegacySkewResult(result: EngineTraceResult): LegacySkewRayTraceResult {
  return {
    x: result.x,
    y: result.y,
    ux: result.ux,
