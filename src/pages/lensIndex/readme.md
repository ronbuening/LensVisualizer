...
- Direct subfolders: 0
- Main outbound areas: src/utils/catalog (17), same folder (12), package:react (2), src/types (2), src/utils/seo (2), src/utils/style (2), package:react-router, src/generated
...
| `groupAnchors.ts` | Group Anchors helper module | src/utils/catalog | same folder, src/pages/AuthorPage.tsx, src/pages/LensIndexPage.tsx, src/pages/PatentsIndexPage.tsx | slugifyGroupKey, makerGroupAnchorId, patentPartyGroupAnchorId, mountGroupAnchorId, formatGroupAnchorId, yearGroupAnchorId, focalSectionAnchorId, focalSubGroupAnchorId |
