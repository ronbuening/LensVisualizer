...
- Direct subfolders: 0
- Main outbound areas: src/utils/catalog (13), same folder (12), package:react (2), src/types (2), src/utils/seo (2), package:react-router, src/generated, src/utils/style
...
| `LensIndexResults.tsx` | Route-level React page | same folder (4), src/utils/catalog (2), package:react-router, src/types, src/utils/seo | src/pages/LensIndexPage.tsx | default, LensIndexResults |
