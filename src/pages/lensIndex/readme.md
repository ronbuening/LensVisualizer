...
| `LensIndexResults.tsx` | Route-level React page | same folder (4), src/types (2), src/utils/catalog (2), package:react-router, src/utils/seo, +1 more | src/pages/LensIndexPage.tsx | default, LensIndexResults |
