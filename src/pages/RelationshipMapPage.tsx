...
export default function RelationshipMapPage() {
  ...
  return (
    <StaticPageShell
      breadcrumbs={[
        { label: "Home", to: "/" },
        { label: "Relationship map", to: focus ? "/relationships/" : undefined },
      ]}
      seo={
        <SEOHead
        ...
        <>
          {graph && focus ? (
            ...
            <>
              ...
              >
                <section>
                  <h2 style={{ fontSize: "0.95rem", fontWeight: 600, margin: "0 0 0.6rem" }}>
                    Most-connected inventors
                  </h2>
