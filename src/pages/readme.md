...
flowchart LR
  ...
  n_src_pages_src_pages_AuthorsIndexPage_tsx --> |4| n_external_src_utils_catalog
  n_src_pages_src_pages_MountPage_tsx --> |4| n_external_src_utils_catalog
  n_src_pages_src_pages_RelationshipMapPage_tsx --> |4| n_external_src_utils_catalog
  ...
  n_src_pages_src_pages_AuthorsIndexPage_tsx --> n_external_pkg_react
...
- Direct subfolders: 1
- Main outbound areas: src/utils/catalog (50), package:react-router (19), src/components/layout (19), src/components/SEOHead.tsx (19), src/utils/seo (19), src/pages/lensIndex (18), src/utils/style (17), src/utils/theme (16), +16 more
...
| `AuthorPage.tsx` | Route-level React page | src/utils/catalog (5), src/components/content (2), src/utils/style (2), package:react-router, src/components/layout, +5 more | src/routes | default, AuthorPage |
| `AuthorsIndexPage.tsx` | Route-level React page | src/utils/catalog (4), src/utils/style (2), package:react, package:react-router, src/components/controls, +5 more | src/routes | default, AuthorsIndexPage |
...
| `MountPage.tsx` | Route-level React page | src/utils/catalog (4), src/components/content (2), src/pages/lensIndex (2), package:react-router, src/components/layout, +6 more | src/routes | default, MountPage |
