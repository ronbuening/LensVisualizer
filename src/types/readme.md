...
| `optics.ts` | Shared TypeScript types | same folder (2), src/utils/catalog | src/components/display (22), src/components/diagram (14), src/optics/trace (10), src/optics/analysis (9), src/components/hooks (7), +38 more | RadialPhaseTerm, DiffractivePhaseSurface, SurfaceData, SurfaceIncidentSide, SurfaceInactiveSideBehavior, SurfaceInteractionType, MirrorKind, SurfaceInteraction, +51 more |
...
| `theme.ts` | Shared TypeScript types | same folder | src/components/display (43), src/components/layout (20), src/components/diagram (16), src/components/controls (9), src/components/content (8), +13 more | ThemeInternalTokens, ThemeColorTokens, Theme, ThemeVariant |
