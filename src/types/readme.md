...
| `theme.ts` | Shared TypeScript types | same folder | src/components/display (56), src/components/layout (21), src/components/diagram (16), src/components/controls (10), src/components/content (8), +13 more | ThemeInternalTokens, ThemeColorTokens, Theme, ThemeVariant |
