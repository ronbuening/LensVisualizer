...
| --- | --- | --- | --- | --- |
| `asphericSchema.ts` | Shared TypeScript types | none | same folder, src/optics/analysis, src/optics/internal, src/optics/validateLensData.ts | AsphericCoefficientDescriptor, ASPHERIC_COEFFICIENT_SCHEMA, AsphericPolynomialDescriptor, ASPHERIC_POLYNOMIAL_TERMS, AsphericCoefficients |
...
| `optics.ts` | Shared TypeScript types | same folder (2), src/utils/catalog | src/components/display (24), src/components/diagram (14), src/optics/analysis (10), src/optics/perspective (10), src/optics/trace (10), +38 more | RadialPhaseTerm, DiffractivePhaseSurface, SurfaceData, SurfaceIncidentSide, SurfaceInactiveSideBehavior, SurfaceInteractionType, MirrorKind, SurfaceInteraction, +54 more |
