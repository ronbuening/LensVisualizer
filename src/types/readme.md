...
| `theme.ts` | Shared TypeScript types | same folder | src/components/display (54), src/components/layout (20), src/components/diagram (16), src/components/controls (9), src/components/content (8), +13 more | ThemeInternalTokens, ThemeColorTokens, Theme, ThemeVariant |
