...
| `optics.ts` | Shared TypeScript types | same folder (2), src/utils/catalog | src/components/display (26), src/components/diagram (14), src/components/hooks (11), src/optics/analysis (11), src/optics/perspective (10), +41 more | RadialPhaseTerm, DiffractivePhaseSurface, SurfaceData, SyntheticOpticsKind, RearPlateData, SurfaceIncidentSide, SurfaceInactiveSideBehavior, SurfaceInteractionType, +55 more |
