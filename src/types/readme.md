...
| `optics.ts` | Shared TypeScript types | same folder (2), src/utils/catalog | src/components/display (24), src/components/diagram (14), src/optics/perspective (10), src/optics/trace (10), src/optics/analysis (9), +40 more | RadialPhaseTerm, DiffractivePhaseSurface, SurfaceData, SyntheticOpticsKind, RearPlateData, SurfaceIncidentSide, SurfaceInactiveSideBehavior, SurfaceInteractionType, +53 more |
...
| `theme.ts` | Shared TypeScript types | same folder | src/components/display (54), src/components/layout (22), src/components/diagram (16), src/components/controls (11), src/components/content (8), +13 more | ThemeInternalTokens, ThemeColorTokens, Theme, ThemeVariant |
