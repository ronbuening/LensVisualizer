...
| `optics.ts` | Shared TypeScript types | same folder (2), src/utils/catalog | src/components/display (25), src/components/diagram (14), src/optics/perspective (10), src/optics/trace (10), src/components/hooks (9), +40 more | RadialPhaseTerm, DiffractivePhaseSurface, SurfaceData, SurfaceIncidentSide, SurfaceInactiveSideBehavior, SurfaceInteractionType, MirrorKind, SurfaceInteraction, +51 more |
