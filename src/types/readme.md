...
| `mtf.ts` | Shared TypeScript types | same folder | src/optics/analysis (4), src/components/display (2), src/components/hooks | MtfMethod, MtfSpectrum, MtfGridCap, MtfUnavailableReason, MtfOptions, MtfSpectralLine, MtfSupport, MtfFieldResult, +1 more |
...
| `theme.ts` | Shared TypeScript types | same folder | src/components/display (56), src/components/layout (22), src/components/diagram (16), src/components/controls (11), src/components/content (8), +13 more | ThemeInternalTokens, ThemeColorTokens, Theme, ThemeVariant |
