...
| `mtf.ts` | Shared TypeScript types | same folder | src/components/display (5), src/optics/analysis (5), src/components/hooks (3), src/utils/state | MtfMethod, MtfSpectrum, MtfFocusMode, MtfGridCap, MtfUnavailableReason, MtfOptions, MtfSpectralLine, MtfSupport, +5 more |
| `optics.ts` | Shared TypeScript types | same folder (2), src/utils/catalog | src/components/display (25), src/components/diagram (14), src/components/hooks (10), src/optics/analysis (10), src/optics/perspective (10), +40 more | RadialPhaseTerm, DiffractivePhaseSurface, SurfaceData, SyntheticOpticsKind, RearPlateData, SurfaceIncidentSide, SurfaceInactiveSideBehavior, SurfaceInteractionType, +54 more |
