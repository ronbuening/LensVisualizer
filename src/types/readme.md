...
| `mtf.ts` | Shared TypeScript types | same folder | src/components/display (6), src/optics/analysis (5), src/components/hooks (3), src/utils/state | MtfMethod, MtfSpectrum, MtfFocusMode, MtfGridCap, MtfUnavailableReason, MtfOptions, MtfSpectralLine, MtfSupport, +5 more |
