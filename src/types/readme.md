...
| `mtf.ts` | Shared TypeScript types | same folder | src/optics/analysis (5), src/components/display (2), src/components/hooks | MtfMethod, MtfSpectrum, MtfFocusMode, MtfGridCap, MtfUnavailableReason, MtfOptions, MtfSpectralLine, MtfSupport, +5 more |
