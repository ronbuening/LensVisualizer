...
flowchart LR
  ...
  n_src_components_controls_src_components_controls_DiagramControls_tsx --> n_external_src_optics_compat_ts
...
- Direct subfolders: 0
- Main outbound areas: src/types (17), same folder (10), src/utils/style (8), package:react (7), src/components/content (2), src/optics/optics.ts (2), src/optics/projection.ts (2), src/utils/featureFlags.ts (2), +8 more
...
| `DiagramControls.tsx` | React component module | same folder (4), src/types (3), package:react, src/components/hooks, src/optics/compat.ts, +5 more | src/components/layout | default, DiagramControls |
...
| `focalLengthFormatting.ts` | Focal Length Formatting helper module | none | src/comparison (2), same folder | formatFocalLength, formatZoomFocalLength, formatZoomReconstructionNote |
