...
- Direct subfolders: 0
- Main outbound areas: src/utils/catalog (17), src/types (9), src/utils/style (6), package:react (5), same folder (5), src/utils/text.ts (4), src/components/content (3), src/components/hooks (3), +2 more
