...
flowchart LR
  ...
  n_src_components_relationshipMap_src_components_relationshipMap_UniversalRelationshipMap_tsx --> n_src_components_relationshipMap_src_components_relationshipMap_universalLayout_ts
```
...
- Direct subfolders: 0
- Main outbound areas: src/utils/catalog (13), src/types (8), src/utils/style (5), package:react (4), same folder (4), src/utils/text.ts (4), src/components/content (3), src/components/hooks (3), +1 more
...
| `universalLayout.ts` | Universal Layout helper module | src/utils/catalog (2), same folder | same folder | UniversalLayoutNode, UniversalLayoutEdge, UniversalLayoutCluster, UniversalLayoutComponent, UniversalRelationshipLayout, universalNodeRadius, layoutUniversalRelationshipGraph |
