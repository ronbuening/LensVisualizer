...
flowchart LR
  ...
  n_src_components_relationshipMap_src_components_relationshipMap_PatentDetailCard_tsx --> n_external_src_types
...
- Direct subfolders: 0
- Main outbound areas: src/utils/catalog (9), src/types (3), package:react (2), src/utils/style (2), package:react-router, same folder, src/components/hooks
