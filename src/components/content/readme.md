...
flowchart LR
  ...
  n_external_src_utils_mediaQuery_ts["src/utils/mediaQuery.ts"]
  ...
  n_src_components_content_src_components_content_ArticleTOC_tsx --> n_external_src_utils_mediaQuery_ts
  n_src_components_content_src_components_content_SidebarLayout_tsx --> n_external_src_utils_mediaQuery_ts
...
- Direct subfolders: 0
- Main outbound areas: src/utils/content (8), src/types (6), package:react-router (4), package:react (3), src/utils/seo (3), src/utils/mediaQuery.ts (2), same folder, src/components/markdown
...
| --- | --- | --- | --- | --- |
| `ArticleCard.tsx` | React component module | src/utils/content (2), package:react-router, src/types, src/utils/seo | same folder, src/pages/ArticlesPage.tsx | default, ArticleCard |
...
| `ArticleTOC.tsx` | React component module | package:react, src/components/markdown, src/types, src/utils/mediaQuery.ts | src/pages/ArticlePage.tsx | TOCHeading, ArticleTOCProps, ARTICLE_SCROLL_MARGIN_TOP, TOC_OBSERVER_THRESHOLDS, TOC_OBSERVER_BOTTOM_ROOT_MARGIN, extractTOCHeadings, resolveActiveHeadingId, default, +1 more |
| `ChangelogList.tsx` | React component module | src/utils/content (3), src/types | src/pages/UpdatesPage.tsx | default, ChangelogList |
