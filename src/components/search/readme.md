...
- Direct subfolders: 0
- Main outbound areas: package:react (3), src/utils/catalog (3), package:react-router (2), src/types (2), src/components/content, src/utils/seo, src/utils/style
...
| `CatalogSearchResults.tsx` | React component module | package:react, package:react-router, src/components/content, src/types, src/utils/catalog | src/pages/SearchPage.tsx | default, CatalogSearchResults |
