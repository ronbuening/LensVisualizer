...
flowchart LR
  ...
  n_src_components_hooks_src_components_hooks_mtf_worker_ts --> n_external_src_optics_buildLens_ts
...
- Direct subfolders: 0
- Main outbound areas: package:react (19), src/types (18), same folder (14), src/optics/perspective (8), src/optics/optics.ts (7), src/optics/raySampling.ts (3), src/utils/state (3), src/optics/buildLens.ts (2), +11 more
...
| --- | --- | --- | --- | --- |
| `mtf.worker.ts` | Mtf helper module | same folder, src/optics/buildLens.ts, src/optics/compat.ts, src/optics/mtf.ts, src/types | none | none |
| `mtfWorkerClient.ts` | Mtf Worker Client helper module | src/types (2) | same folder, src/components/display | MtfJob, MtfWorkerReply, MtfWorkerPort, MtfWorkerClient |
