...
export default function AberrationsPanel({
  ...
  const comaPreviewResult = useMemo(
    () => computeEstimatedComaPreview(L, zPos, focusT, zoomT, currentEPSD, currentPhysStopSD),
    [L, zPos, focusT, zoomT, currentEPSD, currentPhysStopSD],
  );
        ...
        >
          ...
          {comaPreviewExpanded && (
            <>
              ...
              {comaPreviewResult ? (
                <>
                  <ComaPreviewGrid result={comaPreviewResult} t={t} mode="estimated" />
                  <div
                    style={{
                      display: "flex",
                      gap: 14,
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ±{formatComaSpan(comaPreviewResult.sharedTangentialHalfRangeMm * 1000)}
                      </span>
                    </div>
                  </div>
                </>
