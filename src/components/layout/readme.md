...
| `PageNavBar.tsx` | React component module | src/utils/theme (3), package:react, package:react-router, src/types, src/utils/style, +1 more | same folder, src/pages/ArticlePage.tsx, src/pages/HomePage.tsx, src/pages/LensIndexPage.tsx, src/pages/NotFoundPage.tsx | default, PageNavBar |
...
| `StaticPageShell.tsx` | React component module | package:react, package:react-router, same folder, src/types, src/utils/seo, +2 more | src/pages/ArticlesPage.tsx, src/pages/AuthorPage.tsx, src/pages/AuthorsIndexPage.tsx, src/pages/FormatPage.tsx, src/pages/FormatsIndexPage.tsx, +8 more | default, StaticPageShell |
