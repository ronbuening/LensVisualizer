...
| `PageNavBar.tsx` | React component module | src/utils/theme (3), package:react, package:react-router, src/types, src/utils/style, +1 more | same folder, src/pages/ArticlePage.tsx, src/pages/ArticlesPage.tsx, src/pages/FormatPage.tsx, src/pages/FormatsIndexPage.tsx, +8 more | default, PageNavBar |
...
| `StaticPageShell.tsx` | React component module | package:react, package:react-router, same folder, src/types, src/utils/seo, +2 more | src/pages/AuthorPage.tsx, src/pages/AuthorsIndexPage.tsx, src/pages/PatentsIndexPage.tsx, src/pages/SearchPage.tsx, src/pages/UpdatesPage.tsx | default, StaticPageShell |
