...
| `DropdownPanel.tsx` | React component module | package:react (2), package:react-dom, src/components/hooks, src/types | same folder, src/components/controls, src/components/relationshipMap | DropdownPanelPos, default |
