...
const LENS_DATA = {
  ...
  elements: [
    ...
    { id: 1,  name: "L11",  label: "Element 1",  type: "Biconcave Negative",
      nd: 1.67270, vd: 32.2, fl: -36.15,
    ...
    { id: 2,  name: "L12",  label: "Element 2",  type: "Pos. Meniscus (convex to obj.)",
      nd: 1.94595, vd: 18.0, fl: 98.54,
    ...
    { id: 3,  name: "L13",  label: "Element 3",  type: "Pos. Meniscus (concave to obj.)",
      nd: 1.72916, vd: 54.6, fl: 82.18,
    ...
    { id: 4,  name: "L14",  label: "Element 4",  type: "Pos. Meniscus (Asph, convex to obj.)",
      nd: 1.80400, vd: 46.6, fl: 54.12,
    ...
    { id: 5,  name: "L15",  label: "Element 5",  type: "Biconvex Positive (ED)",
      nd: 1.59319, vd: 67.9, fl: 41.42,
    ...
    { id: 6,  name: "L16",  label: "Element 6",  type: "Biconcave Negative",
      nd: 1.64769, vd: 33.7, fl: -28.59,
    ...
    { id: 7,  name: "L21",  label: "Element 7",  type: "Biconcave Negative",
      nd: 1.64769, vd: 33.7, fl: -35.31,
      glass: "S-TIH14 class (dense flint)",
      apd: false,
    ...
    { id: 8,  name: "L22",  label: "Element 8",  type: "Biconvex Positive (2× Asph)",
      nd: 1.77377, vd: 47.2, fl: 32.84,
    ...
    { id: 9,  name: "L23",  label: "Element 9",  type: "Pos. Meniscus (concave to obj., Super ED)",
      nd: 1.49782, vd: 82.6, fl: 65.37,
    ...
    { id: 10, name: "L31",  label: "Element 10", type: "Pos. Meniscus (concave to obj.)",
      nd: 1.94595, vd: 18.0, fl: 103.65,
    ...
    { id: 11, name: "L32",  label: "Element 11", type: "Neg. Meniscus (concave to obj.)",
      nd: 1.64769, vd: 33.7, fl: -113.52,
      glass: "S-TIH14 class (dense flint)",
      apd: false,
    ...
    { id: 12, name: "L33",  label: "Element 12", type: "Concave-Plano Negative",
      nd: 1.64769, vd: 33.7, fl: -77.52,
      glass: "S-TIH14 class (dense flint)",
      apd: false,
  ...
  surfaces: [
    ...
    // ── Virtual surface ───────────────────────────────────────────
    { label: "13",  R: 1e15,       d:  2.700, nd: 1.0,     elemId: 0,  sd: 14.5 },  // fixed air space
