...
import data from "../../../src/lens-data/carl-zeiss-jena/ZeissTessar144f55.data.js";
...
describe("Tessar: US721240 corrected prescription", () => {
  it("images the labeled close object distance in the inferred paraxial unit model", () => {
    ...
    for (const s of data.surfaces) {
      ...
      index = s.nd;
      const gap = s.label === "7" ? data.var["7"][1] : s.d;
  ...
  it("moves every optical surface and stop equally toward the object", () => {
    ...
    const extension = data.var["7"][1] - data.var["7"][0];
