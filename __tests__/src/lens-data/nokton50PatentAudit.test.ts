...
import data from "../../../src/lens-data/voigtlander/VoigtlanderNokton50f1.data.js";
...
describe("Nokton 50: JP2023063766A Example 1", () => {
  it("images the labeled close object distance in the inferred paraxial unit model", () => {
    ...
    for (const s of data.surfaces) {
      ...
      index = s.nd;
      const gap = s.label === "17A" ? data.var["17A"][1] : s.d;
  ...
  it("moves every optical surface and stop equally toward the object", () => {
    ...
    const extension = data.var["17A"][1] - data.var["17A"][0];
