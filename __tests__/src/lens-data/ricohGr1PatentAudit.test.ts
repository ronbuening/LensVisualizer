...
import data from "../../../src/lens-data/ricoh/RicohGR28f28.data.js";
...
describe("Ricoh GR1: US5760973 Example 1", () => {
  it("images the labeled close object distance in the inferred paraxial unit model", () => {
    ...
    for (const s of data.surfaces) {
      ...
      index = s.nd;
      const gap = s.label === "12" ? data.var["12"][1] : s.d;
  ...
  it("moves every optical surface and stop equally toward the object", () => {
    ...
    const extension = data.var["12"][1] - data.var["12"][0];
