...
import data from "../../../src/lens-data/carl-zeiss-jena/ZeissJenaSonnar50f2.data.js";
...
describe("Sonnar f2: US1998704 Example I", () => {
  it("images the labeled close object distance in the inferred paraxial unit model", () => {
    ...
    for (const s of data.surfaces) {
      ...
      index = s.nd;
      const gap = s.label === "9" ? data.var["9"][1] : s.d;
  ...
  it("moves every optical surface and stop equally toward the object", () => {
    ...
    const extension = data.var["9"][1] - data.var["9"][0];
